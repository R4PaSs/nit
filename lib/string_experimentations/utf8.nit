...
redef class FlatString
	...
	init with_infos_index(items: NativeString, len: Int, index_from: Int, index_to: Int, index: StringIndex, bytelen: Int)
	do
		self.items = items
		length = len
...
redef class NativeString
	...
	fun make_index(length: Int, real_len: Container[Int]): StringIndex import Container[Int].item= `{
		int pos = 0;
		int index_pos = 0;
