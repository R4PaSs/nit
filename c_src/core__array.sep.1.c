...
{
core___core__NativeArray___memmove(var_items, var_start, var_len, var_dest_items, var_new_start); /* Direct call array#NativeArray#memmove on <var_items:nullable NativeArray[nullable Object](NativeArray[nullable Object])>*/
}
RET_LABEL:;
}
...
var14 = self->attrs[COLOR_core__array__Array___items].val; /* _items on <self:Array[nullable Object]> */
var_it = var14;
var15 = var_o->attrs[COLOR_core__array__Array___items].val; /* _items on <var_o:nullable Object(Array[nullable Object])> */
var_oit = var15;
for(;;) {
{
{ /* Inline kernel#Int#< (var_i,var_l) on <var_i:Int> */
...
var24 = ((struct instance_core__NativeArray*)var_it)->values[var_i];
var22 = var24;
goto RET_LABEL23;
RET_LABEL23:(void)0;
}
...
var27 = ((struct instance_core__NativeArray*)var_oit)->values[var_i];
var25 = var27;
goto RET_LABEL26;
RET_LABEL26:(void)0;
}
...
var29 = ((short int(*)(val* self, val* p0))((((long)var22&3)?class_info[((long)var22&3)]:var22->class)->vft[COLOR_core__kernel__Object___33d_61d]))(var22, var25); /* != on <var22:nullable Object>*/
var28 = var29;
}
if (var28){
var = 0;
...
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 1169);
fatal_exit(1);
}
