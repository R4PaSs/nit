...
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 3870);
fatal_exit(1);
}
var_mproperty = var8;
{
...
PRINT_ERROR("Runtime error: %s", "Cast failed");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 3872);
fatal_exit(1);
}
...
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 3873);
fatal_exit(1);
}
{
...
PRINT_ERROR("Runtime error: %s", "Cast failed");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 3882);
fatal_exit(1);
}
var_mproperty = var5;
{
...
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 3941);
fatal_exit(1);
}
var1 = var3;
RET_LABEL2:(void)0;
