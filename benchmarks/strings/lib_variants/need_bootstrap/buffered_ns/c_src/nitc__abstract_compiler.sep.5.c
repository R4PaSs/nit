...
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 3082);
fatal_exit(1);
}
{
...
if (var_ret == NULL) {
PRINT_ERROR("Runtime error: %s", "Receiver is null");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 3088);
fatal_exit(1);
} else {
...
if (var32 == NULL) {
PRINT_ERROR("Runtime error: %s", "Receiver is null");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 3091);
fatal_exit(1);
} else {
...
if (var51 == NULL) {
PRINT_ERROR("Runtime error: %s", "Receiver is null");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 3096);
fatal_exit(1);
} else {
...
if (var70 == NULL) {
PRINT_ERROR("Runtime error: %s", "Receiver is null");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 3108);
fatal_exit(1);
} else {
...
if (var78 == NULL) {
PRINT_ERROR("Runtime error: %s", "Receiver is null");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 3110);
fatal_exit(1);
} else {
...
if (unlikely(!var95)) {
PRINT_ERROR("Runtime error: %s", "Assert failed");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 3112);
fatal_exit(1);
}
{
{ /* Inline modelize_property#APropdef#mpropdef (self) on <self:AAttrPropdef> */
...
if (var98 == NULL) {
PRINT_ERROR("Runtime error: %s", "Receiver is null");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 3113);
fatal_exit(1);
} else {
...
if (var_ret112 == NULL) {
PRINT_ERROR("Runtime error: %s", "Receiver is null");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 3116);
fatal_exit(1);
} else {
...
if (var123 == NULL) {
PRINT_ERROR("Runtime error: %s", "Receiver is null");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 3118);
fatal_exit(1);
} else {
...
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 3122);
fatal_exit(1);
}
}
RET_LABEL:;
...
if (unlikely(var9 == NULL)) {
PRINT_ERROR("Runtime error: %s", "Cast failed");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 3137);
fatal_exit(1);
}
{
...
PRINT_ERROR("Runtime error: %s", "Cast failed");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 3154);
fatal_exit(1);
}
...
if (unlikely(!var11)) {
PRINT_ERROR("Runtime error: %s", "Assert failed");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 3189);
fatal_exit(1);
}
{
{ /* Inline array#AbstractArrayRead#length (var_arguments) on <var_arguments:Array[RuntimeVariable]> */
...
PRINT_ERROR("Runtime error: %s", "Aborted");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 3196);
fatal_exit(1);
}
RET_LABEL:;
}
...
PRINT_ERROR("Runtime error: %s", "Cast failed");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 3244);
fatal_exit(1);
}
var_variable = var;
{
...
PRINT_ERROR("Runtime error: %s", "Cast failed");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 3256);
fatal_exit(1);
}
{
...
if (unlikely(var1 == NULL)) {
PRINT_ERROR("Runtime error: %s", "Cast failed");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 3265);
fatal_exit(1);
}
var_variable = var1;
{
...
if (unlikely(var == NULL)) {
PRINT_ERROR("Runtime error: %s", "Cast failed");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 3275);
fatal_exit(1);
}
var_variable = var;
{
...
if (unlikely(!var16)) {
PRINT_ERROR("Runtime error: %s", "Assert failed");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 3279);
fatal_exit(1);
}
{
...
if (var1 == NULL) {
PRINT_ERROR("Runtime error: %s", "Receiver is null");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 3285);
fatal_exit(1);
} else {
...
if (unlikely(var9 == NULL)) {
PRINT_ERROR("Runtime error: %s", "Cast failed");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 3291);
fatal_exit(1);
}
{
...
if (var8 == NULL) {
PRINT_ERROR("Runtime error: %s", "Receiver is null");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 3304);
fatal_exit(1);
} else {
...
if (var27 == NULL) {
PRINT_ERROR("Runtime error: %s", "Receiver is null");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 3308);
fatal_exit(1);
} else {
...
if (unlikely(var1 == NULL)) {
PRINT_ERROR("Runtime error: %s", "Cast failed");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 3329);
fatal_exit(1);
}
{
...
if (unlikely(!var22)) {
PRINT_ERROR("Runtime error: %s", "Assert failed");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 3394);
fatal_exit(1);
}
{
...
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 3447);
fatal_exit(1);
}
var41 = var43;
RET_LABEL42:(void)0;
...
if (unlikely(!var48)) {
PRINT_ERROR("Runtime error: %s", "Assert failed");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 3401);
fatal_exit(1);
}
...
if (unlikely(!var93)) {
PRINT_ERROR("Runtime error: %s", "Assert failed");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 3409);
fatal_exit(1);
}
{
{ /* Inline scope#AForGroup#variables (var_g40) on <var_g40:AForGroup> */
...
if (var103 == NULL) {
PRINT_ERROR("Runtime error: %s", "Receiver is null");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 3411);
fatal_exit(1);
} else {
...
if (unlikely(!var115)) {
PRINT_ERROR("Runtime error: %s", "Assert failed");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 3413);
fatal_exit(1);
}
...
if (unlikely(!var124)) {
PRINT_ERROR("Runtime error: %s", "Assert failed");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 3415);
fatal_exit(1);
}
{
{ /* Inline scope#AForGroup#variables (var_g40) on <var_g40:AForGroup> */
...
if (var129 == NULL) {
PRINT_ERROR("Runtime error: %s", "Receiver is null");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 3416);
fatal_exit(1);
} else {
...
if (unlikely(!var138)) {
PRINT_ERROR("Runtime error: %s", "Assert failed");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 3418);
fatal_exit(1);
}
...
PRINT_ERROR("Runtime error: %s", "Aborted");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 3423);
fatal_exit(1);
}
}
{
...
if (unlikely(!var175)) {
PRINT_ERROR("Runtime error: %s", "Assert failed");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 3430);
fatal_exit(1);
}
...
if (unlikely(var1 == NULL)) {
PRINT_ERROR("Runtime error: %s", "Cast failed");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 3472);
fatal_exit(1);
}
{
var4 = nitc___nitc__AbstractCompilerVisitor___new_var(var_v, var1);
...
if (unlikely(var1 == NULL)) {
PRINT_ERROR("Runtime error: %s", "Cast failed");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 3487);
fatal_exit(1);
}
{
var4 = nitc___nitc__AbstractCompilerVisitor___new_var(var_v, var1);
...
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 3539);
fatal_exit(1);
}
{
var12 = (long)(var5)>>2;
...
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 3540);
fatal_exit(1);
}
{
...
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 3541);
fatal_exit(1);
}
{
...
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 3542);
fatal_exit(1);
}
{
...
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 3545);
fatal_exit(1);
}
{
...
PRINT_ERROR("Runtime error: %s", "Aborted");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 3547);
fatal_exit(1);
RET_LABEL:;
return var;
}
...
if (unlikely(var1 == NULL)) {
PRINT_ERROR("Runtime error: %s", "Cast failed");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 3556);
fatal_exit(1);
}
{
...
if (unlikely(var1 == NULL)) {
PRINT_ERROR("Runtime error: %s", "Cast failed");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 3562);
fatal_exit(1);
}
var_mtype = var1;
...
if (var12 == NULL) {
PRINT_ERROR("Runtime error: %s", "Receiver is null");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 3567);
fatal_exit(1);
} else {
...
if (unlikely(var1 == NULL)) {
PRINT_ERROR("Runtime error: %s", "Cast failed");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 3578);
fatal_exit(1);
}
{
...
if (unlikely(var1 == NULL)) {
PRINT_ERROR("Runtime error: %s", "Cast failed");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 3584);
fatal_exit(1);
}
...
if (unlikely(var14 == NULL)) {
PRINT_ERROR("Runtime error: %s", "Cast failed");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 3653);
fatal_exit(1);
}
var17 = NEW_core__Array(&type_core__Array__nitc__RuntimeVariable);
{
...
if (unlikely(var14 == NULL)) {
PRINT_ERROR("Runtime error: %s", "Cast failed");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 3665);
fatal_exit(1);
}
var17 = NEW_core__Array(&type_core__Array__nitc__RuntimeVariable);
{
...
if (unlikely(var1 == NULL)) {
PRINT_ERROR("Runtime error: %s", "Cast failed");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 3725);
fatal_exit(1);
}
var_mtype = var1;
if (likely(varonce!=NULL)) {
...
if (unlikely(var4 == NULL)) {
PRINT_ERROR("Runtime error: %s", "Cast failed");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 3758);
fatal_exit(1);
}
var_callsite = var4;
{
...
if (unlikely(!var23)) {
PRINT_ERROR("Runtime error: %s", "Assert failed");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 3765);
fatal_exit(1);
}
{
...
if (unlikely(var28 == NULL)) {
PRINT_ERROR("Runtime error: %s", "Cast failed");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 3767);
fatal_exit(1);
}
...
if (unlikely(!var33)) {
PRINT_ERROR("Runtime error: %s", "Assert failed");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 3768);
fatal_exit(1);
}
{
...
if (unlikely(var38 == NULL)) {
PRINT_ERROR("Runtime error: %s", "Cast failed");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 3771);
fatal_exit(1);
}
{
...
if (unlikely(var1 == NULL)) {
PRINT_ERROR("Runtime error: %s", "Cast failed");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 3778);
fatal_exit(1);
}
var_frame = var1;
{
...
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 3811);
fatal_exit(1);
}
{
...
if (unlikely(var5 == NULL)) {
PRINT_ERROR("Runtime error: %s", "Cast failed");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 3849);
fatal_exit(1);
}
var_mproperty = var5;
{
