...
PRINT_ERROR("Runtime error: Cast failed. Expected `%s`, got `%s`", "nullable N", var_class_name);
PRINT_ERROR(" (%s:%d)\n", FILE_core__hash_collection, 127);
fatal_exit(1);
}
...
PRINT_ERROR("Runtime error: %s", "Uninitialized attribute _array");
PRINT_ERROR(" (%s:%d)\n", FILE_core__hash_collection, 142);
fatal_exit(1);
}
/* <var_next:nullable HashNode[nullable Object]> isa nullable N */
...
PRINT_ERROR("Runtime error: %s", "Uninitialized attribute _array");
PRINT_ERROR(" (%s:%d)\n", FILE_core__hash_collection, 156);
fatal_exit(1);
}
{
...
PRINT_ERROR(" (%s:%d)\n", FILE_core__hash_collection, 188);
fatal_exit(1);
}
var_node = var50;
} else {
...
PRINT_ERROR(" (%s:%d)\n", FILE_core__hash_collection, 194);
fatal_exit(1);
}
...
var_class_name = p0 == NULL ? "null" : (((long)p0&3)?type_info[((long)p0&3)]:p0->type)->name;
PRINT_ERROR("Runtime error: Cast failed. Expected `%s`, got `%s`", "K", var_class_name);
PRINT_ERROR(" (%s:%d)\n", FILE_core__hash_collection, 247);
fatal_exit(1);
}
...
PRINT_ERROR(" (%s:%d)\n", FILE_core__hash_collection, 274);
fatal_exit(1);
}
} else {
...
PRINT_ERROR(" (%s:%d)\n", FILE_core__hash_collection, 275);
fatal_exit(1);
}
} else {
...
PRINT_ERROR(" (%s:%d)\n", FILE_core__hash_collection, 282);
fatal_exit(1);
}
var = var1;
RET_LABEL:;
...
PRINT_ERROR("Runtime error: %s", "Receiver is null");
PRINT_ERROR(" (%s:%d)\n", FILE_core__hash_collection, 286);
fatal_exit(1);
}
...
if (unlikely(var1 == NULL)) {
PRINT_ERROR("Runtime error: %s", "Uninitialized attribute _map");
PRINT_ERROR(" (%s:%d)\n", FILE_core__hash_collection, 303);
fatal_exit(1);
}
var = var1;
RET_LABEL:;
...
if (unlikely(var4 == NULL)) {
PRINT_ERROR("Runtime error: %s", "Receiver is null");
PRINT_ERROR(" (%s:%d)\n", FILE_core__hash_collection, 316);
fatal_exit(1);
}
...
PRINT_ERROR(" (%s:%d)\n", FILE_core__hash_collection, 374);
fatal_exit(1);
}
...
PRINT_ERROR(" (%s:%d)\n", FILE_core__hash_collection, 384);
fatal_exit(1);
}
...
if (unlikely(var2 == NULL)) {
PRINT_ERROR("Runtime error: %s", "Receiver is null");
PRINT_ERROR(" (%s:%d)\n", FILE_core__hash_collection, 385);
fatal_exit(1);
}
...
if (unlikely(!var1)) {
PRINT_ERROR("Runtime error: %s", "Assert failed");
PRINT_ERROR(" (%s:%d)\n", FILE_core__hash_collection, 396);
fatal_exit(1);
}
var2 = self->attrs[COLOR_core__hash_collection__HashMapIterator___node].val; /* _node on <self:HashMapIterator[nullable Object, nullable Object]> */
if (unlikely(var2 == NULL)) {
PRINT_ERROR("Runtime error: %s", "Receiver is null");
PRINT_ERROR(" (%s:%d)\n", FILE_core__hash_collection, 397);
fatal_exit(1);
}
...
if (unlikely(var1 == NULL)) {
PRINT_ERROR("Runtime error: %s", "Receiver is null");
PRINT_ERROR(" (%s:%d)\n", FILE_core__hash_collection, 403);
fatal_exit(1);
}
...
if (unlikely(var1 == NULL)) {
PRINT_ERROR("Runtime error: %s", "Uninitialized attribute _map");
PRINT_ERROR(" (%s:%d)\n", FILE_core__hash_collection, 406);
fatal_exit(1);
}
var = var1;
RET_LABEL:;
...
if (unlikely(var3 == NULL)) {
PRINT_ERROR("Runtime error: %s", "Uninitialized attribute _map");
PRINT_ERROR(" (%s:%d)\n", FILE_core__hash_collection, 415);
fatal_exit(1);
}
...
if (unlikely(!var2)) {
PRINT_ERROR("Runtime error: %s", "Assert failed");
PRINT_ERROR(" (%s:%d)\n", FILE_core__hash_collection, 433);
fatal_exit(1);
}
...
PRINT_ERROR("Runtime error: %s", "Receiver is null");
PRINT_ERROR(" (%s:%d)\n", FILE_core__hash_collection, 434);
fatal_exit(1);
}
...
PRINT_ERROR(" (%s:%d)\n", FILE_core__hash_collection, 442);
fatal_exit(1);
}
var_item = p0;
...
PRINT_ERROR(" (%s:%d)\n", FILE_core__hash_collection, 466);
fatal_exit(1);
}
var_coll = p0;
{
...
if (unlikely(var1 == NULL)) {
PRINT_ERROR("Runtime error: %s", "Receiver is null");
PRINT_ERROR(" (%s:%d)\n", FILE_core__hash_collection, 493);
fatal_exit(1);
}
...
PRINT_ERROR(" (%s:%d)\n", FILE_core__hash_collection, 496);
fatal_exit(1);
}
