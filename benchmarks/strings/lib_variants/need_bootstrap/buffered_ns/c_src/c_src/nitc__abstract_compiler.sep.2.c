...
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 1055);
fatal_exit(1);
}
var68 = var70;
RET_LABEL69:(void)0;
...
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 954);
fatal_exit(1);
} else {
...
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 1029);
fatal_exit(1);
}
var_v = p0;
var_recv = p1;
...
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 1191);
fatal_exit(1);
}
}
{
...
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 1203);
fatal_exit(1);
RET_LABEL:;
}
...
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 1220);
fatal_exit(1);
}
var1 = var5;
}
...
if (unlikely(!var21)) {
PRINT_ERROR("Runtime error: %s", "Assert failed");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 1227);
fatal_exit(1);
}
var_ = var_args;
{
...
if (var9 == NULL) {
PRINT_ERROR("Runtime error: %s", "Receiver is null");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 1267);
fatal_exit(1);
} else {
...
if (var6 == NULL) {
PRINT_ERROR("Runtime error: %s", "Receiver is null");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 1273);
fatal_exit(1);
} else {
...
if (unlikely(!var1)) {
PRINT_ERROR("Runtime error: %s", "Assert failed");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 1336);
fatal_exit(1);
}
{
{ /* Inline abstract_compiler#AbstractCompilerVisitor#compiler (self) on <self:AbstractCompilerVisitor> */
...
if (unlikely(!var1)) {
PRINT_ERROR("Runtime error: %s", "Assert failed");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 1344);
fatal_exit(1);
}
{
{ /* Inline abstract_compiler#AbstractCompilerVisitor#compiler (self) on <self:AbstractCompilerVisitor> */
...
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 1377);
fatal_exit(1);
}
var = var1;
RET_LABEL:;
...
if (unlikely(!var1)) {
PRINT_ERROR("Runtime error: %s", "Assert failed");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 1402);
fatal_exit(1);
}
{
{ /* Inline abstract_compiler#AbstractCompilerVisitor#frame (self) on <self:AbstractCompilerVisitor> */
...
if (var29 == NULL) {
PRINT_ERROR("Runtime error: %s", "Receiver is null");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 1407);
fatal_exit(1);
} else {
...
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 1425);
fatal_exit(1);
}
var = var1;
RET_LABEL:;
...
if (unlikely(var19 == NULL)) {
PRINT_ERROR("Runtime error: %s", "Cast failed");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 1434);
fatal_exit(1);
}
var_mtype = var19;
{
...
if (unlikely(!var11)) {
PRINT_ERROR("Runtime error: %s", "Assert failed");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 1492);
fatal_exit(1);
}
{
