...
if (unlikely(!var2)) {
PRINT_ERROR("Runtime error: %s", "Assert \'not_empty\' failed");
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 824);
fatal_exit(1);
}
{
...
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 934);
fatal_exit(1);
RET_LABEL:;
return var;
}
...
var_class_name = p0 == NULL ? "null" : (((long)p0&3)?type_info[((long)p0&3)]:p0->type)->name;
PRINT_ERROR("Runtime error: Cast failed. Expected `%s`, got `%s`", "E", var_class_name);
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 961);
fatal_exit(1);
}
var_item = p0;
{
...
var_class_name = p0 == NULL ? "null" : (((long)p0&3)?type_info[((long)p0&3)]:p0->type)->name;
PRINT_ERROR("Runtime error: Cast failed. Expected `%s`, got `%s`", "E", var_class_name);
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 992);
fatal_exit(1);
}
var_e = p0;
{
...
var_class_name = p0 == NULL ? "null" : (((long)p0&3)?type_info[((long)p0&3)]:p0->type)->name;
PRINT_ERROR("Runtime error: Cast failed. Expected `%s`, got `%s`", "Collection[E]", var_class_name);
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 1003);
fatal_exit(1);
}
var_coll = p0;
{
...
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 1012);
fatal_exit(1);
RET_LABEL:;
return var;
}
...
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 1022);
fatal_exit(1);
RET_LABEL:;
}
...
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 1065);
fatal_exit(1);
RET_LABEL:;
}
...
if (unlikely(!var1)) {
PRINT_ERROR("Runtime error: %s", "Assert failed");
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 1085);
fatal_exit(1);
}
{
...
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 1145);
fatal_exit(1);
}
{
...
if (unlikely(var1 == NULL)) {
PRINT_ERROR("Runtime error: %s", "Uninitialized attribute _iter");
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 1149);
fatal_exit(1);
}
{
var2 = ((val*(*)(val* self))((((long)var1&3)?class_info[((long)var1&3)]:var1->class)->vft[COLOR_core__abstract_collection__Iterator__item]))(var1); /* item on <var1:Iterator[Couple[nullable Object, nullable Object]]>*/
...
PRINT_ERROR("Runtime error: %s", "Uninitialized attribute _iter");
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 1155);
fatal_exit(1);
}
{
...
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 1166);
fatal_exit(1);
}
