...
#define COLOR_nitc__light___AMethPropdef___compile_externmeth_to_c 101
...
#define COLOR_nitc__nitni_base__MType__is_cprimitive 50
...
#define COLOR_nitc__light___AMethPropdef___compile_externinit_to_c 100
