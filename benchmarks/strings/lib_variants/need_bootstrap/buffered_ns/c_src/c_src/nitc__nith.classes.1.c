...
val* var2 /* : HashMap[String, nullable MModule] */;
val* var3 /* : Array[MModule] */;
val* var4 /* : Array[MModule] */;
val* var5 /* : HashMap[String, nullable MGroup] */;
val* var6 /* : Array[SequenceRead[MModule]] */;
val* var7 /* : Array[AModule] */;
val* var8 /* : HashMap[MModule, AModule] */;
val* var9 /* : HashMap[MClassDef, AClassdef] */;
val* var10 /* : HashMap[String, MModuleData[AAnnotation]] */;
...
self->attrs[COLOR_nitc__loader__ModelBuilder___paths].val = var1; /* _paths on <self:ModelBuilder exact> */
var2 = NEW_core__HashMap(&type_core__HashMap__core__String__nullable__nitc__MModule);
{
core___core__HashMap___core__kernel__Object__init(var2); /* Direct call hash_collection#HashMap#init on <var2:HashMap[String, nullable MModule]>*/
}
self->attrs[COLOR_nitc__loader__ModelBuilder___identified_modules_by_path].val = var2; /* _identified_modules_by_path on <self:ModelBuilder exact> */
...
self->attrs[COLOR_nitc__loader__ModelBuilder___identified_modules].val = var3; /* _identified_modules on <self:ModelBuilder exact> */
...
self->attrs[COLOR_nitc__loader__ModelBuilder___parsed_modules].val = var4; /* _parsed_modules on <self:ModelBuilder exact> */
var5 = NEW_core__HashMap(&type_core__HashMap__core__String__nullable__nitc__MGroup);
{
core___core__HashMap___core__kernel__Object__init(var5); /* Direct call hash_collection#HashMap#init on <var5:HashMap[String, nullable MGroup]>*/
}
self->attrs[COLOR_nitc__loader__ModelBuilder___mgroups].val = var5; /* _mgroups on <self:ModelBuilder exact> */
var6 = NEW_core__Array(&type_core__Array__core__SequenceRead__nitc__MModule);
{
core___core__Array___core__kernel__Object__init(var6); /* Direct call array#Array#init on <var6:Array[SequenceRead[MModule]]>*/
}
self->attrs[COLOR_nitc__loader__ModelBuilder___conditional_importations].val = var6; /* _conditional_importations on <self:ModelBuilder exact> */
var7 = NEW_core__Array(&type_core__Array__nitc__AModule);
{
core___core__Array___core__kernel__Object__init(var7); /* Direct call array#Array#init on <var7:Array[AModule]>*/
}
self->attrs[COLOR_nitc__loader__ModelBuilder___nmodules].val = var7; /* _nmodules on <self:ModelBuilder exact> */
var8 = NEW_core__HashMap(&type_core__HashMap__nitc__MModule__nitc__AModule);
{
core___core__HashMap___core__kernel__Object__init(var8); /* Direct call hash_collection#HashMap#init on <var8:HashMap[MModule, AModule]>*/
}
self->attrs[COLOR_nitc__loader__ModelBuilder___mmodule2nmodule].val = var8; /* _mmodule2nmodule on <self:ModelBuilder exact> */
var9 = NEW_core__HashMap(&type_core__HashMap__nitc__MClassDef__nitc__AClassdef);
{
core___core__HashMap___core__kernel__Object__init(var9); /* Direct call hash_collection#HashMap#init on <var9:HashMap[MClassDef, AClassdef]>*/
}
self->attrs[COLOR_nitc__modelize_class__ModelBuilder___mclassdef2nclassdef].val = var9; /* _mclassdef2nclassdef on <self:ModelBuilder exact> */
var10 = NEW_core__HashMap(&type_core__HashMap__core__String__nitc__MModuleData__nitc__AAnnotation);
{
core___core__HashMap___core__kernel__Object__init(var10); /* Direct call hash_collection#HashMap#init on <var10:HashMap[String, MModuleData[AAnnotation]]>*/
}
self->attrs[COLOR_nitc__annotation__ModelBuilder___collect_annotations_data_cache].val = var10; /* _collect_annotations_data_cache on <self:ModelBuilder exact> */
var11 = NEW_core__HashMap(&type_core__HashMap__nitc__MPropDef__nitc__APropdef);
{
core___core__HashMap___core__kernel__Object__init(var11); /* Direct call hash_collection#HashMap#init on <var11:HashMap[MPropDef, APropdef]>*/
}
self->attrs[COLOR_nitc__modelize_property__ModelBuilder___mpropdef2npropdef].val = var11; /* _mpropdef2npropdef on <self:ModelBuilder exact> */
...
(nitmethod_t)nitc___nitc__MClass___visibility, /* pointer to model:MClass:model#MClass#visibility */
...
(nitmethod_t)nitc___nitc__MClassDef___location, /* pointer to model:MClassDef:model#MClassDef#location */
...
var3 = NEW_core__HashMap(&type_core__HashMap__nitc__MProperty__nitc__APropdef);
{
core___core__HashMap___core__kernel__Object__init(var3); /* Direct call hash_collection#HashMap#init on <var3:HashMap[MProperty, APropdef]>*/
}
self->attrs[COLOR_nitc__modelize_property__MClassDef___mprop2npropdef].val = var3; /* _mprop2npropdef on <self:MClassDef exact> */
...
(nitmethod_t)nitc___nitc__MProperty___visibility, /* pointer to model:MMethod:model#MProperty#visibility */
...
(nitmethod_t)nitc___nitc__MProperty___visibility, /* pointer to model:MAttribute:model#MProperty#visibility */
...
(nitmethod_t)nitc___nitc__MProperty___visibility, /* pointer to model:MVirtualTypeProp:model#MProperty#visibility */
...
(nitmethod_t)nitc___nitc__MPropDef___location, /* pointer to model:MMethodDef:model#MPropDef#location */
...
(nitmethod_t)nitc___nitc__MPropDef___location, /* pointer to model:MAttributeDef:model#MPropDef#location */
...
(nitmethod_t)nitc___nitc__MPropDef___location, /* pointer to model:MVirtualTypeDef:model#MPropDef#location */
...
(nitmethod_t)nitc___nitc__MModule___location, /* pointer to mmodule:MModule:mmodule#MModule#location */
...
(nitmethod_t)nitc___nitc__MModule___filepath_61d, /* pointer to mmodule:MModule:mmodule#MModule#filepath= */
...
(nitmethod_t)nitc__model___MModule___native_string_type, /* pointer to mmodule:MModule:model#MModule#native_string_type */
...
self = nit_alloc(sizeof(struct instance) + 68*sizeof(nitattribute_t));
self->type = type;
...
(nitmethod_t)core__fixed_ints___Text___to_i, /* pointer to ropes:Concat:fixed_ints#Text#to_i */
...
(nitmethod_t)core__fixed_ints___Text___is_int, /* pointer to ropes:Concat:fixed_ints#Text#is_int */
...
(nitmethod_t)core__ropes___core__ropes__Concat___core__abstract_text__Text__bytelen, /* pointer to ropes:Concat:ropes#Concat#bytelen */
...
(nitmethod_t)core__fixed_ints___Text___strip_numhead, /* pointer to ropes:Concat:fixed_ints#Text#strip_numhead */
(nitmethod_t)core__fixed_ints___Text___get_numhead, /* pointer to ropes:Concat:fixed_ints#Text#get_numhead */
...
(nitmethod_t)core__fixed_ints___Text___to_num, /* pointer to ropes:Concat:fixed_ints#Text#to_num */
...
(nitmethod_t)core__ropes___core__ropes__Concat___core__abstract_text__Text__bytes, /* pointer to ropes:Concat:ropes#Concat#bytes */
(nitmethod_t)core__fixed_ints___Text___is_num, /* pointer to ropes:Concat:fixed_ints#Text#is_num */
(nitmethod_t)core__fixed_ints___Text___get_numext, /* pointer to ropes:Concat:fixed_ints#Text#get_numext */
(nitmethod_t)core__fixed_ints___Text___strip_numext, /* pointer to ropes:Concat:fixed_ints#Text#strip_numext */
(nitmethod_t)core__environ___String___environ, /* pointer to ropes:Concat:environ#String#environ */
(nitmethod_t)core__ropes___core__ropes__Concat___core__abstract_text__String___43d, /* pointer to ropes:Concat:ropes#Concat#+ */
(nitmethod_t)core___core__String___to_snake_case, /* pointer to ropes:Concat:abstract_text#String#to_snake_case */
...
(nitmethod_t)core__file___String___file_exists, /* pointer to ropes:Concat:file#String#file_exists */
(nitmethod_t)core__ropes___core__ropes__Concat___core__abstract_text__String___42d, /* pointer to ropes:Concat:ropes#Concat#* */
...
(nitmethod_t)core__ropes___core__ropes__Concat___length_61d, /* pointer to ropes:Concat:ropes#Concat#length= */
...
(nitmethod_t)core__ropes___core__ropes__Concat___core__abstract_text__String__to_lower, /* pointer to ropes:Concat:ropes#Concat#to_lower */
...
(nitmethod_t)core__ropes___core__ropes__Concat___core__abstract_text__String__to_upper, /* pointer to ropes:Concat:ropes#Concat#to_upper */
...
self->attrs[COLOR_core__ropes__Concat___flat_last_pos_start].l = var; /* _flat_last_pos_start on <self:Concat exact> */
{
{ /* Inline kernel#Int#unary - (1l) on <1l:Int> */
var4 = -1l;
var2 = var4;
...
self->attrs[COLOR_core__ropes__Concat___flat_last_pos_end].l = var2; /* _flat_last_pos_end on <self:Concat exact> */
return self;
}
/* runtime class core__RopeBuffer: core::RopeBuffer (dead=false; need_corpse=false)*/
const struct class class_core__RopeBuffer = {
0, /* box_kind */
{
(nitmethod_t)core___core__RopeBuffer___core__kernel__Object__init, /* pointer to ropes:RopeBuffer:ropes#RopeBuffer#init */
(nitmethod_t)core___core__Object____33d_61d, /* pointer to ropes:RopeBuffer:kernel#Object#!= */
(nitmethod_t)core___core__Object___sys, /* pointer to ropes:RopeBuffer:kernel#Object#sys */
(nitmethod_t)core___core__RopeBuffer___core__abstract_text__Object__to_s, /* pointer to ropes:RopeBuffer:ropes#RopeBuffer#to_s */
(nitmethod_t)core___core__Text___core__kernel__Object___61d_61d, /* pointer to ropes:RopeBuffer:abstract_text#Text#== */
(nitmethod_t)core___core__Object___is_same_instance, /* pointer to ropes:RopeBuffer:kernel#Object#is_same_instance */
(nitmethod_t)core__abstract_text___Object___inspect, /* pointer to ropes:RopeBuffer:abstract_text#Object#inspect */
(nitmethod_t)core___core__Object___object_id, /* pointer to ropes:RopeBuffer:kernel#Object#object_id */
(nitmethod_t)core__abstract_text___Object___class_name, /* pointer to ropes:RopeBuffer:abstract_text#Object#class_name */
(nitmethod_t)core__abstract_text___Object___inspect_head, /* pointer to ropes:RopeBuffer:abstract_text#Object#inspect_head */
(nitmethod_t)core__abstract_text___Object___native_class_name, /* pointer to ropes:RopeBuffer:abstract_text#Object#native_class_name */
(nitmethod_t)core___core__Buffer___core__kernel__Object__hash, /* pointer to ropes:RopeBuffer:abstract_text#Buffer#hash */
(nitmethod_t)core___core__Comparable____60d_61d, /* pointer to ropes:RopeBuffer:kernel#Comparable#<= */
(nitmethod_t)core___core__Comparable____62d, /* pointer to ropes:RopeBuffer:kernel#Comparable#> */
(nitmethod_t)core___core__Comparable____62d_61d, /* pointer to ropes:RopeBuffer:kernel#Comparable#>= */
(nitmethod_t)core___core__Text___core__kernel__Comparable___60d, /* pointer to ropes:RopeBuffer:abstract_text#Text#< */
(nitmethod_t)core___core__Comparable____60d_61d_62d, /* pointer to ropes:RopeBuffer:kernel#Comparable#<=> */
(nitmethod_t)core___core__Pattern___split_in, /* pointer to ropes:RopeBuffer:string_search#Pattern#split_in */
(nitmethod_t)core__string_search___Text___Pattern__search_in, /* pointer to ropes:RopeBuffer:string_search#Text#search_in */
(nitmethod_t)core__string_search___Text___Pattern__search_index_in, /* pointer to ropes:RopeBuffer:string_search#Text#search_index_in */
(nitmethod_t)core__fixed_ints___Text___to_i, /* pointer to ropes:RopeBuffer:fixed_ints#Text#to_i */
(nitmethod_t)core___core__Text___to_cstring, /* pointer to ropes:RopeBuffer:abstract_text#Text#to_cstring */
(nitmethod_t)core___core__RopeBuffer___core__abstract_text__Text__length, /* pointer to ropes:RopeBuffer:ropes#RopeBuffer#length */
(nitmethod_t)core___core__RopeBuffer___core__abstract_text__Text__chars, /* pointer to ropes:RopeBuffer:ropes#RopeBuffer#chars */
(nitmethod_t)core___core__RopeBuffer___core__abstract_text__Text__substring, /* pointer to ropes:RopeBuffer:ropes#RopeBuffer#substring */
(nitmethod_t)core__fixed_ints___Text___is_int, /* pointer to ropes:RopeBuffer:fixed_ints#Text#is_int */
(nitmethod_t)core__string_search___Text___remove_all, /* pointer to ropes:RopeBuffer:string_search#Text#remove_all */
(nitmethod_t)core__file___Writable___write_to_file, /* pointer to ropes:RopeBuffer:file#Writable#write_to_file */
(nitmethod_t)core__stream___Text___Writable__write_to, /* pointer to ropes:RopeBuffer:stream#Text#write_to */
(nitmethod_t)core___core__RopeBuffer___core__abstract_text__Text___91d_93d, /* pointer to ropes:RopeBuffer:ropes#RopeBuffer#[] */
(nitmethod_t)core___core__Text___substring_from, /* pointer to ropes:RopeBuffer:abstract_text#Text#substring_from */
(nitmethod_t)core___core__Text___to_hex, /* pointer to ropes:RopeBuffer:abstract_text#Text#to_hex */
(nitmethod_t)core___core__Text___to_oct, /* pointer to ropes:RopeBuffer:abstract_text#Text#to_oct */
(nitmethod_t)core___core__Text___to_bin, /* pointer to ropes:RopeBuffer:abstract_text#Text#to_bin */
(nitmethod_t)core___core__Text___to_dec, /* pointer to ropes:RopeBuffer:abstract_text#Text#to_dec */
(nitmethod_t)core___core__RopeBuffer___core__abstract_text__Text__bytelen, /* pointer to ropes:RopeBuffer:ropes#RopeBuffer#bytelen */
(nitmethod_t)core___core__RopeBuffer___core__abstract_text__Text__substrings, /* pointer to ropes:RopeBuffer:ropes#RopeBuffer#substrings */
(nitmethod_t)core___core__Text___is_empty, /* pointer to ropes:RopeBuffer:abstract_text#Text#is_empty */
(nitmethod_t)core__string_search___Text___split_with, /* pointer to ropes:RopeBuffer:string_search#Text#split_with */
(nitmethod_t)core__fixed_ints___Text___strip_numhead, /* pointer to ropes:RopeBuffer:fixed_ints#Text#strip_numhead */
(nitmethod_t)core__fixed_ints___Text___get_numhead, /* pointer to ropes:RopeBuffer:fixed_ints#Text#get_numhead */
(nitmethod_t)core___core__Text___is_hex, /* pointer to ropes:RopeBuffer:abstract_text#Text#is_hex */
(nitmethod_t)core___core__Text___is_bin, /* pointer to ropes:RopeBuffer:abstract_text#Text#is_bin */
(nitmethod_t)core___core__Text___is_oct, /* pointer to ropes:RopeBuffer:abstract_text#Text#is_oct */
(nitmethod_t)core___core__Text___is_dec, /* pointer to ropes:RopeBuffer:abstract_text#Text#is_dec */
(nitmethod_t)core__string_search___Text___split, /* pointer to ropes:RopeBuffer:string_search#Text#split */
(nitmethod_t)core___core__RopeBuffer___core__abstract_text__Text__empty, /* pointer to ropes:RopeBuffer:ropes#RopeBuffer#empty */
(nitmethod_t)core___core__Text___a_to, /* pointer to ropes:RopeBuffer:abstract_text#Text#a_to */
(nitmethod_t)core___core__Text___is_lower, /* pointer to ropes:RopeBuffer:abstract_text#Text#is_lower */
(nitmethod_t)core___core__Text___has_suffix, /* pointer to ropes:RopeBuffer:abstract_text#Text#has_suffix */
(nitmethod_t)core__file___Text___write_native_to, /* pointer to ropes:RopeBuffer:file#Text#write_native_to */
(nitmethod_t)core___core__Text___to_cmangle, /* pointer to ropes:RopeBuffer:abstract_text#Text#to_cmangle */
(nitmethod_t)core__string_search___Text___split_once_on, /* pointer to ropes:RopeBuffer:string_search#Text#split_once_on */
(nitmethod_t)core___core__Text___is_numeric, /* pointer to ropes:RopeBuffer:abstract_text#Text#is_numeric */
(nitmethod_t)core___core__Text___has_substring, /* pointer to ropes:RopeBuffer:abstract_text#Text#has_substring */
(nitmethod_t)core___core__Text___last, /* pointer to ropes:RopeBuffer:abstract_text#Text#last */
(nitmethod_t)core___core__Text___hash_cache, /* pointer to ropes:RopeBuffer:abstract_text#Text#hash_cache */
(nitmethod_t)core___core__Text___hash_cache_61d, /* pointer to ropes:RopeBuffer:abstract_text#Text#hash_cache= */
(nitmethod_t)core___core__Text___has_prefix, /* pointer to ropes:RopeBuffer:abstract_text#Text#has_prefix */
(nitmethod_t)core___core__Text___trim, /* pointer to ropes:RopeBuffer:abstract_text#Text#trim */
(nitmethod_t)core___core__Text___escape_to_c, /* pointer to ropes:RopeBuffer:abstract_text#Text#escape_to_c */
(nitmethod_t)core__file___Text___to_path, /* pointer to ropes:RopeBuffer:file#Text#to_path */
(nitmethod_t)core___core__Text___chomp, /* pointer to ropes:RopeBuffer:abstract_text#Text#chomp */
(nitmethod_t)core___core__Text___r_trim, /* pointer to ropes:RopeBuffer:abstract_text#Text#r_trim */
(nitmethod_t)core___core__Text___l_trim, /* pointer to ropes:RopeBuffer:abstract_text#Text#l_trim */
(nitmethod_t)core___core__Text___escape_to_sh, /* pointer to ropes:RopeBuffer:abstract_text#Text#escape_to_sh */
(nitmethod_t)core___core__Text___escape_to_mk, /* pointer to ropes:RopeBuffer:abstract_text#Text#escape_to_mk */
(nitmethod_t)core__string_search___Text___replace, /* pointer to ropes:RopeBuffer:string_search#Text#replace */
(nitmethod_t)core__fixed_ints___Text___to_num, /* pointer to ropes:RopeBuffer:fixed_ints#Text#to_num */
(nitmethod_t)core___core__Text___to_f, /* pointer to ropes:RopeBuffer:abstract_text#Text#to_f */
(nitmethod_t)core___core__Text___unescape_nit, /* pointer to ropes:RopeBuffer:abstract_text#Text#unescape_nit */
(nitmethod_t)core___core__RopeBuffer___core__abstract_text__Text__bytes, /* pointer to ropes:RopeBuffer:ropes#RopeBuffer#bytes */
(nitmethod_t)core__fixed_ints___Text___is_num, /* pointer to ropes:RopeBuffer:fixed_ints#Text#is_num */
(nitmethod_t)core__fixed_ints___Text___get_numext, /* pointer to ropes:RopeBuffer:fixed_ints#Text#get_numext */
(nitmethod_t)core__fixed_ints___Text___strip_numext, /* pointer to ropes:RopeBuffer:fixed_ints#Text#strip_numext */
(nitmethod_t)core__flat___Buffer___new, /* pointer to ropes:RopeBuffer:flat#Buffer#new */
(nitmethod_t)core___core__RopeBuffer___core__abstract_text__Buffer__append, /* pointer to ropes:RopeBuffer:ropes#RopeBuffer#append */
(nitmethod_t)core__flat___Buffer___with_cap, /* pointer to ropes:RopeBuffer:flat#Buffer#with_cap */
(nitmethod_t)core___core__RopeBuffer___core__abstract_text__Buffer__add, /* pointer to ropes:RopeBuffer:ropes#RopeBuffer#add */
(nitmethod_t)core___core__Buffer___is_dirty, /* pointer to ropes:RopeBuffer:abstract_text#Buffer#is_dirty */
(nitmethod_t)core___core__Buffer___is_dirty_61d, /* pointer to ropes:RopeBuffer:abstract_text#Buffer#is_dirty= */
(nitmethod_t)core___core__Buffer___written_61d, /* pointer to ropes:RopeBuffer:abstract_text#Buffer#written= */
(nitmethod_t)core___core__RopeBuffer___core__abstract_text__Buffer__enlarge, /* pointer to ropes:RopeBuffer:ropes#RopeBuffer#enlarge */
(nitmethod_t)core___core__Buffer___written, /* pointer to ropes:RopeBuffer:abstract_text#Buffer#written */
(nitmethod_t)core___core__RopeBuffer___core__abstract_text__Buffer___91d_93d_61d, /* pointer to ropes:RopeBuffer:ropes#RopeBuffer#[]= */
(nitmethod_t)core___core__Text___core__kernel__Object__hash, /* pointer to ropes:RopeBuffer:abstract_text#Text#hash */
(nitmethod_t)core___core__RopeBuffer___ns_61d, /* pointer to ropes:RopeBuffer:ropes#RopeBuffer#ns= */
(nitmethod_t)core___core__RopeBuffer___buf_size_61d, /* pointer to ropes:RopeBuffer:ropes#RopeBuffer#buf_size= */
(nitmethod_t)core___core__RopeBuffer___dumped_61d, /* pointer to ropes:RopeBuffer:ropes#RopeBuffer#dumped= */
(nitmethod_t)core___core__RopeBuffer___persist_buffer, /* pointer to ropes:RopeBuffer:ropes#RopeBuffer#persist_buffer */
(nitmethod_t)core___core__RopeBuffer___str, /* pointer to ropes:RopeBuffer:ropes#RopeBuffer#str */
(nitmethod_t)core___core__RopeBuffer___dumped, /* pointer to ropes:RopeBuffer:ropes#RopeBuffer#dumped */
(nitmethod_t)core___core__RopeBuffer___rpos, /* pointer to ropes:RopeBuffer:ropes#RopeBuffer#rpos */
(nitmethod_t)core___core__RopeBuffer___ns, /* pointer to ropes:RopeBuffer:ropes#RopeBuffer#ns */
(nitmethod_t)core___core__RopeBuffer___from, /* pointer to ropes:RopeBuffer:ropes#RopeBuffer#from */
(nitmethod_t)core___core__RopeBuffer___str_61d, /* pointer to ropes:RopeBuffer:ropes#RopeBuffer#str= */
(nitmethod_t)core___core__RopeBuffer___buf_size, /* pointer to ropes:RopeBuffer:ropes#RopeBuffer#buf_size */
(nitmethod_t)core___core__RopeBuffer___rpos_61d, /* pointer to ropes:RopeBuffer:ropes#RopeBuffer#rpos= */
(nitmethod_t)core___core__RopeBuffer___dump_buffer, /* pointer to ropes:RopeBuffer:ropes#RopeBuffer#dump_buffer */
(nitmethod_t)core___core__Object___init, /* pointer to ropes:RopeBuffer:kernel#Object#init */
}
};
/* allocate RopeBuffer */
...
self = nit_alloc(sizeof(struct instance) + 14*sizeof(nitattribute_t));
self->type = type;
self->class = &class_core__RopeBuffer;
self->attrs[COLOR_core__abstract_text__Buffer___is_dirty].s = 1; /* _is_dirty on <self:RopeBuffer exact> */
self->attrs[COLOR_core__abstract_text__Buffer___written].s = 0; /* _written on <self:RopeBuffer exact> */
...
self->attrs[COLOR_core__ropes__RopeBuffer___str].val = var; /* _str on <self:RopeBuffer exact> */
self->attrs[COLOR_core__ropes__RopeBuffer___rpos].l = 0l; /* _rpos on <self:RopeBuffer exact> */
self->attrs[COLOR_core__ropes__RopeBuffer___nslen].l = 0l; /* _nslen on <self:RopeBuffer exact> */
self->attrs[COLOR_core__ropes__RopeBuffer___bytelen].l = 0l; /* _bytelen on <self:RopeBuffer exact> */
return self;
}
...
/* runtime class core__ropes__RopeByteReverseIterator: core::ropes::RopeByteReverseIterator (dead=false; need_corpse=false)*/
const struct class class_core__ropes__RopeByteReverseIterator = {
0, /* box_kind */
{
(nitmethod_t)core___core__Object___init, /* pointer to ropes:RopeByteReverseIterator:kernel#Object#init */
(nitmethod_t)core___core__Object____33d_61d, /* pointer to ropes:RopeByteReverseIterator:kernel#Object#!= */
(nitmethod_t)core___core__Object___sys, /* pointer to ropes:RopeByteReverseIterator:kernel#Object#sys */
(nitmethod_t)core__abstract_text___Object___to_s, /* pointer to ropes:RopeByteReverseIterator:abstract_text#Object#to_s */
(nitmethod_t)core___core__Object____61d_61d, /* pointer to ropes:RopeByteReverseIterator:kernel#Object#== */
(nitmethod_t)core___core__Object___is_same_instance, /* pointer to ropes:RopeByteReverseIterator:kernel#Object#is_same_instance */
(nitmethod_t)core__abstract_text___Object___inspect, /* pointer to ropes:RopeByteReverseIterator:abstract_text#Object#inspect */
(nitmethod_t)core___core__Object___object_id, /* pointer to ropes:RopeByteReverseIterator:kernel#Object#object_id */
(nitmethod_t)core__abstract_text___Object___class_name, /* pointer to ropes:RopeByteReverseIterator:abstract_text#Object#class_name */
(nitmethod_t)core__abstract_text___Object___inspect_head, /* pointer to ropes:RopeByteReverseIterator:abstract_text#Object#inspect_head */
(nitmethod_t)core__abstract_text___Object___native_class_name, /* pointer to ropes:RopeByteReverseIterator:abstract_text#Object#native_class_name */
(nitmethod_t)core___core__Object___hash, /* pointer to ropes:RopeByteReverseIterator:kernel#Object#hash */
(nitmethod_t)core__ropes___core__ropes__RopeByteReverseIterator___core__abstract_collection__Iterator__is_ok, /* pointer to ropes:RopeByteReverseIterator:ropes#RopeByteReverseIterator#is_ok */
(nitmethod_t)VIRTUAL_core__ropes___core__ropes__RopeByteReverseIterator___core__abstract_collection__Iterator__item, /* pointer to ropes:RopeByteReverseIterator:ropes#RopeByteReverseIterator#item */
(nitmethod_t)core__ropes___core__ropes__RopeByteReverseIterator___core__abstract_collection__Iterator__next, /* pointer to ropes:RopeByteReverseIterator:ropes#RopeByteReverseIterator#next */
(nitmethod_t)core___core__Iterator___finish, /* pointer to ropes:RopeByteReverseIterator:abstract_collection#Iterator#finish */
(nitmethod_t)core___core__Iterator___iterator, /* pointer to ropes:RopeByteReverseIterator:abstract_collection#Iterator#iterator */
(nitmethod_t)core__array___Iterator___to_a, /* pointer to ropes:RopeByteReverseIterator:array#Iterator#to_a */
(nitmethod_t)core__ropes___core__ropes__RopeByteReverseIterator___core__abstract_collection__IndexedIterator__index, /* pointer to ropes:RopeByteReverseIterator:ropes#RopeByteReverseIterator#index */
(nitmethod_t)core__ropes___core__ropes__RopeByteReverseIterator___from, /* pointer to ropes:RopeByteReverseIterator:ropes#RopeByteReverseIterator#from */
(nitmethod_t)core__ropes___core__ropes__RopeByteReverseIterator___pos, /* pointer to ropes:RopeByteReverseIterator:ropes#RopeByteReverseIterator#pos */
(nitmethod_t)core__ropes___core__ropes__RopeByteReverseIterator___ns, /* pointer to ropes:RopeByteReverseIterator:ropes#RopeByteReverseIterator#ns */
(nitmethod_t)core__ropes___core__ropes__RopeByteReverseIterator___pns, /* pointer to ropes:RopeByteReverseIterator:ropes#RopeByteReverseIterator#pns */
(nitmethod_t)core__ropes___core__ropes__RopeByteReverseIterator___pns_61d, /* pointer to ropes:RopeByteReverseIterator:ropes#RopeByteReverseIterator#pns= */
(nitmethod_t)core__ropes___core__ropes__RopeByteReverseIterator___pos_61d, /* pointer to ropes:RopeByteReverseIterator:ropes#RopeByteReverseIterator#pos= */
(nitmethod_t)core__ropes___core__ropes__RopeByteReverseIterator___subs, /* pointer to ropes:RopeByteReverseIterator:ropes#RopeByteReverseIterator#subs */
(nitmethod_t)core__ropes___core__ropes__RopeByteReverseIterator___ns_61d, /* pointer to ropes:RopeByteReverseIterator:ropes#RopeByteReverseIterator#ns= */
(nitmethod_t)core__ropes___core__ropes__RopeByteReverseIterator___subs_61d, /* pointer to ropes:RopeByteReverseIterator:ropes#RopeByteReverseIterator#subs= */
}
};
/* allocate RopeByteReverseIterator */
val* NEW_core__ropes__RopeByteReverseIterator(const struct type* type) {
val* self /* : RopeByteReverseIterator */;
self = nit_alloc(sizeof(struct instance) + 4*sizeof(nitattribute_t));
self->type = type;
self->class = &class_core__ropes__RopeByteReverseIterator;
return self;
}
/* runtime class core__ropes__RopeByteIterator: core::ropes::RopeByteIterator (dead=false; need_corpse=false)*/
const struct class class_core__ropes__RopeByteIterator = {
0, /* box_kind */
{
(nitmethod_t)core___core__Object___init, /* pointer to ropes:RopeByteIterator:kernel#Object#init */
(nitmethod_t)core___core__Object____33d_61d, /* pointer to ropes:RopeByteIterator:kernel#Object#!= */
(nitmethod_t)core___core__Object___sys, /* pointer to ropes:RopeByteIterator:kernel#Object#sys */
(nitmethod_t)core__abstract_text___Object___to_s, /* pointer to ropes:RopeByteIterator:abstract_text#Object#to_s */
(nitmethod_t)core___core__Object____61d_61d, /* pointer to ropes:RopeByteIterator:kernel#Object#== */
(nitmethod_t)core___core__Object___is_same_instance, /* pointer to ropes:RopeByteIterator:kernel#Object#is_same_instance */
(nitmethod_t)core__abstract_text___Object___inspect, /* pointer to ropes:RopeByteIterator:abstract_text#Object#inspect */
(nitmethod_t)core___core__Object___object_id, /* pointer to ropes:RopeByteIterator:kernel#Object#object_id */
(nitmethod_t)core__abstract_text___Object___class_name, /* pointer to ropes:RopeByteIterator:abstract_text#Object#class_name */
(nitmethod_t)core__abstract_text___Object___inspect_head, /* pointer to ropes:RopeByteIterator:abstract_text#Object#inspect_head */
(nitmethod_t)core__abstract_text___Object___native_class_name, /* pointer to ropes:RopeByteIterator:abstract_text#Object#native_class_name */
(nitmethod_t)core___core__Object___hash, /* pointer to ropes:RopeByteIterator:kernel#Object#hash */
(nitmethod_t)core__ropes___core__ropes__RopeByteIterator___core__abstract_collection__Iterator__is_ok, /* pointer to ropes:RopeByteIterator:ropes#RopeByteIterator#is_ok */
(nitmethod_t)VIRTUAL_core__ropes___core__ropes__RopeByteIterator___core__abstract_collection__Iterator__item, /* pointer to ropes:RopeByteIterator:ropes#RopeByteIterator#item */
(nitmethod_t)core__ropes___core__ropes__RopeByteIterator___core__abstract_collection__Iterator__next, /* pointer to ropes:RopeByteIterator:ropes#RopeByteIterator#next */
(nitmethod_t)core___core__Iterator___finish, /* pointer to ropes:RopeByteIterator:abstract_collection#Iterator#finish */
(nitmethod_t)core___core__Iterator___iterator, /* pointer to ropes:RopeByteIterator:abstract_collection#Iterator#iterator */
(nitmethod_t)core__array___Iterator___to_a, /* pointer to ropes:RopeByteIterator:array#Iterator#to_a */
(nitmethod_t)core__ropes___core__ropes__RopeByteIterator___core__abstract_collection__IndexedIterator__index, /* pointer to ropes:RopeByteIterator:ropes#RopeByteIterator#index */
(nitmethod_t)core__ropes___core__ropes__RopeByteIterator___from, /* pointer to ropes:RopeByteIterator:ropes#RopeByteIterator#from */
(nitmethod_t)core__ropes___core__ropes__RopeByteIterator___pos, /* pointer to ropes:RopeByteIterator:ropes#RopeByteIterator#pos */
(nitmethod_t)core__ropes___core__ropes__RopeByteIterator___max, /* pointer to ropes:RopeByteIterator:ropes#RopeByteIterator#max */
(nitmethod_t)core__ropes___core__ropes__RopeByteIterator___ns, /* pointer to ropes:RopeByteIterator:ropes#RopeByteIterator#ns */
(nitmethod_t)core__ropes___core__ropes__RopeByteIterator___pns, /* pointer to ropes:RopeByteIterator:ropes#RopeByteIterator#pns */
(nitmethod_t)core__ropes___core__ropes__RopeByteIterator___pns_61d, /* pointer to ropes:RopeByteIterator:ropes#RopeByteIterator#pns= */
(nitmethod_t)core__ropes___core__ropes__RopeByteIterator___pos_61d, /* pointer to ropes:RopeByteIterator:ropes#RopeByteIterator#pos= */
(nitmethod_t)core__ropes___core__ropes__RopeByteIterator___subs, /* pointer to ropes:RopeByteIterator:ropes#RopeByteIterator#subs */
(nitmethod_t)core__ropes___core__ropes__RopeByteIterator___ns_61d, /* pointer to ropes:RopeByteIterator:ropes#RopeByteIterator#ns= */
(nitmethod_t)core__ropes___core__ropes__RopeByteIterator___subs_61d, /* pointer to ropes:RopeByteIterator:ropes#RopeByteIterator#subs= */
(nitmethod_t)core__ropes___core__ropes__RopeByteIterator___max_61d, /* pointer to ropes:RopeByteIterator:ropes#RopeByteIterator#max= */
}
};
/* allocate RopeByteIterator */
val* NEW_core__ropes__RopeByteIterator(const struct type* type) {
val* self /* : RopeByteIterator */;
self = nit_alloc(sizeof(struct instance) + 5*sizeof(nitattribute_t));
self->type = type;
self->class = &class_core__ropes__RopeByteIterator;
return self;
}
...
/* runtime class core__ropes__RopeBufSubstringIterator: core::ropes::RopeBufSubstringIterator (dead=false; need_corpse=false)*/
const struct class class_core__ropes__RopeBufSubstringIterator = {
0, /* box_kind */
{
(nitmethod_t)core___core__Object___init, /* pointer to ropes:RopeBufSubstringIterator:kernel#Object#init */
(nitmethod_t)core___core__Object____33d_61d, /* pointer to ropes:RopeBufSubstringIterator:kernel#Object#!= */
(nitmethod_t)core___core__Object___sys, /* pointer to ropes:RopeBufSubstringIterator:kernel#Object#sys */
(nitmethod_t)core__abstract_text___Object___to_s, /* pointer to ropes:RopeBufSubstringIterator:abstract_text#Object#to_s */
(nitmethod_t)core___core__Object____61d_61d, /* pointer to ropes:RopeBufSubstringIterator:kernel#Object#== */
(nitmethod_t)core___core__Object___is_same_instance, /* pointer to ropes:RopeBufSubstringIterator:kernel#Object#is_same_instance */
(nitmethod_t)core__abstract_text___Object___inspect, /* pointer to ropes:RopeBufSubstringIterator:abstract_text#Object#inspect */
(nitmethod_t)core___core__Object___object_id, /* pointer to ropes:RopeBufSubstringIterator:kernel#Object#object_id */
(nitmethod_t)core__abstract_text___Object___class_name, /* pointer to ropes:RopeBufSubstringIterator:abstract_text#Object#class_name */
(nitmethod_t)core__abstract_text___Object___inspect_head, /* pointer to ropes:RopeBufSubstringIterator:abstract_text#Object#inspect_head */
(nitmethod_t)core__abstract_text___Object___native_class_name, /* pointer to ropes:RopeBufSubstringIterator:abstract_text#Object#native_class_name */
(nitmethod_t)core___core__Object___hash, /* pointer to ropes:RopeBufSubstringIterator:kernel#Object#hash */
(nitmethod_t)core__ropes___core__ropes__RopeBufSubstringIterator___core__abstract_collection__Iterator__is_ok, /* pointer to ropes:RopeBufSubstringIterator:ropes#RopeBufSubstringIterator#is_ok */
(nitmethod_t)core__ropes___core__ropes__RopeBufSubstringIterator___core__abstract_collection__Iterator__item, /* pointer to ropes:RopeBufSubstringIterator:ropes#RopeBufSubstringIterator#item */
(nitmethod_t)core__ropes___core__ropes__RopeBufSubstringIterator___core__abstract_collection__Iterator__next, /* pointer to ropes:RopeBufSubstringIterator:ropes#RopeBufSubstringIterator#next */
(nitmethod_t)core___core__Iterator___finish, /* pointer to ropes:RopeBufSubstringIterator:abstract_collection#Iterator#finish */
(nitmethod_t)core___core__Iterator___iterator, /* pointer to ropes:RopeBufSubstringIterator:abstract_collection#Iterator#iterator */
(nitmethod_t)core__array___Iterator___to_a, /* pointer to ropes:RopeBufSubstringIterator:array#Iterator#to_a */
(nitmethod_t)core__ropes___core__ropes__RopeBufSubstringIterator___from, /* pointer to ropes:RopeBufSubstringIterator:ropes#RopeBufSubstringIterator#from */
(nitmethod_t)core__ropes___core__ropes__RopeBufSubstringIterator___iter, /* pointer to ropes:RopeBufSubstringIterator:ropes#RopeBufSubstringIterator#iter */
(nitmethod_t)core__ropes___core__ropes__RopeBufSubstringIterator___nsstr_done, /* pointer to ropes:RopeBufSubstringIterator:ropes#RopeBufSubstringIterator#nsstr_done */
(nitmethod_t)core__ropes___core__ropes__RopeBufSubstringIterator___nsstr, /* pointer to ropes:RopeBufSubstringIterator:ropes#RopeBufSubstringIterator#nsstr */
(nitmethod_t)core__ropes___core__ropes__RopeBufSubstringIterator___nsstr_done_61d, /* pointer to ropes:RopeBufSubstringIterator:ropes#RopeBufSubstringIterator#nsstr_done= */
(nitmethod_t)core__ropes___core__ropes__RopeBufSubstringIterator___iter_61d, /* pointer to ropes:RopeBufSubstringIterator:ropes#RopeBufSubstringIterator#iter= */
(nitmethod_t)core__ropes___core__ropes__RopeBufSubstringIterator___nsstr_61d, /* pointer to ropes:RopeBufSubstringIterator:ropes#RopeBufSubstringIterator#nsstr= */
}
};
...
self = nit_alloc(sizeof(struct instance) + 3*sizeof(nitattribute_t));
self->type = type;
self->class = &class_core__ropes__RopeBufSubstringIterator;
self->attrs[COLOR_core__ropes__RopeBufSubstringIterator___nsstr_done].s = 0; /* _nsstr_done on <self:RopeBufSubstringIterator exact> */
return self;
}
...
/* runtime class core__ropes__RopeBytes: core::ropes::RopeBytes (dead=false; need_corpse=false)*/
const struct class class_core__ropes__RopeBytes = {
0, /* box_kind */
{
(nitmethod_t)core__abstract_text___core__abstract_text__StringByteView___core__kernel__Object__init, /* pointer to ropes:RopeBytes:abstract_text#StringByteView#init */
(nitmethod_t)core___core__Object____33d_61d, /* pointer to ropes:RopeBytes:kernel#Object#!= */
(nitmethod_t)core___core__Object___sys, /* pointer to ropes:RopeBytes:kernel#Object#sys */
(nitmethod_t)core__abstract_text___Collection___Object__to_s, /* pointer to ropes:RopeBytes:abstract_text#Collection#to_s */
(nitmethod_t)core___core__SequenceRead___core__kernel__Object___61d_61d, /* pointer to ropes:RopeBytes:abstract_collection#SequenceRead#== */
(nitmethod_t)core___core__Object___is_same_instance, /* pointer to ropes:RopeBytes:kernel#Object#is_same_instance */
(nitmethod_t)core__abstract_text___Object___inspect, /* pointer to ropes:RopeBytes:abstract_text#Object#inspect */
(nitmethod_t)core___core__Object___object_id, /* pointer to ropes:RopeBytes:kernel#Object#object_id */
(nitmethod_t)core__abstract_text___Object___class_name, /* pointer to ropes:RopeBytes:abstract_text#Object#class_name */
(nitmethod_t)core__abstract_text___Object___inspect_head, /* pointer to ropes:RopeBytes:abstract_text#Object#inspect_head */
(nitmethod_t)core__abstract_text___Object___native_class_name, /* pointer to ropes:RopeBytes:abstract_text#Object#native_class_name */
(nitmethod_t)core___core__SequenceRead___core__kernel__Object__hash, /* pointer to ropes:RopeBytes:abstract_collection#SequenceRead#hash */
(nitmethod_t)core__abstract_text___core__abstract_text__StringByteView___target_61d, /* pointer to ropes:RopeBytes:abstract_text#StringByteView#target= */
(nitmethod_t)core__abstract_text___core__abstract_text__StringByteView___target, /* pointer to ropes:RopeBytes:abstract_text#StringByteView#target */
(nitmethod_t)core___core__Object___init, /* pointer to ropes:RopeBytes:kernel#Object#init */
NULL, /* empty */
NULL, /* empty */
(nitmethod_t)core__abstract_text___Collection___join, /* pointer to ropes:RopeBytes:abstract_text#Collection#join */
(nitmethod_t)core__array___Collection___to_a, /* pointer to ropes:RopeBytes:array#Collection#to_a */
(nitmethod_t)core__abstract_text___core__abstract_text__StringByteView___core__abstract_collection__Collection__length, /* pointer to ropes:RopeBytes:abstract_text#StringByteView#length */
(nitmethod_t)core__abstract_text___core__abstract_text__StringByteView___core__abstract_collection__Collection__is_empty, /* pointer to ropes:RopeBytes:abstract_text#StringByteView#is_empty */
(nitmethod_t)core__abstract_text___core__abstract_text__StringByteView___core__abstract_collection__Collection__iterator, /* pointer to ropes:RopeBytes:abstract_text#StringByteView#iterator */
(nitmethod_t)core___core__Collection___has_all, /* pointer to ropes:RopeBytes:abstract_collection#Collection#has_all */
(nitmethod_t)core___core__Collection___has, /* pointer to ropes:RopeBytes:abstract_collection#Collection#has */
(nitmethod_t)core___core__SequenceRead___Collection__first, /* pointer to ropes:RopeBytes:abstract_collection#SequenceRead#first */
(nitmethod_t)core___core__Collection___not_empty, /* pointer to ropes:RopeBytes:abstract_collection#Collection#not_empty */
(nitmethod_t)core__abstract_text___Collection___plain_to_s, /* pointer to ropes:RopeBytes:abstract_text#Collection#plain_to_s */
NULL, /* empty */
NULL, /* empty */
(nitmethod_t)VIRTUAL_core__ropes___core__ropes__RopeBytes___core__abstract_collection__SequenceRead___91d_93d, /* pointer to ropes:RopeBytes:ropes#RopeBytes#[] */
(nitmethod_t)core__ropes___core__ropes__RopeBytes___core__abstract_collection__SequenceRead__iterator_from, /* pointer to ropes:RopeBytes:ropes#RopeBytes#iterator_from */
(nitmethod_t)core___core__SequenceRead___index_of, /* pointer to ropes:RopeBytes:abstract_collection#SequenceRead#index_of */
(nitmethod_t)core___core__SequenceRead___last_index_of, /* pointer to ropes:RopeBytes:abstract_collection#SequenceRead#last_index_of */
(nitmethod_t)core___core__SequenceRead___index_of_from, /* pointer to ropes:RopeBytes:abstract_collection#SequenceRead#index_of_from */
(nitmethod_t)core___core__SequenceRead___last, /* pointer to ropes:RopeBytes:abstract_collection#SequenceRead#last */
(nitmethod_t)core___core__SequenceRead___last_index_of_from, /* pointer to ropes:RopeBytes:abstract_collection#SequenceRead#last_index_of_from */
(nitmethod_t)core__abstract_text___core__abstract_text__StringByteView___core__abstract_collection__SequenceRead__reverse_iterator, /* pointer to ropes:RopeBytes:abstract_text#StringByteView#reverse_iterator */
(nitmethod_t)core__ropes___core__ropes__RopeBytes___core__abstract_collection__SequenceRead__reverse_iterator_from, /* pointer to ropes:RopeBytes:ropes#RopeBytes#reverse_iterator_from */
}
};
/* allocate RopeBytes */
...
self = nit_alloc(sizeof(struct instance) + 1*sizeof(nitattribute_t));
self->type = type;
self->class = &class_core__ropes__RopeBytes;
return self;
}
/* runtime class core__RopeBufferCharIterator: core::RopeBufferCharIterator (dead=false; need_corpse=false)*/
const struct class class_core__RopeBufferCharIterator = {
0, /* box_kind */
{
(nitmethod_t)core___core__Object___init, /* pointer to ropes:RopeBufferCharIterator:kernel#Object#init */
(nitmethod_t)core___core__Object____33d_61d, /* pointer to ropes:RopeBufferCharIterator:kernel#Object#!= */
(nitmethod_t)core___core__Object___sys, /* pointer to ropes:RopeBufferCharIterator:kernel#Object#sys */
(nitmethod_t)core__abstract_text___Object___to_s, /* pointer to ropes:RopeBufferCharIterator:abstract_text#Object#to_s */
(nitmethod_t)core___core__Object____61d_61d, /* pointer to ropes:RopeBufferCharIterator:kernel#Object#== */
(nitmethod_t)core___core__Object___is_same_instance, /* pointer to ropes:RopeBufferCharIterator:kernel#Object#is_same_instance */
(nitmethod_t)core__abstract_text___Object___inspect, /* pointer to ropes:RopeBufferCharIterator:abstract_text#Object#inspect */
(nitmethod_t)core___core__Object___object_id, /* pointer to ropes:RopeBufferCharIterator:kernel#Object#object_id */
(nitmethod_t)core__abstract_text___Object___class_name, /* pointer to ropes:RopeBufferCharIterator:abstract_text#Object#class_name */
(nitmethod_t)core__abstract_text___Object___inspect_head, /* pointer to ropes:RopeBufferCharIterator:abstract_text#Object#inspect_head */
(nitmethod_t)core__abstract_text___Object___native_class_name, /* pointer to ropes:RopeBufferCharIterator:abstract_text#Object#native_class_name */
(nitmethod_t)core___core__Object___hash, /* pointer to ropes:RopeBufferCharIterator:kernel#Object#hash */
(nitmethod_t)core___core__RopeBufferCharIterator___core__abstract_collection__Iterator__is_ok, /* pointer to ropes:RopeBufferCharIterator:ropes#RopeBufferCharIterator#is_ok */
(nitmethod_t)VIRTUAL_core___core__RopeBufferCharIterator___core__abstract_collection__Iterator__item, /* pointer to ropes:RopeBufferCharIterator:ropes#RopeBufferCharIterator#item */
(nitmethod_t)core___core__RopeBufferCharIterator___core__abstract_collection__Iterator__next, /* pointer to ropes:RopeBufferCharIterator:ropes#RopeBufferCharIterator#next */
(nitmethod_t)core___core__Iterator___finish, /* pointer to ropes:RopeBufferCharIterator:abstract_collection#Iterator#finish */
(nitmethod_t)core___core__Iterator___iterator, /* pointer to ropes:RopeBufferCharIterator:abstract_collection#Iterator#iterator */
(nitmethod_t)core__array___Iterator___to_a, /* pointer to ropes:RopeBufferCharIterator:array#Iterator#to_a */
(nitmethod_t)core___core__RopeBufferCharIterator___core__abstract_collection__IndexedIterator__index, /* pointer to ropes:RopeBufferCharIterator:ropes#RopeBufferCharIterator#index */
(nitmethod_t)core___core__RopeBufferCharIterator___from, /* pointer to ropes:RopeBufferCharIterator:ropes#RopeBufferCharIterator#from */
(nitmethod_t)core___core__RopeBufferCharIterator___sit, /* pointer to ropes:RopeBufferCharIterator:ropes#RopeBufferCharIterator#sit */
(nitmethod_t)core___core__RopeBufferCharIterator___sit_61d, /* pointer to ropes:RopeBufferCharIterator:ropes#RopeBufferCharIterator#sit= */
}
};
/* allocate RopeBufferCharIterator */
val* NEW_core__RopeBufferCharIterator(const struct type* type) {
val* self /* : RopeBufferCharIterator */;
self = nit_alloc(sizeof(struct instance) + 1*sizeof(nitattribute_t));
self->type = type;
self->class = &class_core__RopeBufferCharIterator;
return self;
}
/* runtime class core__RopeBufferCharReverseIterator: core::RopeBufferCharReverseIterator (dead=false; need_corpse=false)*/
const struct class class_core__RopeBufferCharReverseIterator = {
0, /* box_kind */
{
(nitmethod_t)core___core__Object___init, /* pointer to ropes:RopeBufferCharReverseIterator:kernel#Object#init */
(nitmethod_t)core___core__Object____33d_61d, /* pointer to ropes:RopeBufferCharReverseIterator:kernel#Object#!= */
(nitmethod_t)core___core__Object___sys, /* pointer to ropes:RopeBufferCharReverseIterator:kernel#Object#sys */
(nitmethod_t)core__abstract_text___Object___to_s, /* pointer to ropes:RopeBufferCharReverseIterator:abstract_text#Object#to_s */
(nitmethod_t)core___core__Object____61d_61d, /* pointer to ropes:RopeBufferCharReverseIterator:kernel#Object#== */
(nitmethod_t)core___core__Object___is_same_instance, /* pointer to ropes:RopeBufferCharReverseIterator:kernel#Object#is_same_instance */
(nitmethod_t)core__abstract_text___Object___inspect, /* pointer to ropes:RopeBufferCharReverseIterator:abstract_text#Object#inspect */
(nitmethod_t)core___core__Object___object_id, /* pointer to ropes:RopeBufferCharReverseIterator:kernel#Object#object_id */
(nitmethod_t)core__abstract_text___Object___class_name, /* pointer to ropes:RopeBufferCharReverseIterator:abstract_text#Object#class_name */
(nitmethod_t)core__abstract_text___Object___inspect_head, /* pointer to ropes:RopeBufferCharReverseIterator:abstract_text#Object#inspect_head */
(nitmethod_t)core__abstract_text___Object___native_class_name, /* pointer to ropes:RopeBufferCharReverseIterator:abstract_text#Object#native_class_name */
(nitmethod_t)core___core__Object___hash, /* pointer to ropes:RopeBufferCharReverseIterator:kernel#Object#hash */
(nitmethod_t)core___core__RopeBufferCharReverseIterator___core__abstract_collection__Iterator__is_ok, /* pointer to ropes:RopeBufferCharReverseIterator:ropes#RopeBufferCharReverseIterator#is_ok */
(nitmethod_t)VIRTUAL_core___core__RopeBufferCharReverseIterator___core__abstract_collection__Iterator__item, /* pointer to ropes:RopeBufferCharReverseIterator:ropes#RopeBufferCharReverseIterator#item */
(nitmethod_t)core___core__RopeBufferCharReverseIterator___core__abstract_collection__Iterator__next, /* pointer to ropes:RopeBufferCharReverseIterator:ropes#RopeBufferCharReverseIterator#next */
(nitmethod_t)core___core__Iterator___finish, /* pointer to ropes:RopeBufferCharReverseIterator:abstract_collection#Iterator#finish */
(nitmethod_t)core___core__Iterator___iterator, /* pointer to ropes:RopeBufferCharReverseIterator:abstract_collection#Iterator#iterator */
(nitmethod_t)core__array___Iterator___to_a, /* pointer to ropes:RopeBufferCharReverseIterator:array#Iterator#to_a */
(nitmethod_t)core___core__RopeBufferCharReverseIterator___core__abstract_collection__IndexedIterator__index, /* pointer to ropes:RopeBufferCharReverseIterator:ropes#RopeBufferCharReverseIterator#index */
(nitmethod_t)core___core__RopeBufferCharReverseIterator___from, /* pointer to ropes:RopeBufferCharReverseIterator:ropes#RopeBufferCharReverseIterator#from */
(nitmethod_t)core___core__RopeBufferCharReverseIterator___sit, /* pointer to ropes:RopeBufferCharReverseIterator:ropes#RopeBufferCharReverseIterator#sit */
(nitmethod_t)core___core__RopeBufferCharReverseIterator___sit_61d, /* pointer to ropes:RopeBufferCharReverseIterator:ropes#RopeBufferCharReverseIterator#sit= */
}
};
/* allocate RopeBufferCharReverseIterator */
val* NEW_core__RopeBufferCharReverseIterator(const struct type* type) {
val* self /* : RopeBufferCharReverseIterator */;
self = nit_alloc(sizeof(struct instance) + 1*sizeof(nitattribute_t));
self->type = type;
self->class = &class_core__RopeBufferCharReverseIterator;
return self;
}
/* runtime class core__RopeBufferChars: core::RopeBufferChars (dead=false; need_corpse=false)*/
const struct class class_core__RopeBufferChars = {
0, /* box_kind */
{
(nitmethod_t)core__abstract_text___core__abstract_text__StringCharView___core__kernel__Object__init, /* pointer to ropes:RopeBufferChars:abstract_text#StringCharView#init */
(nitmethod_t)core___core__Object____33d_61d, /* pointer to ropes:RopeBufferChars:kernel#Object#!= */
(nitmethod_t)core___core__Object___sys, /* pointer to ropes:RopeBufferChars:kernel#Object#sys */
(nitmethod_t)core__abstract_text___Collection___Object__to_s, /* pointer to ropes:RopeBufferChars:abstract_text#Collection#to_s */
(nitmethod_t)core___core__SequenceRead___core__kernel__Object___61d_61d, /* pointer to ropes:RopeBufferChars:abstract_collection#SequenceRead#== */
(nitmethod_t)core___core__Object___is_same_instance, /* pointer to ropes:RopeBufferChars:kernel#Object#is_same_instance */
(nitmethod_t)core__abstract_text___Object___inspect, /* pointer to ropes:RopeBufferChars:abstract_text#Object#inspect */
(nitmethod_t)core___core__Object___object_id, /* pointer to ropes:RopeBufferChars:kernel#Object#object_id */
(nitmethod_t)core__abstract_text___Object___class_name, /* pointer to ropes:RopeBufferChars:abstract_text#Object#class_name */
(nitmethod_t)core__abstract_text___Object___inspect_head, /* pointer to ropes:RopeBufferChars:abstract_text#Object#inspect_head */
(nitmethod_t)core__abstract_text___Object___native_class_name, /* pointer to ropes:RopeBufferChars:abstract_text#Object#native_class_name */
(nitmethod_t)core___core__SequenceRead___core__kernel__Object__hash, /* pointer to ropes:RopeBufferChars:abstract_collection#SequenceRead#hash */
(nitmethod_t)core__abstract_text___core__abstract_text__StringCharView___target_61d, /* pointer to ropes:RopeBufferChars:abstract_text#StringCharView#target= */
(nitmethod_t)core__abstract_text___core__abstract_text__StringCharView___target, /* pointer to ropes:RopeBufferChars:abstract_text#StringCharView#target */
(nitmethod_t)core___core__Object___init, /* pointer to ropes:RopeBufferChars:kernel#Object#init */
NULL, /* empty */
NULL, /* empty */
(nitmethod_t)core__abstract_text___Collection___join, /* pointer to ropes:RopeBufferChars:abstract_text#Collection#join */
(nitmethod_t)core__array___Collection___to_a, /* pointer to ropes:RopeBufferChars:array#Collection#to_a */
(nitmethod_t)core__abstract_text___core__abstract_text__StringCharView___core__abstract_collection__Collection__length, /* pointer to ropes:RopeBufferChars:abstract_text#StringCharView#length */
(nitmethod_t)core__abstract_text___core__abstract_text__StringCharView___core__abstract_collection__Collection__is_empty, /* pointer to ropes:RopeBufferChars:abstract_text#StringCharView#is_empty */
(nitmethod_t)core__abstract_text___core__abstract_text__StringCharView___core__abstract_collection__Collection__iterator, /* pointer to ropes:RopeBufferChars:abstract_text#StringCharView#iterator */
(nitmethod_t)core___core__Collection___has_all, /* pointer to ropes:RopeBufferChars:abstract_collection#Collection#has_all */
(nitmethod_t)core___core__Collection___has, /* pointer to ropes:RopeBufferChars:abstract_collection#Collection#has */
(nitmethod_t)core___core__SequenceRead___Collection__first, /* pointer to ropes:RopeBufferChars:abstract_collection#SequenceRead#first */
(nitmethod_t)core___core__Collection___not_empty, /* pointer to ropes:RopeBufferChars:abstract_collection#Collection#not_empty */
(nitmethod_t)core__abstract_text___Collection___plain_to_s, /* pointer to ropes:RopeBufferChars:abstract_text#Collection#plain_to_s */
NULL, /* empty */
NULL, /* empty */
(nitmethod_t)VIRTUAL_core___core__RopeBufferChars___core__abstract_collection__SequenceRead___91d_93d, /* pointer to ropes:RopeBufferChars:ropes#RopeBufferChars#[] */
(nitmethod_t)core___core__RopeBufferChars___core__abstract_collection__SequenceRead__iterator_from, /* pointer to ropes:RopeBufferChars:ropes#RopeBufferChars#iterator_from */
(nitmethod_t)core___core__SequenceRead___index_of, /* pointer to ropes:RopeBufferChars:abstract_collection#SequenceRead#index_of */
(nitmethod_t)core___core__SequenceRead___last_index_of, /* pointer to ropes:RopeBufferChars:abstract_collection#SequenceRead#last_index_of */
(nitmethod_t)core___core__SequenceRead___index_of_from, /* pointer to ropes:RopeBufferChars:abstract_collection#SequenceRead#index_of_from */
(nitmethod_t)core___core__SequenceRead___last, /* pointer to ropes:RopeBufferChars:abstract_collection#SequenceRead#last */
(nitmethod_t)core___core__SequenceRead___last_index_of_from, /* pointer to ropes:RopeBufferChars:abstract_collection#SequenceRead#last_index_of_from */
(nitmethod_t)core__abstract_text___core__abstract_text__StringCharView___core__abstract_collection__SequenceRead__reverse_iterator, /* pointer to ropes:RopeBufferChars:abstract_text#StringCharView#reverse_iterator */
(nitmethod_t)core___core__RopeBufferChars___core__abstract_collection__SequenceRead__reverse_iterator_from, /* pointer to ropes:RopeBufferChars:ropes#RopeBufferChars#reverse_iterator_from */
(nitmethod_t)core___core__RemovableCollection___remove, /* pointer to ropes:RopeBufferChars:abstract_collection#RemovableCollection#remove */
(nitmethod_t)core___core__RemovableCollection___clear, /* pointer to ropes:RopeBufferChars:abstract_collection#RemovableCollection#clear */
NULL, /* empty */
NULL, /* empty */
NULL, /* empty */
NULL, /* empty */
(nitmethod_t)core___core__SimpleCollection___add_all, /* pointer to ropes:RopeBufferChars:abstract_collection#SimpleCollection#add_all */
(nitmethod_t)VIRTUAL_core___core__RopeBufferChars___core__abstract_collection__SimpleCollection__add, /* pointer to ropes:RopeBufferChars:ropes#RopeBufferChars#add */
(nitmethod_t)VIRTUAL_core___core__RopeBufferChars___core__abstract_collection__Sequence__push, /* pointer to ropes:RopeBufferChars:ropes#RopeBufferChars#push */
(nitmethod_t)core___core__Sequence___append, /* pointer to ropes:RopeBufferChars:abstract_collection#Sequence#append */
(nitmethod_t)VIRTUAL_core___core__RopeBufferChars___core__abstract_collection__Sequence___91d_93d_61d, /* pointer to ropes:RopeBufferChars:ropes#RopeBufferChars#[]= */
(nitmethod_t)core___core__Sequence___remove_at, /* pointer to ropes:RopeBufferChars:abstract_collection#Sequence#remove_at */
(nitmethod_t)core___core__Sequence___pop, /* pointer to ropes:RopeBufferChars:abstract_collection#Sequence#pop */
(nitmethod_t)core___core__Sequence___shift, /* pointer to ropes:RopeBufferChars:abstract_collection#Sequence#shift */
(nitmethod_t)core___core__Sequence___prepend, /* pointer to ropes:RopeBufferChars:abstract_collection#Sequence#prepend */
(nitmethod_t)core___core__Sequence___insert_all, /* pointer to ropes:RopeBufferChars:abstract_collection#Sequence#insert_all */
(nitmethod_t)core___core__Sequence___unshift, /* pointer to ropes:RopeBufferChars:abstract_collection#Sequence#unshift */
(nitmethod_t)core___core__Sequence___insert, /* pointer to ropes:RopeBufferChars:abstract_collection#Sequence#insert */
(nitmethod_t)core___core__Sequence___first_61d, /* pointer to ropes:RopeBufferChars:abstract_collection#Sequence#first= */
}
};
...
self = nit_alloc(sizeof(struct instance) + 1*sizeof(nitattribute_t));
self->type = type;
self->class = &class_core__RopeBufferChars;
return self;
}
/* runtime class core__RopeBufferByteIterator: core::RopeBufferByteIterator (dead=false; need_corpse=false)*/
const struct class class_core__RopeBufferByteIterator = {
0, /* box_kind */
{
(nitmethod_t)core___core__Object___init, /* pointer to ropes:RopeBufferByteIterator:kernel#Object#init */
(nitmethod_t)core___core__Object____33d_61d, /* pointer to ropes:RopeBufferByteIterator:kernel#Object#!= */
(nitmethod_t)core___core__Object___sys, /* pointer to ropes:RopeBufferByteIterator:kernel#Object#sys */
(nitmethod_t)core__abstract_text___Object___to_s, /* pointer to ropes:RopeBufferByteIterator:abstract_text#Object#to_s */
(nitmethod_t)core___core__Object____61d_61d, /* pointer to ropes:RopeBufferByteIterator:kernel#Object#== */
(nitmethod_t)core___core__Object___is_same_instance, /* pointer to ropes:RopeBufferByteIterator:kernel#Object#is_same_instance */
(nitmethod_t)core__abstract_text___Object___inspect, /* pointer to ropes:RopeBufferByteIterator:abstract_text#Object#inspect */
(nitmethod_t)core___core__Object___object_id, /* pointer to ropes:RopeBufferByteIterator:kernel#Object#object_id */
(nitmethod_t)core__abstract_text___Object___class_name, /* pointer to ropes:RopeBufferByteIterator:abstract_text#Object#class_name */
(nitmethod_t)core__abstract_text___Object___inspect_head, /* pointer to ropes:RopeBufferByteIterator:abstract_text#Object#inspect_head */
(nitmethod_t)core__abstract_text___Object___native_class_name, /* pointer to ropes:RopeBufferByteIterator:abstract_text#Object#native_class_name */
(nitmethod_t)core___core__Object___hash, /* pointer to ropes:RopeBufferByteIterator:kernel#Object#hash */
(nitmethod_t)core___core__RopeBufferByteIterator___core__abstract_collection__Iterator__is_ok, /* pointer to ropes:RopeBufferByteIterator:ropes#RopeBufferByteIterator#is_ok */
(nitmethod_t)VIRTUAL_core___core__RopeBufferByteIterator___core__abstract_collection__Iterator__item, /* pointer to ropes:RopeBufferByteIterator:ropes#RopeBufferByteIterator#item */
(nitmethod_t)core___core__RopeBufferByteIterator___core__abstract_collection__Iterator__next, /* pointer to ropes:RopeBufferByteIterator:ropes#RopeBufferByteIterator#next */
(nitmethod_t)core___core__Iterator___finish, /* pointer to ropes:RopeBufferByteIterator:abstract_collection#Iterator#finish */
(nitmethod_t)core___core__Iterator___iterator, /* pointer to ropes:RopeBufferByteIterator:abstract_collection#Iterator#iterator */
(nitmethod_t)core__array___Iterator___to_a, /* pointer to ropes:RopeBufferByteIterator:array#Iterator#to_a */
(nitmethod_t)core___core__RopeBufferByteIterator___core__abstract_collection__IndexedIterator__index, /* pointer to ropes:RopeBufferByteIterator:ropes#RopeBufferByteIterator#index */
(nitmethod_t)core___core__RopeBufferByteIterator___from, /* pointer to ropes:RopeBufferByteIterator:ropes#RopeBufferByteIterator#from */
(nitmethod_t)core___core__RopeBufferByteIterator___maxpos, /* pointer to ropes:RopeBufferByteIterator:ropes#RopeBufferByteIterator#maxpos */
(nitmethod_t)core___core__RopeBufferByteIterator___sit, /* pointer to ropes:RopeBufferByteIterator:ropes#RopeBufferByteIterator#sit */
(nitmethod_t)core___core__RopeBufferByteIterator___ns, /* pointer to ropes:RopeBufferByteIterator:ropes#RopeBufferByteIterator#ns */
(nitmethod_t)core___core__RopeBufferByteIterator___pns, /* pointer to ropes:RopeBufferByteIterator:ropes#RopeBufferByteIterator#pns */
(nitmethod_t)core___core__RopeBufferByteIterator___index_61d, /* pointer to ropes:RopeBufferByteIterator:ropes#RopeBufferByteIterator#index= */
(nitmethod_t)core___core__RopeBufferByteIterator___pns_61d, /* pointer to ropes:RopeBufferByteIterator:ropes#RopeBufferByteIterator#pns= */
(nitmethod_t)core___core__RopeBufferByteIterator___ns_61d, /* pointer to ropes:RopeBufferByteIterator:ropes#RopeBufferByteIterator#ns= */
(nitmethod_t)core___core__RopeBufferByteIterator___maxpos_61d, /* pointer to ropes:RopeBufferByteIterator:ropes#RopeBufferByteIterator#maxpos= */
(nitmethod_t)core___core__RopeBufferByteIterator___sit_61d, /* pointer to ropes:RopeBufferByteIterator:ropes#RopeBufferByteIterator#sit= */
}
};
/* allocate RopeBufferByteIterator */
val* NEW_core__RopeBufferByteIterator(const struct type* type) {
val* self /* : RopeBufferByteIterator */;
self = nit_alloc(sizeof(struct instance) + 5*sizeof(nitattribute_t));
self->type = type;
self->class = &class_core__RopeBufferByteIterator;
return self;
}
/* runtime class core__RopeBufferByteReverseIterator: core::RopeBufferByteReverseIterator (dead=false; need_corpse=false)*/
const struct class class_core__RopeBufferByteReverseIterator = {
0, /* box_kind */
{
(nitmethod_t)core___core__Object___init, /* pointer to ropes:RopeBufferByteReverseIterator:kernel#Object#init */
(nitmethod_t)core___core__Object____33d_61d, /* pointer to ropes:RopeBufferByteReverseIterator:kernel#Object#!= */
(nitmethod_t)core___core__Object___sys, /* pointer to ropes:RopeBufferByteReverseIterator:kernel#Object#sys */
(nitmethod_t)core__abstract_text___Object___to_s, /* pointer to ropes:RopeBufferByteReverseIterator:abstract_text#Object#to_s */
(nitmethod_t)core___core__Object____61d_61d, /* pointer to ropes:RopeBufferByteReverseIterator:kernel#Object#== */
(nitmethod_t)core___core__Object___is_same_instance, /* pointer to ropes:RopeBufferByteReverseIterator:kernel#Object#is_same_instance */
(nitmethod_t)core__abstract_text___Object___inspect, /* pointer to ropes:RopeBufferByteReverseIterator:abstract_text#Object#inspect */
(nitmethod_t)core___core__Object___object_id, /* pointer to ropes:RopeBufferByteReverseIterator:kernel#Object#object_id */
(nitmethod_t)core__abstract_text___Object___class_name, /* pointer to ropes:RopeBufferByteReverseIterator:abstract_text#Object#class_name */
(nitmethod_t)core__abstract_text___Object___inspect_head, /* pointer to ropes:RopeBufferByteReverseIterator:abstract_text#Object#inspect_head */
(nitmethod_t)core__abstract_text___Object___native_class_name, /* pointer to ropes:RopeBufferByteReverseIterator:abstract_text#Object#native_class_name */
(nitmethod_t)core___core__Object___hash, /* pointer to ropes:RopeBufferByteReverseIterator:kernel#Object#hash */
(nitmethod_t)core___core__RopeBufferByteReverseIterator___core__abstract_collection__Iterator__is_ok, /* pointer to ropes:RopeBufferByteReverseIterator:ropes#RopeBufferByteReverseIterator#is_ok */
(nitmethod_t)VIRTUAL_core___core__RopeBufferByteReverseIterator___core__abstract_collection__Iterator__item, /* pointer to ropes:RopeBufferByteReverseIterator:ropes#RopeBufferByteReverseIterator#item */
(nitmethod_t)core___core__RopeBufferByteReverseIterator___core__abstract_collection__Iterator__next, /* pointer to ropes:RopeBufferByteReverseIterator:ropes#RopeBufferByteReverseIterator#next */
(nitmethod_t)core___core__Iterator___finish, /* pointer to ropes:RopeBufferByteReverseIterator:abstract_collection#Iterator#finish */
(nitmethod_t)core___core__Iterator___iterator, /* pointer to ropes:RopeBufferByteReverseIterator:abstract_collection#Iterator#iterator */
(nitmethod_t)core__array___Iterator___to_a, /* pointer to ropes:RopeBufferByteReverseIterator:array#Iterator#to_a */
(nitmethod_t)core___core__RopeBufferByteReverseIterator___core__abstract_collection__IndexedIterator__index, /* pointer to ropes:RopeBufferByteReverseIterator:ropes#RopeBufferByteReverseIterator#index */
(nitmethod_t)core___core__RopeBufferByteReverseIterator___from, /* pointer to ropes:RopeBufferByteReverseIterator:ropes#RopeBufferByteReverseIterator#from */
(nitmethod_t)core___core__RopeBufferByteReverseIterator___pns, /* pointer to ropes:RopeBufferByteReverseIterator:ropes#RopeBufferByteReverseIterator#pns */
(nitmethod_t)core___core__RopeBufferByteReverseIterator___ns, /* pointer to ropes:RopeBufferByteReverseIterator:ropes#RopeBufferByteReverseIterator#ns */
(nitmethod_t)core___core__RopeBufferByteReverseIterator___sit, /* pointer to ropes:RopeBufferByteReverseIterator:ropes#RopeBufferByteReverseIterator#sit */
(nitmethod_t)core___core__RopeBufferByteReverseIterator___index_61d, /* pointer to ropes:RopeBufferByteReverseIterator:ropes#RopeBufferByteReverseIterator#index= */
(nitmethod_t)core___core__RopeBufferByteReverseIterator___pns_61d, /* pointer to ropes:RopeBufferByteReverseIterator:ropes#RopeBufferByteReverseIterator#pns= */
(nitmethod_t)core___core__RopeBufferByteReverseIterator___sit_61d, /* pointer to ropes:RopeBufferByteReverseIterator:ropes#RopeBufferByteReverseIterator#sit= */
(nitmethod_t)core___core__RopeBufferByteReverseIterator___ns_61d, /* pointer to ropes:RopeBufferByteReverseIterator:ropes#RopeBufferByteReverseIterator#ns= */
}
};
/* allocate RopeBufferByteReverseIterator */
val* NEW_core__RopeBufferByteReverseIterator(const struct type* type) {
val* self /* : RopeBufferByteReverseIterator */;
self = nit_alloc(sizeof(struct instance) + 4*sizeof(nitattribute_t));
self->type = type;
self->class = &class_core__RopeBufferByteReverseIterator;
return self;
}
/* runtime class core__RopeBufferBytes: core::RopeBufferBytes (dead=false; need_corpse=false)*/
const struct class class_core__RopeBufferBytes = {
0, /* box_kind */
{
(nitmethod_t)core__abstract_text___core__abstract_text__StringByteView___core__kernel__Object__init, /* pointer to ropes:RopeBufferBytes:abstract_text#StringByteView#init */
(nitmethod_t)core___core__Object____33d_61d, /* pointer to ropes:RopeBufferBytes:kernel#Object#!= */
(nitmethod_t)core___core__Object___sys, /* pointer to ropes:RopeBufferBytes:kernel#Object#sys */
(nitmethod_t)core__abstract_text___Collection___Object__to_s, /* pointer to ropes:RopeBufferBytes:abstract_text#Collection#to_s */
(nitmethod_t)core___core__SequenceRead___core__kernel__Object___61d_61d, /* pointer to ropes:RopeBufferBytes:abstract_collection#SequenceRead#== */
(nitmethod_t)core___core__Object___is_same_instance, /* pointer to ropes:RopeBufferBytes:kernel#Object#is_same_instance */
(nitmethod_t)core__abstract_text___Object___inspect, /* pointer to ropes:RopeBufferBytes:abstract_text#Object#inspect */
(nitmethod_t)core___core__Object___object_id, /* pointer to ropes:RopeBufferBytes:kernel#Object#object_id */
(nitmethod_t)core__abstract_text___Object___class_name, /* pointer to ropes:RopeBufferBytes:abstract_text#Object#class_name */
(nitmethod_t)core__abstract_text___Object___inspect_head, /* pointer to ropes:RopeBufferBytes:abstract_text#Object#inspect_head */
(nitmethod_t)core__abstract_text___Object___native_class_name, /* pointer to ropes:RopeBufferBytes:abstract_text#Object#native_class_name */
(nitmethod_t)core___core__SequenceRead___core__kernel__Object__hash, /* pointer to ropes:RopeBufferBytes:abstract_collection#SequenceRead#hash */
(nitmethod_t)core__abstract_text___core__abstract_text__StringByteView___target_61d, /* pointer to ropes:RopeBufferBytes:abstract_text#StringByteView#target= */
(nitmethod_t)core__abstract_text___core__abstract_text__StringByteView___target, /* pointer to ropes:RopeBufferBytes:abstract_text#StringByteView#target */
(nitmethod_t)core___core__Object___init, /* pointer to ropes:RopeBufferBytes:kernel#Object#init */
NULL, /* empty */
NULL, /* empty */
(nitmethod_t)core__abstract_text___Collection___join, /* pointer to ropes:RopeBufferBytes:abstract_text#Collection#join */
(nitmethod_t)core__array___Collection___to_a, /* pointer to ropes:RopeBufferBytes:array#Collection#to_a */
(nitmethod_t)core__abstract_text___core__abstract_text__StringByteView___core__abstract_collection__Collection__length, /* pointer to ropes:RopeBufferBytes:abstract_text#StringByteView#length */
(nitmethod_t)core__abstract_text___core__abstract_text__StringByteView___core__abstract_collection__Collection__is_empty, /* pointer to ropes:RopeBufferBytes:abstract_text#StringByteView#is_empty */
(nitmethod_t)core__abstract_text___core__abstract_text__StringByteView___core__abstract_collection__Collection__iterator, /* pointer to ropes:RopeBufferBytes:abstract_text#StringByteView#iterator */
(nitmethod_t)core___core__Collection___has_all, /* pointer to ropes:RopeBufferBytes:abstract_collection#Collection#has_all */
(nitmethod_t)core___core__Collection___has, /* pointer to ropes:RopeBufferBytes:abstract_collection#Collection#has */
(nitmethod_t)core___core__SequenceRead___Collection__first, /* pointer to ropes:RopeBufferBytes:abstract_collection#SequenceRead#first */
(nitmethod_t)core___core__Collection___not_empty, /* pointer to ropes:RopeBufferBytes:abstract_collection#Collection#not_empty */
(nitmethod_t)core__abstract_text___Collection___plain_to_s, /* pointer to ropes:RopeBufferBytes:abstract_text#Collection#plain_to_s */
NULL, /* empty */
NULL, /* empty */
(nitmethod_t)VIRTUAL_core___core__RopeBufferBytes___core__abstract_collection__SequenceRead___91d_93d, /* pointer to ropes:RopeBufferBytes:ropes#RopeBufferBytes#[] */
(nitmethod_t)core___core__RopeBufferBytes___core__abstract_collection__SequenceRead__iterator_from, /* pointer to ropes:RopeBufferBytes:ropes#RopeBufferBytes#iterator_from */
(nitmethod_t)core___core__SequenceRead___index_of, /* pointer to ropes:RopeBufferBytes:abstract_collection#SequenceRead#index_of */
(nitmethod_t)core___core__SequenceRead___last_index_of, /* pointer to ropes:RopeBufferBytes:abstract_collection#SequenceRead#last_index_of */
(nitmethod_t)core___core__SequenceRead___index_of_from, /* pointer to ropes:RopeBufferBytes:abstract_collection#SequenceRead#index_of_from */
(nitmethod_t)core___core__SequenceRead___last, /* pointer to ropes:RopeBufferBytes:abstract_collection#SequenceRead#last */
(nitmethod_t)core___core__SequenceRead___last_index_of_from, /* pointer to ropes:RopeBufferBytes:abstract_collection#SequenceRead#last_index_of_from */
(nitmethod_t)core__abstract_text___core__abstract_text__StringByteView___core__abstract_collection__SequenceRead__reverse_iterator, /* pointer to ropes:RopeBufferBytes:abstract_text#StringByteView#reverse_iterator */
(nitmethod_t)core___core__RopeBufferBytes___core__abstract_collection__SequenceRead__reverse_iterator_from, /* pointer to ropes:RopeBufferBytes:ropes#RopeBufferBytes#reverse_iterator_from */
}
};
/* allocate RopeBufferBytes */
val* NEW_core__RopeBufferBytes(const struct type* type) {
val* self /* : RopeBufferBytes */;
self = nit_alloc(sizeof(struct instance) + 1*sizeof(nitattribute_t));
self->type = type;
self->class = &class_core__RopeBufferBytes;
return self;
}
...
(nitmethod_t)core__fixed_ints___Text___to_i, /* pointer to flat:FlatString:fixed_ints#Text#to_i */
...
(nitmethod_t)core__fixed_ints___Text___is_int, /* pointer to flat:FlatString:fixed_ints#Text#is_int */
...
(nitmethod_t)core___core__FlatString___core__abstract_text__Text__substring_from, /* pointer to flat:FlatString:flat#FlatString#substring_from */
...
(nitmethod_t)core___core__FlatText___Text__bytelen, /* pointer to flat:FlatString:abstract_text#FlatText#bytelen */
...
(nitmethod_t)core__fixed_ints___Text___strip_numhead, /* pointer to flat:FlatString:fixed_ints#Text#strip_numhead */
(nitmethod_t)core__fixed_ints___Text___get_numhead, /* pointer to flat:FlatString:fixed_ints#Text#get_numhead */
...
(nitmethod_t)core__fixed_ints___Text___to_num, /* pointer to flat:FlatString:fixed_ints#Text#to_num */
...
(nitmethod_t)core___core__FlatString___core__abstract_text__Text__bytes, /* pointer to flat:FlatString:flat#FlatString#bytes */
(nitmethod_t)core__fixed_ints___Text___is_num, /* pointer to flat:FlatString:fixed_ints#Text#is_num */
(nitmethod_t)core__fixed_ints___Text___get_numext, /* pointer to flat:FlatString:fixed_ints#Text#get_numext */
(nitmethod_t)core__fixed_ints___Text___strip_numext, /* pointer to flat:FlatString:fixed_ints#Text#strip_numext */
(nitmethod_t)core__environ___String___environ, /* pointer to flat:FlatString:environ#String#environ */
(nitmethod_t)core__ropes___FlatString___core__abstract_text__String___43d, /* pointer to flat:FlatString:ropes#FlatString#+ */
(nitmethod_t)core___core__String___to_snake_case, /* pointer to flat:FlatString:abstract_text#String#to_snake_case */
...
(nitmethod_t)core__file___String___file_exists, /* pointer to flat:FlatString:file#String#file_exists */
(nitmethod_t)core___core__FlatString___core__abstract_text__String___42d, /* pointer to flat:FlatString:flat#FlatString#* */
...
(nitmethod_t)core___core__FlatString___core__abstract_text__String__to_lower, /* pointer to flat:FlatString:flat#FlatString#to_lower */
...
(nitmethod_t)core___core__FlatString___core__abstract_text__String__to_upper, /* pointer to flat:FlatString:flat#FlatString#to_upper */
...
(nitmethod_t)core___core__FlatString___to_cstring_61d, /* pointer to flat:FlatString:flat#FlatString#to_cstring= */
...
self->attrs[COLOR_core__abstract_text__FlatText___bytelen].l = 0l; /* _bytelen on <self:FlatString exact> */
...
/* runtime class core__flat__FlatStringByteReverseIterator: core::flat::FlatStringByteReverseIterator (dead=false; need_corpse=false)*/
const struct class class_core__flat__FlatStringByteReverseIterator = {
0, /* box_kind */
{
(nitmethod_t)core__flat___core__flat__FlatStringByteReverseIterator___core__kernel__Object__init, /* pointer to flat:FlatStringByteReverseIterator:flat#FlatStringByteReverseIterator#init */
(nitmethod_t)core___core__Object____33d_61d, /* pointer to flat:FlatStringByteReverseIterator:kernel#Object#!= */
(nitmethod_t)core___core__Object___sys, /* pointer to flat:FlatStringByteReverseIterator:kernel#Object#sys */
(nitmethod_t)core__abstract_text___Object___to_s, /* pointer to flat:FlatStringByteReverseIterator:abstract_text#Object#to_s */
(nitmethod_t)core___core__Object____61d_61d, /* pointer to flat:FlatStringByteReverseIterator:kernel#Object#== */
(nitmethod_t)core___core__Object___is_same_instance, /* pointer to flat:FlatStringByteReverseIterator:kernel#Object#is_same_instance */
(nitmethod_t)core__abstract_text___Object___inspect, /* pointer to flat:FlatStringByteReverseIterator:abstract_text#Object#inspect */
(nitmethod_t)core___core__Object___object_id, /* pointer to flat:FlatStringByteReverseIterator:kernel#Object#object_id */
(nitmethod_t)core__abstract_text___Object___class_name, /* pointer to flat:FlatStringByteReverseIterator:abstract_text#Object#class_name */
(nitmethod_t)core__abstract_text___Object___inspect_head, /* pointer to flat:FlatStringByteReverseIterator:abstract_text#Object#inspect_head */
(nitmethod_t)core__abstract_text___Object___native_class_name, /* pointer to flat:FlatStringByteReverseIterator:abstract_text#Object#native_class_name */
(nitmethod_t)core___core__Object___hash, /* pointer to flat:FlatStringByteReverseIterator:kernel#Object#hash */
(nitmethod_t)core__flat___core__flat__FlatStringByteReverseIterator___core__abstract_collection__Iterator__is_ok, /* pointer to flat:FlatStringByteReverseIterator:flat#FlatStringByteReverseIterator#is_ok */
(nitmethod_t)VIRTUAL_core__flat___core__flat__FlatStringByteReverseIterator___core__abstract_collection__Iterator__item, /* pointer to flat:FlatStringByteReverseIterator:flat#FlatStringByteReverseIterator#item */
(nitmethod_t)core__flat___core__flat__FlatStringByteReverseIterator___core__abstract_collection__Iterator__next, /* pointer to flat:FlatStringByteReverseIterator:flat#FlatStringByteReverseIterator#next */
(nitmethod_t)core___core__Iterator___finish, /* pointer to flat:FlatStringByteReverseIterator:abstract_collection#Iterator#finish */
(nitmethod_t)core___core__Iterator___iterator, /* pointer to flat:FlatStringByteReverseIterator:abstract_collection#Iterator#iterator */
(nitmethod_t)core__array___Iterator___to_a, /* pointer to flat:FlatStringByteReverseIterator:array#Iterator#to_a */
(nitmethod_t)core__flat___core__flat__FlatStringByteReverseIterator___core__abstract_collection__IndexedIterator__index, /* pointer to flat:FlatStringByteReverseIterator:flat#FlatStringByteReverseIterator#index */
(nitmethod_t)core__flat___core__flat__FlatStringByteReverseIterator___target_61d, /* pointer to flat:FlatStringByteReverseIterator:flat#FlatStringByteReverseIterator#target= */
(nitmethod_t)core__flat___core__flat__FlatStringByteReverseIterator___curr_pos_61d, /* pointer to flat:FlatStringByteReverseIterator:flat#FlatStringByteReverseIterator#curr_pos= */
(nitmethod_t)core__flat___core__flat__FlatStringByteReverseIterator___target, /* pointer to flat:FlatStringByteReverseIterator:flat#FlatStringByteReverseIterator#target */
(nitmethod_t)core__flat___core__flat__FlatStringByteReverseIterator___target_items_61d, /* pointer to flat:FlatStringByteReverseIterator:flat#FlatStringByteReverseIterator#target_items= */
(nitmethod_t)core__flat___core__flat__FlatStringByteReverseIterator___curr_pos, /* pointer to flat:FlatStringByteReverseIterator:flat#FlatStringByteReverseIterator#curr_pos */
(nitmethod_t)core__flat___core__flat__FlatStringByteReverseIterator___target_items, /* pointer to flat:FlatStringByteReverseIterator:flat#FlatStringByteReverseIterator#target_items */
(nitmethod_t)core___core__Object___init, /* pointer to flat:FlatStringByteReverseIterator:kernel#Object#init */
}
};
/* allocate FlatStringByteReverseIterator */
val* NEW_core__flat__FlatStringByteReverseIterator(const struct type* type) {
val* self /* : FlatStringByteReverseIterator */;
self = nit_alloc(sizeof(struct instance) + 3*sizeof(nitattribute_t));
self->type = type;
self->class = &class_core__flat__FlatStringByteReverseIterator;
return self;
}
/* runtime class core__flat__FlatStringByteIterator: core::flat::FlatStringByteIterator (dead=false; need_corpse=false)*/
const struct class class_core__flat__FlatStringByteIterator = {
0, /* box_kind */
{
(nitmethod_t)core__flat___core__flat__FlatStringByteIterator___core__kernel__Object__init, /* pointer to flat:FlatStringByteIterator:flat#FlatStringByteIterator#init */
(nitmethod_t)core___core__Object____33d_61d, /* pointer to flat:FlatStringByteIterator:kernel#Object#!= */
(nitmethod_t)core___core__Object___sys, /* pointer to flat:FlatStringByteIterator:kernel#Object#sys */
(nitmethod_t)core__abstract_text___Object___to_s, /* pointer to flat:FlatStringByteIterator:abstract_text#Object#to_s */
(nitmethod_t)core___core__Object____61d_61d, /* pointer to flat:FlatStringByteIterator:kernel#Object#== */
(nitmethod_t)core___core__Object___is_same_instance, /* pointer to flat:FlatStringByteIterator:kernel#Object#is_same_instance */
(nitmethod_t)core__abstract_text___Object___inspect, /* pointer to flat:FlatStringByteIterator:abstract_text#Object#inspect */
(nitmethod_t)core___core__Object___object_id, /* pointer to flat:FlatStringByteIterator:kernel#Object#object_id */
(nitmethod_t)core__abstract_text___Object___class_name, /* pointer to flat:FlatStringByteIterator:abstract_text#Object#class_name */
(nitmethod_t)core__abstract_text___Object___inspect_head, /* pointer to flat:FlatStringByteIterator:abstract_text#Object#inspect_head */
(nitmethod_t)core__abstract_text___Object___native_class_name, /* pointer to flat:FlatStringByteIterator:abstract_text#Object#native_class_name */
(nitmethod_t)core___core__Object___hash, /* pointer to flat:FlatStringByteIterator:kernel#Object#hash */
(nitmethod_t)core__flat___core__flat__FlatStringByteIterator___core__abstract_collection__Iterator__is_ok, /* pointer to flat:FlatStringByteIterator:flat#FlatStringByteIterator#is_ok */
(nitmethod_t)VIRTUAL_core__flat___core__flat__FlatStringByteIterator___core__abstract_collection__Iterator__item, /* pointer to flat:FlatStringByteIterator:flat#FlatStringByteIterator#item */
(nitmethod_t)core__flat___core__flat__FlatStringByteIterator___core__abstract_collection__Iterator__next, /* pointer to flat:FlatStringByteIterator:flat#FlatStringByteIterator#next */
(nitmethod_t)core___core__Iterator___finish, /* pointer to flat:FlatStringByteIterator:abstract_collection#Iterator#finish */
(nitmethod_t)core___core__Iterator___iterator, /* pointer to flat:FlatStringByteIterator:abstract_collection#Iterator#iterator */
(nitmethod_t)core__array___Iterator___to_a, /* pointer to flat:FlatStringByteIterator:array#Iterator#to_a */
(nitmethod_t)core__flat___core__flat__FlatStringByteIterator___core__abstract_collection__IndexedIterator__index, /* pointer to flat:FlatStringByteIterator:flat#FlatStringByteIterator#index */
(nitmethod_t)core__flat___core__flat__FlatStringByteIterator___target_61d, /* pointer to flat:FlatStringByteIterator:flat#FlatStringByteIterator#target= */
(nitmethod_t)core__flat___core__flat__FlatStringByteIterator___curr_pos_61d, /* pointer to flat:FlatStringByteIterator:flat#FlatStringByteIterator#curr_pos= */
(nitmethod_t)core__flat___core__flat__FlatStringByteIterator___target, /* pointer to flat:FlatStringByteIterator:flat#FlatStringByteIterator#target */
(nitmethod_t)core__flat___core__flat__FlatStringByteIterator___target_items_61d, /* pointer to flat:FlatStringByteIterator:flat#FlatStringByteIterator#target_items= */
(nitmethod_t)core__flat___core__flat__FlatStringByteIterator___curr_pos, /* pointer to flat:FlatStringByteIterator:flat#FlatStringByteIterator#curr_pos */
(nitmethod_t)core__flat___core__flat__FlatStringByteIterator___target_items, /* pointer to flat:FlatStringByteIterator:flat#FlatStringByteIterator#target_items */
(nitmethod_t)core___core__Object___init, /* pointer to flat:FlatStringByteIterator:kernel#Object#init */
}
};
/* allocate FlatStringByteIterator */
val* NEW_core__flat__FlatStringByteIterator(const struct type* type) {
val* self /* : FlatStringByteIterator */;
self = nit_alloc(sizeof(struct instance) + 3*sizeof(nitattribute_t));
self->type = type;
self->class = &class_core__flat__FlatStringByteIterator;
return self;
}
/* runtime class core__flat__FlatStringByteView: core::flat::FlatStringByteView (dead=false; need_corpse=false)*/
const struct class class_core__flat__FlatStringByteView = {
0, /* box_kind */
{
(nitmethod_t)core__abstract_text___core__abstract_text__StringByteView___core__kernel__Object__init, /* pointer to flat:FlatStringByteView:abstract_text#StringByteView#init */
(nitmethod_t)core___core__Object____33d_61d, /* pointer to flat:FlatStringByteView:kernel#Object#!= */
(nitmethod_t)core___core__Object___sys, /* pointer to flat:FlatStringByteView:kernel#Object#sys */
(nitmethod_t)core__abstract_text___Collection___Object__to_s, /* pointer to flat:FlatStringByteView:abstract_text#Collection#to_s */
(nitmethod_t)core___core__SequenceRead___core__kernel__Object___61d_61d, /* pointer to flat:FlatStringByteView:abstract_collection#SequenceRead#== */
(nitmethod_t)core___core__Object___is_same_instance, /* pointer to flat:FlatStringByteView:kernel#Object#is_same_instance */
(nitmethod_t)core__abstract_text___Object___inspect, /* pointer to flat:FlatStringByteView:abstract_text#Object#inspect */
(nitmethod_t)core___core__Object___object_id, /* pointer to flat:FlatStringByteView:kernel#Object#object_id */
(nitmethod_t)core__abstract_text___Object___class_name, /* pointer to flat:FlatStringByteView:abstract_text#Object#class_name */
(nitmethod_t)core__abstract_text___Object___inspect_head, /* pointer to flat:FlatStringByteView:abstract_text#Object#inspect_head */
(nitmethod_t)core__abstract_text___Object___native_class_name, /* pointer to flat:FlatStringByteView:abstract_text#Object#native_class_name */
(nitmethod_t)core___core__SequenceRead___core__kernel__Object__hash, /* pointer to flat:FlatStringByteView:abstract_collection#SequenceRead#hash */
(nitmethod_t)core__abstract_text___core__abstract_text__StringByteView___target_61d, /* pointer to flat:FlatStringByteView:abstract_text#StringByteView#target= */
(nitmethod_t)core__abstract_text___core__abstract_text__StringByteView___target, /* pointer to flat:FlatStringByteView:abstract_text#StringByteView#target */
(nitmethod_t)core___core__Object___init, /* pointer to flat:FlatStringByteView:kernel#Object#init */
NULL, /* empty */
NULL, /* empty */
(nitmethod_t)core__abstract_text___Collection___join, /* pointer to flat:FlatStringByteView:abstract_text#Collection#join */
(nitmethod_t)core__array___Collection___to_a, /* pointer to flat:FlatStringByteView:array#Collection#to_a */
(nitmethod_t)core__abstract_text___core__abstract_text__StringByteView___core__abstract_collection__Collection__length, /* pointer to flat:FlatStringByteView:abstract_text#StringByteView#length */
(nitmethod_t)core__abstract_text___core__abstract_text__StringByteView___core__abstract_collection__Collection__is_empty, /* pointer to flat:FlatStringByteView:abstract_text#StringByteView#is_empty */
(nitmethod_t)core__abstract_text___core__abstract_text__StringByteView___core__abstract_collection__Collection__iterator, /* pointer to flat:FlatStringByteView:abstract_text#StringByteView#iterator */
(nitmethod_t)core___core__Collection___has_all, /* pointer to flat:FlatStringByteView:abstract_collection#Collection#has_all */
(nitmethod_t)core___core__Collection___has, /* pointer to flat:FlatStringByteView:abstract_collection#Collection#has */
(nitmethod_t)core___core__SequenceRead___Collection__first, /* pointer to flat:FlatStringByteView:abstract_collection#SequenceRead#first */
(nitmethod_t)core___core__Collection___not_empty, /* pointer to flat:FlatStringByteView:abstract_collection#Collection#not_empty */
(nitmethod_t)core__abstract_text___Collection___plain_to_s, /* pointer to flat:FlatStringByteView:abstract_text#Collection#plain_to_s */
NULL, /* empty */
NULL, /* empty */
(nitmethod_t)VIRTUAL_core__flat___core__flat__FlatStringByteView___core__abstract_collection__SequenceRead___91d_93d, /* pointer to flat:FlatStringByteView:flat#FlatStringByteView#[] */
(nitmethod_t)core__flat___core__flat__FlatStringByteView___core__abstract_collection__SequenceRead__iterator_from, /* pointer to flat:FlatStringByteView:flat#FlatStringByteView#iterator_from */
(nitmethod_t)core___core__SequenceRead___index_of, /* pointer to flat:FlatStringByteView:abstract_collection#SequenceRead#index_of */
(nitmethod_t)core___core__SequenceRead___last_index_of, /* pointer to flat:FlatStringByteView:abstract_collection#SequenceRead#last_index_of */
(nitmethod_t)core___core__SequenceRead___index_of_from, /* pointer to flat:FlatStringByteView:abstract_collection#SequenceRead#index_of_from */
(nitmethod_t)core___core__SequenceRead___last, /* pointer to flat:FlatStringByteView:abstract_collection#SequenceRead#last */
(nitmethod_t)core___core__SequenceRead___last_index_of_from, /* pointer to flat:FlatStringByteView:abstract_collection#SequenceRead#last_index_of_from */
(nitmethod_t)core__abstract_text___core__abstract_text__StringByteView___core__abstract_collection__SequenceRead__reverse_iterator, /* pointer to flat:FlatStringByteView:abstract_text#StringByteView#reverse_iterator */
(nitmethod_t)core__flat___core__flat__FlatStringByteView___core__abstract_collection__SequenceRead__reverse_iterator_from, /* pointer to flat:FlatStringByteView:flat#FlatStringByteView#reverse_iterator_from */
}
};
/* allocate FlatStringByteView */
val* NEW_core__flat__FlatStringByteView(const struct type* type) {
val* self /* : FlatStringByteView */;
self = nit_alloc(sizeof(struct instance) + 1*sizeof(nitattribute_t));
self->type = type;
self->class = &class_core__flat__FlatStringByteView;
return self;
}
...
(nitmethod_t)core___core__Buffer___core__kernel__Object__hash, /* pointer to flat:FlatBuffer:abstract_text#Buffer#hash */
...
(nitmethod_t)core__fixed_ints___Text___to_i, /* pointer to flat:FlatBuffer:fixed_ints#Text#to_i */
...
(nitmethod_t)core__fixed_ints___Text___is_int, /* pointer to flat:FlatBuffer:fixed_ints#Text#is_int */
...
(nitmethod_t)core___core__FlatText___Text__bytelen, /* pointer to flat:FlatBuffer:abstract_text#FlatText#bytelen */
...
(nitmethod_t)core__fixed_ints___Text___strip_numhead, /* pointer to flat:FlatBuffer:fixed_ints#Text#strip_numhead */
(nitmethod_t)core__fixed_ints___Text___get_numhead, /* pointer to flat:FlatBuffer:fixed_ints#Text#get_numhead */
...
(nitmethod_t)core__fixed_ints___Text___to_num, /* pointer to flat:FlatBuffer:fixed_ints#Text#to_num */
...
(nitmethod_t)core___core__FlatBuffer___core__abstract_text__Text__bytes, /* pointer to flat:FlatBuffer:flat#FlatBuffer#bytes */
(nitmethod_t)core__fixed_ints___Text___is_num, /* pointer to flat:FlatBuffer:fixed_ints#Text#is_num */
(nitmethod_t)core__fixed_ints___Text___get_numext, /* pointer to flat:FlatBuffer:fixed_ints#Text#get_numext */
(nitmethod_t)core__fixed_ints___Text___strip_numext, /* pointer to flat:FlatBuffer:fixed_ints#Text#strip_numext */
...
(nitmethod_t)core___core__Buffer___is_dirty, /* pointer to flat:FlatBuffer:abstract_text#Buffer#is_dirty */
(nitmethod_t)core___core__Buffer___is_dirty_61d, /* pointer to flat:FlatBuffer:abstract_text#Buffer#is_dirty= */
...
(nitmethod_t)core___core__FlatBuffer___real_items_61d, /* pointer to flat:FlatBuffer:flat#FlatBuffer#real_items= */
(nitmethod_t)core___core__FlatBuffer___real_items, /* pointer to flat:FlatBuffer:flat#FlatBuffer#real_items */
...
self->attrs[COLOR_core__abstract_text__Buffer___is_dirty].s = 1; /* _is_dirty on <self:FlatBuffer exact> */
...
self->attrs[COLOR_core__abstract_text__FlatText___bytelen].l = 0l; /* _bytelen on <self:FlatBuffer exact> */
...
self->attrs[COLOR_core__flat__FlatBuffer___char_cache].l = var; /* _char_cache on <self:FlatBuffer exact> */
{
{ /* Inline kernel#Int#unary - (1l) on <1l:Int> */
var4 = -1l;
var2 = var4;
...
self->attrs[COLOR_core__flat__FlatBuffer___byte_cache].l = var2; /* _byte_cache on <self:FlatBuffer exact> */
self->attrs[COLOR_core__flat__FlatBuffer___capacity].l = 0l; /* _capacity on <self:FlatBuffer exact> */
return self;
}
/* runtime class core__flat__FlatBufferByteReverseIterator: core::flat::FlatBufferByteReverseIterator (dead=false; need_corpse=false)*/
const struct class class_core__flat__FlatBufferByteReverseIterator = {
0, /* box_kind */
{
(nitmethod_t)core__flat___core__flat__FlatBufferByteReverseIterator___core__kernel__Object__init, /* pointer to flat:FlatBufferByteReverseIterator:flat#FlatBufferByteReverseIterator#init */
(nitmethod_t)core___core__Object____33d_61d, /* pointer to flat:FlatBufferByteReverseIterator:kernel#Object#!= */
(nitmethod_t)core___core__Object___sys, /* pointer to flat:FlatBufferByteReverseIterator:kernel#Object#sys */
(nitmethod_t)core__abstract_text___Object___to_s, /* pointer to flat:FlatBufferByteReverseIterator:abstract_text#Object#to_s */
(nitmethod_t)core___core__Object____61d_61d, /* pointer to flat:FlatBufferByteReverseIterator:kernel#Object#== */
(nitmethod_t)core___core__Object___is_same_instance, /* pointer to flat:FlatBufferByteReverseIterator:kernel#Object#is_same_instance */
(nitmethod_t)core__abstract_text___Object___inspect, /* pointer to flat:FlatBufferByteReverseIterator:abstract_text#Object#inspect */
(nitmethod_t)core___core__Object___object_id, /* pointer to flat:FlatBufferByteReverseIterator:kernel#Object#object_id */
(nitmethod_t)core__abstract_text___Object___class_name, /* pointer to flat:FlatBufferByteReverseIterator:abstract_text#Object#class_name */
(nitmethod_t)core__abstract_text___Object___inspect_head, /* pointer to flat:FlatBufferByteReverseIterator:abstract_text#Object#inspect_head */
(nitmethod_t)core__abstract_text___Object___native_class_name, /* pointer to flat:FlatBufferByteReverseIterator:abstract_text#Object#native_class_name */
(nitmethod_t)core___core__Object___hash, /* pointer to flat:FlatBufferByteReverseIterator:kernel#Object#hash */
(nitmethod_t)core__flat___core__flat__FlatBufferByteReverseIterator___core__abstract_collection__Iterator__is_ok, /* pointer to flat:FlatBufferByteReverseIterator:flat#FlatBufferByteReverseIterator#is_ok */
(nitmethod_t)VIRTUAL_core__flat___core__flat__FlatBufferByteReverseIterator___core__abstract_collection__Iterator__item, /* pointer to flat:FlatBufferByteReverseIterator:flat#FlatBufferByteReverseIterator#item */
(nitmethod_t)core__flat___core__flat__FlatBufferByteReverseIterator___core__abstract_collection__Iterator__next, /* pointer to flat:FlatBufferByteReverseIterator:flat#FlatBufferByteReverseIterator#next */
(nitmethod_t)core___core__Iterator___finish, /* pointer to flat:FlatBufferByteReverseIterator:abstract_collection#Iterator#finish */
(nitmethod_t)core___core__Iterator___iterator, /* pointer to flat:FlatBufferByteReverseIterator:abstract_collection#Iterator#iterator */
(nitmethod_t)core__array___Iterator___to_a, /* pointer to flat:FlatBufferByteReverseIterator:array#Iterator#to_a */
(nitmethod_t)core__flat___core__flat__FlatBufferByteReverseIterator___core__abstract_collection__IndexedIterator__index, /* pointer to flat:FlatBufferByteReverseIterator:flat#FlatBufferByteReverseIterator#index */
(nitmethod_t)core__flat___core__flat__FlatBufferByteReverseIterator___target_61d, /* pointer to flat:FlatBufferByteReverseIterator:flat#FlatBufferByteReverseIterator#target= */
(nitmethod_t)core__flat___core__flat__FlatBufferByteReverseIterator___curr_pos_61d, /* pointer to flat:FlatBufferByteReverseIterator:flat#FlatBufferByteReverseIterator#curr_pos= */
(nitmethod_t)core__flat___core__flat__FlatBufferByteReverseIterator___target_items_61d, /* pointer to flat:FlatBufferByteReverseIterator:flat#FlatBufferByteReverseIterator#target_items= */
(nitmethod_t)core__flat___core__flat__FlatBufferByteReverseIterator___target, /* pointer to flat:FlatBufferByteReverseIterator:flat#FlatBufferByteReverseIterator#target */
(nitmethod_t)core__flat___core__flat__FlatBufferByteReverseIterator___curr_pos, /* pointer to flat:FlatBufferByteReverseIterator:flat#FlatBufferByteReverseIterator#curr_pos */
(nitmethod_t)core__flat___core__flat__FlatBufferByteReverseIterator___target_items, /* pointer to flat:FlatBufferByteReverseIterator:flat#FlatBufferByteReverseIterator#target_items */
(nitmethod_t)core___core__Object___init, /* pointer to flat:FlatBufferByteReverseIterator:kernel#Object#init */
}
};
/* allocate FlatBufferByteReverseIterator */
val* NEW_core__flat__FlatBufferByteReverseIterator(const struct type* type) {
val* self /* : FlatBufferByteReverseIterator */;
self = nit_alloc(sizeof(struct instance) + 3*sizeof(nitattribute_t));
self->type = type;
self->class = &class_core__flat__FlatBufferByteReverseIterator;
return self;
}
/* runtime class core__flat__FlatBufferByteView: core::flat::FlatBufferByteView (dead=false; need_corpse=false)*/
const struct class class_core__flat__FlatBufferByteView = {
0, /* box_kind */
{
(nitmethod_t)core__abstract_text___core__abstract_text__StringByteView___core__kernel__Object__init, /* pointer to flat:FlatBufferByteView:abstract_text#StringByteView#init */
(nitmethod_t)core___core__Object____33d_61d, /* pointer to flat:FlatBufferByteView:kernel#Object#!= */
(nitmethod_t)core___core__Object___sys, /* pointer to flat:FlatBufferByteView:kernel#Object#sys */
(nitmethod_t)core__abstract_text___Collection___Object__to_s, /* pointer to flat:FlatBufferByteView:abstract_text#Collection#to_s */
(nitmethod_t)core___core__SequenceRead___core__kernel__Object___61d_61d, /* pointer to flat:FlatBufferByteView:abstract_collection#SequenceRead#== */
(nitmethod_t)core___core__Object___is_same_instance, /* pointer to flat:FlatBufferByteView:kernel#Object#is_same_instance */
(nitmethod_t)core__abstract_text___Object___inspect, /* pointer to flat:FlatBufferByteView:abstract_text#Object#inspect */
(nitmethod_t)core___core__Object___object_id, /* pointer to flat:FlatBufferByteView:kernel#Object#object_id */
(nitmethod_t)core__abstract_text___Object___class_name, /* pointer to flat:FlatBufferByteView:abstract_text#Object#class_name */
(nitmethod_t)core__abstract_text___Object___inspect_head, /* pointer to flat:FlatBufferByteView:abstract_text#Object#inspect_head */
(nitmethod_t)core__abstract_text___Object___native_class_name, /* pointer to flat:FlatBufferByteView:abstract_text#Object#native_class_name */
(nitmethod_t)core___core__SequenceRead___core__kernel__Object__hash, /* pointer to flat:FlatBufferByteView:abstract_collection#SequenceRead#hash */
(nitmethod_t)core__abstract_text___core__abstract_text__StringByteView___target_61d, /* pointer to flat:FlatBufferByteView:abstract_text#StringByteView#target= */
(nitmethod_t)core__abstract_text___core__abstract_text__StringByteView___target, /* pointer to flat:FlatBufferByteView:abstract_text#StringByteView#target */
(nitmethod_t)core___core__Object___init, /* pointer to flat:FlatBufferByteView:kernel#Object#init */
NULL, /* empty */
NULL, /* empty */
(nitmethod_t)core__abstract_text___Collection___join, /* pointer to flat:FlatBufferByteView:abstract_text#Collection#join */
(nitmethod_t)core__array___Collection___to_a, /* pointer to flat:FlatBufferByteView:array#Collection#to_a */
(nitmethod_t)core__abstract_text___core__abstract_text__StringByteView___core__abstract_collection__Collection__length, /* pointer to flat:FlatBufferByteView:abstract_text#StringByteView#length */
(nitmethod_t)core__abstract_text___core__abstract_text__StringByteView___core__abstract_collection__Collection__is_empty, /* pointer to flat:FlatBufferByteView:abstract_text#StringByteView#is_empty */
(nitmethod_t)core__abstract_text___core__abstract_text__StringByteView___core__abstract_collection__Collection__iterator, /* pointer to flat:FlatBufferByteView:abstract_text#StringByteView#iterator */
(nitmethod_t)core___core__Collection___has_all, /* pointer to flat:FlatBufferByteView:abstract_collection#Collection#has_all */
(nitmethod_t)core___core__Collection___has, /* pointer to flat:FlatBufferByteView:abstract_collection#Collection#has */
(nitmethod_t)core___core__SequenceRead___Collection__first, /* pointer to flat:FlatBufferByteView:abstract_collection#SequenceRead#first */
(nitmethod_t)core___core__Collection___not_empty, /* pointer to flat:FlatBufferByteView:abstract_collection#Collection#not_empty */
(nitmethod_t)core__abstract_text___Collection___plain_to_s, /* pointer to flat:FlatBufferByteView:abstract_text#Collection#plain_to_s */
NULL, /* empty */
NULL, /* empty */
(nitmethod_t)VIRTUAL_core__flat___core__flat__FlatBufferByteView___core__abstract_collection__SequenceRead___91d_93d, /* pointer to flat:FlatBufferByteView:flat#FlatBufferByteView#[] */
(nitmethod_t)core__flat___core__flat__FlatBufferByteView___core__abstract_collection__SequenceRead__iterator_from, /* pointer to flat:FlatBufferByteView:flat#FlatBufferByteView#iterator_from */
(nitmethod_t)core___core__SequenceRead___index_of, /* pointer to flat:FlatBufferByteView:abstract_collection#SequenceRead#index_of */
(nitmethod_t)core___core__SequenceRead___last_index_of, /* pointer to flat:FlatBufferByteView:abstract_collection#SequenceRead#last_index_of */
(nitmethod_t)core___core__SequenceRead___index_of_from, /* pointer to flat:FlatBufferByteView:abstract_collection#SequenceRead#index_of_from */
(nitmethod_t)core___core__SequenceRead___last, /* pointer to flat:FlatBufferByteView:abstract_collection#SequenceRead#last */
(nitmethod_t)core___core__SequenceRead___last_index_of_from, /* pointer to flat:FlatBufferByteView:abstract_collection#SequenceRead#last_index_of_from */
(nitmethod_t)core__abstract_text___core__abstract_text__StringByteView___core__abstract_collection__SequenceRead__reverse_iterator, /* pointer to flat:FlatBufferByteView:abstract_text#StringByteView#reverse_iterator */
(nitmethod_t)core__flat___core__flat__FlatBufferByteView___core__abstract_collection__SequenceRead__reverse_iterator_from, /* pointer to flat:FlatBufferByteView:flat#FlatBufferByteView#reverse_iterator_from */
}
};
/* allocate FlatBufferByteView */
val* NEW_core__flat__FlatBufferByteView(const struct type* type) {
val* self /* : FlatBufferByteView */;
self = nit_alloc(sizeof(struct instance) + 1*sizeof(nitattribute_t));
self->type = type;
self->class = &class_core__flat__FlatBufferByteView;
return self;
}
/* runtime class core__flat__FlatBufferByteIterator: core::flat::FlatBufferByteIterator (dead=false; need_corpse=false)*/
const struct class class_core__flat__FlatBufferByteIterator = {
0, /* box_kind */
{
(nitmethod_t)core__flat___core__flat__FlatBufferByteIterator___core__kernel__Object__init, /* pointer to flat:FlatBufferByteIterator:flat#FlatBufferByteIterator#init */
(nitmethod_t)core___core__Object____33d_61d, /* pointer to flat:FlatBufferByteIterator:kernel#Object#!= */
(nitmethod_t)core___core__Object___sys, /* pointer to flat:FlatBufferByteIterator:kernel#Object#sys */
(nitmethod_t)core__abstract_text___Object___to_s, /* pointer to flat:FlatBufferByteIterator:abstract_text#Object#to_s */
(nitmethod_t)core___core__Object____61d_61d, /* pointer to flat:FlatBufferByteIterator:kernel#Object#== */
(nitmethod_t)core___core__Object___is_same_instance, /* pointer to flat:FlatBufferByteIterator:kernel#Object#is_same_instance */
(nitmethod_t)core__abstract_text___Object___inspect, /* pointer to flat:FlatBufferByteIterator:abstract_text#Object#inspect */
(nitmethod_t)core___core__Object___object_id, /* pointer to flat:FlatBufferByteIterator:kernel#Object#object_id */
(nitmethod_t)core__abstract_text___Object___class_name, /* pointer to flat:FlatBufferByteIterator:abstract_text#Object#class_name */
(nitmethod_t)core__abstract_text___Object___inspect_head, /* pointer to flat:FlatBufferByteIterator:abstract_text#Object#inspect_head */
(nitmethod_t)core__abstract_text___Object___native_class_name, /* pointer to flat:FlatBufferByteIterator:abstract_text#Object#native_class_name */
(nitmethod_t)core___core__Object___hash, /* pointer to flat:FlatBufferByteIterator:kernel#Object#hash */
(nitmethod_t)core__flat___core__flat__FlatBufferByteIterator___core__abstract_collection__Iterator__is_ok, /* pointer to flat:FlatBufferByteIterator:flat#FlatBufferByteIterator#is_ok */
(nitmethod_t)VIRTUAL_core__flat___core__flat__FlatBufferByteIterator___core__abstract_collection__Iterator__item, /* pointer to flat:FlatBufferByteIterator:flat#FlatBufferByteIterator#item */
(nitmethod_t)core__flat___core__flat__FlatBufferByteIterator___core__abstract_collection__Iterator__next, /* pointer to flat:FlatBufferByteIterator:flat#FlatBufferByteIterator#next */
(nitmethod_t)core___core__Iterator___finish, /* pointer to flat:FlatBufferByteIterator:abstract_collection#Iterator#finish */
(nitmethod_t)core___core__Iterator___iterator, /* pointer to flat:FlatBufferByteIterator:abstract_collection#Iterator#iterator */
(nitmethod_t)core__array___Iterator___to_a, /* pointer to flat:FlatBufferByteIterator:array#Iterator#to_a */
(nitmethod_t)core__flat___core__flat__FlatBufferByteIterator___core__abstract_collection__IndexedIterator__index, /* pointer to flat:FlatBufferByteIterator:flat#FlatBufferByteIterator#index */
(nitmethod_t)core__flat___core__flat__FlatBufferByteIterator___target_61d, /* pointer to flat:FlatBufferByteIterator:flat#FlatBufferByteIterator#target= */
(nitmethod_t)core__flat___core__flat__FlatBufferByteIterator___curr_pos_61d, /* pointer to flat:FlatBufferByteIterator:flat#FlatBufferByteIterator#curr_pos= */
(nitmethod_t)core__flat___core__flat__FlatBufferByteIterator___target_items_61d, /* pointer to flat:FlatBufferByteIterator:flat#FlatBufferByteIterator#target_items= */
(nitmethod_t)core__flat___core__flat__FlatBufferByteIterator___target, /* pointer to flat:FlatBufferByteIterator:flat#FlatBufferByteIterator#target */
(nitmethod_t)core__flat___core__flat__FlatBufferByteIterator___curr_pos, /* pointer to flat:FlatBufferByteIterator:flat#FlatBufferByteIterator#curr_pos */
(nitmethod_t)core__flat___core__flat__FlatBufferByteIterator___target_items, /* pointer to flat:FlatBufferByteIterator:flat#FlatBufferByteIterator#target_items */
(nitmethod_t)core___core__Object___init, /* pointer to flat:FlatBufferByteIterator:kernel#Object#init */
}
};
/* allocate FlatBufferByteIterator */
val* NEW_core__flat__FlatBufferByteIterator(const struct type* type) {
val* self /* : FlatBufferByteIterator */;
self = nit_alloc(sizeof(struct instance) + 3*sizeof(nitattribute_t));
self->type = type;
self->class = &class_core__flat__FlatBufferByteIterator;
return self;
}
...
(nitmethod_t)core___core__Buffer___core__kernel__Object__hash, /* pointer to abstract_text:Buffer:abstract_text#Buffer#hash */
...
(nitmethod_t)core__fixed_ints___Text___to_i, /* pointer to abstract_text:Buffer:fixed_ints#Text#to_i */
...
(nitmethod_t)core__fixed_ints___Text___is_int, /* pointer to abstract_text:Buffer:fixed_ints#Text#is_int */
...
(nitmethod_t)core___core__Text___bytelen, /* pointer to abstract_text:Buffer:abstract_text#Text#bytelen */
...
(nitmethod_t)core__fixed_ints___Text___strip_numhead, /* pointer to abstract_text:Buffer:fixed_ints#Text#strip_numhead */
(nitmethod_t)core__fixed_ints___Text___get_numhead, /* pointer to abstract_text:Buffer:fixed_ints#Text#get_numhead */
...
(nitmethod_t)core__fixed_ints___Text___to_num, /* pointer to abstract_text:Buffer:fixed_ints#Text#to_num */
...
(nitmethod_t)core___core__Text___bytes, /* pointer to abstract_text:Buffer:abstract_text#Text#bytes */
(nitmethod_t)core__fixed_ints___Text___is_num, /* pointer to abstract_text:Buffer:fixed_ints#Text#is_num */
(nitmethod_t)core__fixed_ints___Text___get_numext, /* pointer to abstract_text:Buffer:fixed_ints#Text#get_numext */
(nitmethod_t)core__fixed_ints___Text___strip_numext, /* pointer to abstract_text:Buffer:fixed_ints#Text#strip_numext */
...
(nitmethod_t)core___core__Buffer___is_dirty, /* pointer to abstract_text:Buffer:abstract_text#Buffer#is_dirty */
(nitmethod_t)core___core__Buffer___is_dirty_61d, /* pointer to abstract_text:Buffer:abstract_text#Buffer#is_dirty= */
...
self->attrs[COLOR_core__abstract_text__Buffer___is_dirty].s = 1; /* _is_dirty on <self:Buffer exact> */
...
/* runtime class core__NativeString: core::NativeString (dead=false; need_corpse=true)*/
const struct class class_core__NativeString = {
6, /* box_kind */
{
(nitmethod_t)core___core__Object___init, /* pointer to native:NativeString:kernel#Object#init */
(nitmethod_t)VIRTUAL_core___core__NativeString___core__kernel__Object___33d_61d, /* pointer to native:NativeString:native#NativeString#!= */
(nitmethod_t)core___core__Object___sys, /* pointer to native:NativeString:kernel#Object#sys */
(nitmethod_t)VIRTUAL_core__flat___NativeString___core__abstract_text__Object__to_s, /* pointer to native:NativeString:flat#NativeString#to_s */
(nitmethod_t)VIRTUAL_core___core__NativeString___core__kernel__Object___61d_61d, /* pointer to native:NativeString:native#NativeString#== */
(nitmethod_t)core___core__Object___is_same_instance, /* pointer to native:NativeString:kernel#Object#is_same_instance */
(nitmethod_t)core__abstract_text___Object___inspect, /* pointer to native:NativeString:abstract_text#Object#inspect */
(nitmethod_t)core___core__Object___object_id, /* pointer to native:NativeString:kernel#Object#object_id */
(nitmethod_t)core__abstract_text___Object___class_name, /* pointer to native:NativeString:abstract_text#Object#class_name */
(nitmethod_t)core__abstract_text___Object___inspect_head, /* pointer to native:NativeString:abstract_text#Object#inspect_head */
(nitmethod_t)core__abstract_text___Object___native_class_name, /* pointer to native:NativeString:abstract_text#Object#native_class_name */
(nitmethod_t)core___core__Object___hash, /* pointer to native:NativeString:kernel#Object#hash */
(nitmethod_t)core___core__Pointer___address_is_null, /* pointer to native:NativeString:kernel#Pointer#address_is_null */
(nitmethod_t)core___core__Pointer___free, /* pointer to native:NativeString:kernel#Pointer#free */
(nitmethod_t)core___core__NativeString___new, /* pointer to native:NativeString:native#NativeString#new */
(nitmethod_t)core__flat___NativeString___to_s_full, /* pointer to native:NativeString:flat#NativeString#to_s_full */
(nitmethod_t)core__environ___NativeString___get_environ, /* pointer to native:NativeString:environ#NativeString#get_environ */
(nitmethod_t)core___core__NativeString___copy_to, /* pointer to native:NativeString:native#NativeString#copy_to */
(nitmethod_t)core___core__NativeString____91d_93d_61d, /* pointer to native:NativeString:native#NativeString#[]= */
(nitmethod_t)core__flat___NativeString___to_s_with_length, /* pointer to native:NativeString:flat#NativeString#to_s_with_length */
(nitmethod_t)core___core__NativeString___cstring_length, /* pointer to native:NativeString:native#NativeString#cstring_length */
(nitmethod_t)core__flat___NativeString___to_s_unsafe, /* pointer to native:NativeString:flat#NativeString#to_s_unsafe */
(nitmethod_t)core___core__NativeString____91d_93d, /* pointer to native:NativeString:native#NativeString#[] */
(nitmethod_t)core__flat___NativeString___clean_utf8, /* pointer to native:NativeString:flat#NativeString#clean_utf8 */
(nitmethod_t)core___core__NativeString___utf8_length, /* pointer to native:NativeString:native#NativeString#utf8_length */
(nitmethod_t)core__file___NativeString___file_exists, /* pointer to native:NativeString:file#NativeString#file_exists */
(nitmethod_t)core___core__NativeString___fetch_95d4_chars, /* pointer to native:NativeString:native#NativeString#fetch_4_chars */
(nitmethod_t)core___core__NativeString___length_of_char_at, /* pointer to native:NativeString:native#NativeString#length_of_char_at */
(nitmethod_t)core___core__NativeString___char_at, /* pointer to native:NativeString:native#NativeString#char_at */
(nitmethod_t)core___core__NativeString___find_beginning_of_char_at, /* pointer to native:NativeString:native#NativeString#find_beginning_of_char_at */
(nitmethod_t)core___core__NativeString___char_to_byte_index_cached, /* pointer to native:NativeString:native#NativeString#char_to_byte_index_cached */
(nitmethod_t)core___core__NativeString___char_to_byte_index, /* pointer to native:NativeString:native#NativeString#char_to_byte_index */
(nitmethod_t)core__flat___NativeString___set_char_at, /* pointer to native:NativeString:flat#NativeString#set_char_at */
(nitmethod_t)core___core__NativeString___fetch_95d4_ffi, /* pointer to native:NativeString:native#NativeString#fetch_4_ffi */
(nitmethod_t)core___core__NativeString___fetch_95d4_hchars, /* pointer to native:NativeString:native#NativeString#fetch_4_hchars */
(nitmethod_t)core__flat___NativeString___native_set_char, /* pointer to native:NativeString:flat#NativeString#native_set_char */
(nitmethod_t)core___core__NativeString___fetch_95d4h_ffi, /* pointer to native:NativeString:native#NativeString#fetch_4h_ffi */
(nitmethod_t)core__file___NativeString___file_stat, /* pointer to native:NativeString:file#NativeString#file_stat */
(nitmethod_t)core__file___NativeString___file_realpath, /* pointer to native:NativeString:file#NativeString#file_realpath */
(nitmethod_t)core__flat___NativeString___to_s_with_copy, /* pointer to native:NativeString:flat#NativeString#to_s_with_copy */
(nitmethod_t)core__file___NativeString___file_mkdir, /* pointer to native:NativeString:file#NativeString#file_mkdir */
(nitmethod_t)core__exec___NativeString___system, /* pointer to native:NativeString:exec#NativeString#system */
(nitmethod_t)core___core__NativeString___atof, /* pointer to native:NativeString:native#NativeString#atof */
}
};
/* allocate NativeString */
val* BOX_core__NativeString(void* value) {
struct instance_core__NativeString*res = nit_alloc(sizeof(struct instance_core__NativeString));
res->type = &type_core__NativeString;
res->class = &class_core__NativeString;
res->value = value;
return (val*)res;
}
...
(nitmethod_t)core__utf8___Sys___utf8_decoder, /* pointer to kernel:Sys:utf8#Sys#utf8_decoder */
(nitmethod_t)core__utf8___Sys___utf8_coder, /* pointer to kernel:Sys:utf8#Sys#utf8_coder */
...
(nitmethod_t)csv___core__Sys___rfc4180, /* pointer to kernel:Sys:csv#Sys#rfc4180 */
...
(nitmethod_t)core___core__Byte___ffi_ascii, /* pointer to kernel:Byte:kernel#Byte#ffi_ascii */
(nitmethod_t)core__math___Byte___band, /* pointer to kernel:Byte:math#Byte#band */
(nitmethod_t)core___core__Byte____62d_62d, /* pointer to kernel:Byte:kernel#Byte#>> */
(nitmethod_t)core___core__Byte___rsh, /* pointer to kernel:Byte:kernel#Byte#rsh */
(nitmethod_t)core__native___Byte___u8len, /* pointer to kernel:Byte:native#Byte#u8len */
}
};
/* allocate Byte */
...
(nitmethod_t)core___core__Int___lsh, /* pointer to kernel:Int:kernel#Int#lsh */
...
(nitmethod_t)core__flat___Int___to_base, /* pointer to kernel:Int:flat#Int#to_base */
(nitmethod_t)core__math___Int___band, /* pointer to kernel:Int:math#Int#band */
...
(nitmethod_t)core___core__Int___cp, /* pointer to kernel:Int:kernel#Int#cp */
...
(nitmethod_t)core__math___Int___bor, /* pointer to kernel:Int:math#Int#bor */
(nitmethod_t)core___core__Int___rsh, /* pointer to kernel:Int:kernel#Int#rsh */
...
(nitmethod_t)core___core__Char___cp, /* pointer to kernel:Char:kernel#Char#cp */
...
/* runtime class core__Set: core::Set (dead=true; need_corpse=false)*/
...
(nitmethod_t)core___core__Reader___read, /* pointer to file:FileReader:stream#Reader#read */
...
var = glob_sys;
{
var1 = core__utf8___Sys___utf8_decoder(var);
}
self->attrs[COLOR_core__stream__Reader___decoder].val = var1; /* _decoder on <self:FileReader exact> */
var2 = NULL/*special!*/;
{
{ /* Inline native#NativeString#new (var2,0l) on <var2:NativeString> */
...
var = glob_sys;
{
var1 = core__utf8___Sys___utf8_coder(var);
}
...
(nitmethod_t)core___core__Reader___read, /* pointer to file:Stdin:stream#Reader#read */
...
/* runtime class core__Coder: core::Coder (dead=true; need_corpse=false)*/
/* allocate Coder */
val* NEW_core__Coder(const struct type* type) {
PRINT_ERROR("Runtime error: %s", "Coder is DEAD");
PRINT_ERROR("\n");
fatal_exit(1);
}
/* runtime class core__Decoder: core::Decoder (dead=true; need_corpse=false)*/
/* allocate Decoder */
val* NEW_core__Decoder(const struct type* type) {
PRINT_ERROR("Runtime error: %s", "Decoder is DEAD");
PRINT_ERROR("\n");
fatal_exit(1);
}
/* runtime class core__utf8__UTF8Coder: core::utf8::UTF8Coder (dead=false; need_corpse=false)*/
const struct class class_core__utf8__UTF8Coder = {
0, /* box_kind */
{
(nitmethod_t)core___core__Object___init, /* pointer to utf8:UTF8Coder:kernel#Object#init */
(nitmethod_t)core___core__Object____33d_61d, /* pointer to utf8:UTF8Coder:kernel#Object#!= */
(nitmethod_t)core___core__Object___sys, /* pointer to utf8:UTF8Coder:kernel#Object#sys */
(nitmethod_t)core__abstract_text___Object___to_s, /* pointer to utf8:UTF8Coder:abstract_text#Object#to_s */
(nitmethod_t)core___core__Object____61d_61d, /* pointer to utf8:UTF8Coder:kernel#Object#== */
(nitmethod_t)core___core__Object___is_same_instance, /* pointer to utf8:UTF8Coder:kernel#Object#is_same_instance */
(nitmethod_t)core__abstract_text___Object___inspect, /* pointer to utf8:UTF8Coder:abstract_text#Object#inspect */
(nitmethod_t)core___core__Object___object_id, /* pointer to utf8:UTF8Coder:kernel#Object#object_id */
(nitmethod_t)core__abstract_text___Object___class_name, /* pointer to utf8:UTF8Coder:abstract_text#Object#class_name */
(nitmethod_t)core__abstract_text___Object___inspect_head, /* pointer to utf8:UTF8Coder:abstract_text#Object#inspect_head */
(nitmethod_t)core__abstract_text___Object___native_class_name, /* pointer to utf8:UTF8Coder:abstract_text#Object#native_class_name */
(nitmethod_t)core___core__Object___hash, /* pointer to utf8:UTF8Coder:kernel#Object#hash */
}
};
/* allocate UTF8Coder */
...
self = nit_alloc(sizeof(struct instance) + 0*sizeof(nitattribute_t));
self->type = type;
self->class = &class_core__utf8__UTF8Coder;
return self;
}
/* runtime class core__utf8__UTF8Decoder: core::utf8::UTF8Decoder (dead=false; need_corpse=false)*/
const struct class class_core__utf8__UTF8Decoder = {
0, /* box_kind */
{
(nitmethod_t)core___core__Object___init, /* pointer to utf8:UTF8Decoder:kernel#Object#init */
(nitmethod_t)core___core__Object____33d_61d, /* pointer to utf8:UTF8Decoder:kernel#Object#!= */
(nitmethod_t)core___core__Object___sys, /* pointer to utf8:UTF8Decoder:kernel#Object#sys */
(nitmethod_t)core__abstract_text___Object___to_s, /* pointer to utf8:UTF8Decoder:abstract_text#Object#to_s */
(nitmethod_t)core___core__Object____61d_61d, /* pointer to utf8:UTF8Decoder:kernel#Object#== */
(nitmethod_t)core___core__Object___is_same_instance, /* pointer to utf8:UTF8Decoder:kernel#Object#is_same_instance */
(nitmethod_t)core__abstract_text___Object___inspect, /* pointer to utf8:UTF8Decoder:abstract_text#Object#inspect */
(nitmethod_t)core___core__Object___object_id, /* pointer to utf8:UTF8Decoder:kernel#Object#object_id */
(nitmethod_t)core__abstract_text___Object___class_name, /* pointer to utf8:UTF8Decoder:abstract_text#Object#class_name */
(nitmethod_t)core__abstract_text___Object___inspect_head, /* pointer to utf8:UTF8Decoder:abstract_text#Object#inspect_head */
(nitmethod_t)core__abstract_text___Object___native_class_name, /* pointer to utf8:UTF8Decoder:abstract_text#Object#native_class_name */
(nitmethod_t)core___core__Object___hash, /* pointer to utf8:UTF8Decoder:kernel#Object#hash */
}
};
/* allocate UTF8Decoder */
val* NEW_core__utf8__UTF8Decoder(const struct type* type) {
val* self /* : UTF8Decoder */;
self = nit_alloc(sizeof(struct instance) + 0*sizeof(nitattribute_t));
self->type = type;
self->class = &class_core__utf8__UTF8Decoder;
return self;
}
...
(nitmethod_t)core___core__Object____61d_61d, /* pointer to poset:POSet:kernel#Object#== */
...
(nitmethod_t)core___core__Object___hash, /* pointer to poset:POSet:kernel#Object#hash */
