...
var_c = var8;
{
var9 = core__abstract_text___Char___is_numeric(var_c);
}
var10 = !var9;
if (var10){
{
...
{
var22 = core___core__Int___Discrete__successor(var_i, 1l);
}
var_i = var22;
}
BREAK_label: (void)0;
...
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_text, 1830);
fatal_exit(1);
}
PRINT_ERROR("Runtime error: %s", "Aborted");
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_text, 1832);
fatal_exit(1);
RET_LABEL:;
return var;
}
