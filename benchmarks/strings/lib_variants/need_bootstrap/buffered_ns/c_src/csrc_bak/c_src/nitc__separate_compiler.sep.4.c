...
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__separate_compiler, 1637);
fatal_exit(1);
}
var_ret = var4;
{
...
if (unlikely(var3 == NULL)) {
PRINT_ERROR("Runtime error: %s", "Cast failed");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__separate_compiler, 1694);
fatal_exit(1);
}
var_mtype = var3;
{
...
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__separate_compiler, 1709);
fatal_exit(1);
}
...
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__separate_compiler, 1758);
fatal_exit(1);
} else {
...
if (var20 == NULL) {
PRINT_ERROR("Runtime error: %s", "Receiver is null");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__separate_compiler, 1774);
fatal_exit(1);
} else {
...
if (var78 == NULL) {
PRINT_ERROR("Runtime error: %s", "Receiver is null");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__separate_compiler, 1792);
fatal_exit(1);
} else {
...
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 1058);
fatal_exit(1);
}
var137 = var139;
RET_LABEL138:(void)0;
...
if (var178 == NULL) {
PRINT_ERROR("Runtime error: %s", "Receiver is null");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__separate_compiler, 1807);
fatal_exit(1);
} else {
...
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 1057);
fatal_exit(1);
}
var220 = var222;
RET_LABEL221:(void)0;
...
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 1056);
fatal_exit(1);
}
var369 = var371;
RET_LABEL370:(void)0;
...
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__separate_compiler, 1871);
fatal_exit(1);
}
var_mtype1 = var79;
...
{
{ /* Inline abstract_compiler#RuntimeVariable#mtype (var_value) on <var_value:RuntimeVariable> */
var43 = var_value->attrs[COLOR_nitc__abstract_compiler__RuntimeVariable___mtype].val; /* _mtype on <var_value:RuntimeVariable> */
...
cltype = type_nitc__MClassType.color;
idtype = type_nitc__MClassType.id;
if(cltype >= var41->type->table_size) {
var44 = 0;
} else {
var44 = var41->type->type_table[cltype] == idtype;
}
var_ = var44;
if (var44){
{
...
/* <var45:MType> isa MClassType */
cltype49 = type_nitc__MClassType.color;
idtype50 = type_nitc__MClassType.id;
if(cltype49 >= var45->type->table_size) {
var48 = 0;
} else {
var48 = var45->type->type_table[cltype49] == idtype50;
}
if (unlikely(!var48)) {
...
{
{ /* Inline model#MClassType#mclass (var45) on <var45:MType(MClassType)> */
var53 = var45->attrs[COLOR_nitc__model__MClassType___mclass].val; /* _mclass on <var45:MType(MClassType)> */
if (unlikely(var53 == NULL)) {
PRINT_ERROR("Runtime error: %s", "Uninitialized attribute _mclass");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__model, 1166);
fatal_exit(1);
...
{
{ /* Inline model#MClass#kind (var51) on <var51:MClass> */
var56 = var51->attrs[COLOR_nitc__model__MClass___kind].val; /* _kind on <var51:MClass> */
if (unlikely(var56 == NULL)) {
...
var57 = glob_sys;
{
var58 = nitc__model___core__Sys___extern_kind(var57);
}
{
{ /* Inline kernel#Object#== (var54,var58) on <var54:MClassKind> */
var_other = var58;
{
{ /* Inline kernel#Object#is_same_instance (var54,var_other) on <var54:MClassKind> */
var63 = var54 == var_other;
var61 = var63;
goto RET_LABEL62;
RET_LABEL62:(void)0;
}
...
{
{ /* Inline abstract_compiler#RuntimeVariable#mtype (var_value) on <var_value:RuntimeVariable> */
var67 = var_value->attrs[COLOR_nitc__abstract_compiler__RuntimeVariable___mtype].val; /* _mtype on <var_value:RuntimeVariable> */
...
cltype69 = type_nitc__MClassType.color;
idtype70 = type_nitc__MClassType.id;
...
if (unlikely(!var68)) {
var_class_name71 = var65 == NULL ? "null" : var65->type->name;
PRINT_ERROR("Runtime error: Cast failed. Expected `%s`, got `%s`", "MClassType", var_class_name71);
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__separate_compiler, 1888);
fatal_exit(1);
}
{
var72 = nitc___nitc__MType___nitc__model_base__MEntity__name(var65);
}
if (likely(varonce73!=NULL)) {
var74 = varonce73;
} else {
...
{
{ /* Inline kernel#Object#!= (var72,var74) on <var72:String> */
var_other79 = var74;
{
var80 = ((short int(*)(val* self, val* p0))(var72->class->vft[COLOR_core__kernel__Object___61d_61d]))(var72, var_other79); /* == on <var72:String>*/
}
var81 = !var80;
var77 = var81;
goto RET_LABEL78;
...
if(cltype87 >= var83->type->table_size) {
var86 = 0;
} else {
var86 = var83->type->type_table[cltype87] == idtype88;
}
if (unlikely(!var86)) {
var_class_name89 = var83 == NULL ? "null" : var83->type->name;
PRINT_ERROR("Runtime error: Cast failed. Expected `%s`, got `%s`", "MClassType", var_class_name89);
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__separate_compiler, 1889);
fatal_exit(1);
}
{
var90 = nitc___nitc__MType___nitc__model_base__MEntity__name(var83);
}
if (likely(varonce91!=NULL)) {
var92 = varonce91;
} else {
var93 = "BufferedNativeString";
var94 = core__flat___NativeString___to_s_full(var93, 20l, 20l);
var92 = var94;
varonce91 = var92;
}
{
{ /* Inline kernel#Object#!= (var90,var92) on <var90:String> */
var_other79 = var92;
{
var97 = ((short int(*)(val* self, val* p0))(var90->class->vft[COLOR_core__kernel__Object___61d_61d]))(var90, var_other79); /* == on <var90:String>*/
}
var98 = !var97;
var95 = var98;
goto RET_LABEL96;
...
var100 = NEW_core__NativeArray(4l, &type_core__NativeArray__core__String);
if (likely(varonce101!=NULL)) {
var102 = varonce101;
} else {
var103 = " = \"";
var104 = core__flat___NativeString___to_s_full(var103, 4l, 4l);
var102 = var104;
varonce101 = var102;
}
...
((struct instance_core__NativeArray*)var100)->values[3]=var106;
} else {
var100 = varonce99;
varonce99 = NULL;
}
((struct instance_core__NativeArray*)var100)->values[0]=var_res;
{
{ /* Inline abstract_compiler#RuntimeVariable#mtype (var_value) on <var_value:RuntimeVariable> */
...
/* <var109:MType> isa MClassType */
cltype113 = type_nitc__MClassType.color;
idtype114 = type_nitc__MClassType.id;
if(cltype113 >= var109->type->table_size) {
var112 = 0;
} else {
var112 = var109->type->type_table[cltype113] == idtype114;
}
if (unlikely(!var112)) {
var_class_name115 = var109 == NULL ? "null" : var109->type->name;
PRINT_ERROR("Runtime error: Cast failed. Expected `%s`, got `%s`", "MClassType", var_class_name115);
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__separate_compiler, 1890);
fatal_exit(1);
}
{
{ /* Inline model#MClassType#mclass (var109) on <var109:MType(MClassType)> */
var118 = var109->attrs[COLOR_nitc__model__MClassType___mclass].val; /* _mclass on <var109:MType(MClassType)> */
...
{
var119 = ((val*(*)(val* self))(var116->class->vft[COLOR_core__abstract_text__Object__to_s]))(var116); /* to_s on <var116:MClass>*/
}
((struct instance_core__NativeArray*)var100)->values[2]=var119;
{
var120 = ((val*(*)(val* self))(var100->class->vft[COLOR_core__abstract_text__NativeArray__native_to_s]))(var100); /* native_to_s on <var100:NativeArray[String]>*/
}
varonce99 = var100;
{
nitc___nitc__AbstractCompilerVisitor___add(self, var120); /* Direct call abstract_compiler#AbstractCompilerVisitor#add on <self:SeparateCompilerVisitor>*/
...
var122 = NEW_core__NativeArray(2l, &type_core__NativeArray__core__String);
...
{
var130 = ((val*(*)(val* self))(var127->class->vft[COLOR_nitc__model_base__MEntity__c_name]))(var127); /* c_name on <var127:MType>*/
}
((struct instance_core__NativeArray*)var122)->values[1]=var130;
{
var131 = ((val*(*)(val* self))(var122->class->vft[COLOR_core__abstract_text__NativeArray__native_to_s]))(var122); /* native_to_s on <var122:NativeArray[String]>*/
}
varonce121 = var122;
{
nitc___nitc__AbstractCompilerVisitor___require_declaration(self, var131); /* Direct call abstract_compiler#AbstractCompilerVisitor#require_declaration on <self:SeparateCompilerVisitor>*/
}
if (unlikely(varonce132==NULL)) {
var133 = NEW_core__NativeArray(4l, &type_core__NativeArray__core__String);
if (likely(varonce134!=NULL)) {
var135 = varonce134;
} else {
var136 = " = type_";
var137 = core__flat___NativeString___to_s_full(var136, 8l, 8l);
var135 = var137;
varonce134 = var135;
}
...
var140 = ".name;";
var141 = core__flat___NativeString___to_s_full(var140, 6l, 6l);
var139 = var141;
varonce138 = var139;
}
((struct instance_core__NativeArray*)var133)->values[3]=var139;
} else {
var133 = varonce132;
varonce132 = NULL;
}
((struct instance_core__NativeArray*)var133)->values[0]=var_res;
{
{ /* Inline abstract_compiler#RuntimeVariable#mtype (var_value) on <var_value:RuntimeVariable> */
var144 = var_value->attrs[COLOR_nitc__abstract_compiler__RuntimeVariable___mtype].val; /* _mtype on <var_value:RuntimeVariable> */
...
{
var145 = ((val*(*)(val* self))(var142->class->vft[COLOR_nitc__model_base__MEntity__c_name]))(var142); /* c_name on <var142:MType>*/
}
((struct instance_core__NativeArray*)var133)->values[2]=var145;
{
var146 = ((val*(*)(val* self))(var133->class->vft[COLOR_core__abstract_text__NativeArray__native_to_s]))(var133); /* native_to_s on <var133:NativeArray[String]>*/
}
varonce132 = var133;
{
nitc___nitc__AbstractCompilerVisitor___add(self, var146); /* Direct call abstract_compiler#AbstractCompilerVisitor#add on <self:SeparateCompilerVisitor>*/
}
}
}
var = var_res;
...
if (unlikely(!var23)) {
PRINT_ERROR("Runtime error: %s", "Assert failed");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__separate_compiler, 1908);
fatal_exit(1);
}
{
{ /* Inline abstract_compiler#RuntimeVariable#mtype (var_value2) on <var_value2:RuntimeVariable> */
