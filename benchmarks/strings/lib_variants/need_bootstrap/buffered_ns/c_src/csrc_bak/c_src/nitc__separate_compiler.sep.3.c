...
val* var212 /* : MClass */;
val* var214 /* : MClass */;
val* var215 /* : MClassKind */;
val* var217 /* : MClassKind */;
val* var218 /* : Sys */;
val* var219 /* : MClassKind */;
...
val* var263 /* : RuntimeVariable */;
val* var_res264 /* var res: RuntimeVariable */;
val* var265 /* : MType */;
val* var267 /* : MType */;
...
val* var363 /* : RuntimeVariable */;
val* var_res364 /* var res: RuntimeVariable */;
val* var366 /* : NativeArray[String] */;
...
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__separate_compiler, 1218);
fatal_exit(1);
}
}
}
...
PRINT_ERROR("Runtime error: %s", "Aborted");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__separate_compiler, 1233);
fatal_exit(1);
}
}
}
...
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__separate_compiler, 1239);
fatal_exit(1);
}
var_valtype = var201;
/* <var_mtype:MType> isa MClassType */
cltype209 = type_nitc__MClassType.color;
idtype210 = type_nitc__MClassType.id;
if(cltype209 >= var_mtype->type->table_size) {
var208 = 0;
} else {
var208 = var_mtype->type->type_table[cltype209] == idtype210;
}
var_211 = var208;
if (var208){
{
{ /* Inline model#MClassType#mclass (var_mtype) on <var_mtype:MType(MClassType)> */
var214 = var_mtype->attrs[COLOR_nitc__model__MClassType___mclass].val; /* _mclass on <var_mtype:MType(MClassType)> */
...
{
{ /* Inline model#MClass#kind (var212) on <var212:MClass> */
var217 = var212->attrs[COLOR_nitc__model__MClass___kind].val; /* _kind on <var212:MClass> */
...
var218 = glob_sys;
{
var219 = nitc__model___core__Sys___extern_kind(var218);
}
{
{ /* Inline kernel#Object#== (var215,var219) on <var215:MClassKind> */
var_other = var219;
{
{ /* Inline kernel#Object#is_same_instance (var215,var_other) on <var215:MClassKind> */
...
{
{ /* Inline model#MClassType#mclass (var_mtype) on <var_mtype:MType(MClassType)> */
var228 = var_mtype->attrs[COLOR_nitc__model__MClassType___mclass].val; /* _mclass on <var_mtype:MType(MClassType)> */
...
var234 = "NativeString";
var235 = core__flat___NativeString___to_s_full(var234, 12l, 12l);
var233 = var235;
varonce232 = var233;
}
{
{ /* Inline kernel#Object#!= (var229,var233) on <var229:String> */
var_other238 = var233;
{
var239 = ((short int(*)(val* self, val* p0))(var229->class->vft[COLOR_core__kernel__Object___61d_61d]))(var229, var_other238); /* == on <var229:String>*/
}
var240 = !var239;
var236 = var240;
goto RET_LABEL237;
...
{
{ /* Inline model#MClassType#mclass (var_mtype) on <var_mtype:MType(MClassType)> */
var244 = var_mtype->attrs[COLOR_nitc__model__MClassType___mclass].val; /* _mclass on <var_mtype:MType(MClassType)> */
...
{
{ /* Inline model#MClass#name (var242) on <var242:MClass> */
var247 = var242->attrs[COLOR_nitc__model__MClass___name].val; /* _name on <var242:MClass> */
...
var250 = "BufferedNativeString";
var251 = core__flat___NativeString___to_s_full(var250, 20l, 20l);
var249 = var251;
varonce248 = var249;
}
{
{ /* Inline kernel#Object#!= (var245,var249) on <var245:String> */
var_other238 = var249;
{
var254 = ((short int(*)(val* self, val* p0))(var245->class->vft[COLOR_core__kernel__Object___61d_61d]))(var245, var_other238); /* == on <var245:String>*/
}
var255 = !var254;
var252 = var255;
goto RET_LABEL253;
...
var258 = self->attrs[COLOR_nitc__abstract_compiler__AbstractCompilerVisitor___compiler].val; /* _compiler on <self:SeparateCompilerVisitor> */
...
{
{ /* Inline abstract_compiler#AbstractCompiler#mainmodule (var256) on <var256:AbstractCompiler(SeparateCompiler)> */
var261 = var256->attrs[COLOR_nitc__abstract_compiler__AbstractCompiler___mainmodule].val; /* _mainmodule on <var256:AbstractCompiler(SeparateCompiler)> */
...
{
var262 = nitc__model___MModule___pointer_type(var259);
}
var_valtype = var262;
} else {
}
{
var263 = nitc___nitc__AbstractCompilerVisitor___new_var(self, var_mtype);
}
var_res264 = var263;
{
{ /* Inline abstract_compiler#RuntimeVariable#mcasttype (var_value) on <var_value:RuntimeVariable> */
var267 = var_value->attrs[COLOR_nitc__abstract_compiler__RuntimeVariable___mcasttype].val; /* _mcasttype on <var_value:RuntimeVariable> */
...
{
{ /* Inline abstract_compiler#RuntimeVariable#mcasttype= (var_res264,var265) on <var_res264:RuntimeVariable> */
var_res264->attrs[COLOR_nitc__abstract_compiler__RuntimeVariable___mcasttype].val = var265; /* _mcasttype on <var_res264:RuntimeVariable> */
RET_LABEL268:(void)0;
}
}
if (unlikely(varonce269==NULL)) {
var270 = NEW_core__NativeArray(2l, &type_core__NativeArray__core__String);
if (likely(varonce271!=NULL)) {
var272 = varonce271;
} else {
var273 = "BOX_";
var274 = core__flat___NativeString___to_s_full(var273, 4l, 4l);
var272 = var274;
varonce271 = var272;
}
((struct instance_core__NativeArray*)var270)->values[0]=var272;
} else {
var270 = varonce269;
varonce269 = NULL;
}
{
var275 = ((val*(*)(val* self))(var_valtype->class->vft[COLOR_nitc__model_base__MEntity__c_name]))(var_valtype); /* c_name on <var_valtype:MClassType>*/
}
((struct instance_core__NativeArray*)var270)->values[1]=var275;
{
var276 = ((val*(*)(val* self))(var270->class->vft[COLOR_core__abstract_text__NativeArray__native_to_s]))(var270); /* native_to_s on <var270:NativeArray[String]>*/
}
varonce269 = var270;
{
nitc___nitc__AbstractCompilerVisitor___require_declaration(self, var276); /* Direct call abstract_compiler#AbstractCompilerVisitor#require_declaration on <self:SeparateCompilerVisitor>*/
}
if (unlikely(varonce277==NULL)) {
var278 = NEW_core__NativeArray(10l, &type_core__NativeArray__core__String);
if (likely(varonce279!=NULL)) {
var280 = varonce279;
} else {
var281 = " = BOX_";
var282 = core__flat___NativeString___to_s_full(var281, 7l, 7l);
var280 = var282;
varonce279 = var280;
}
((struct instance_core__NativeArray*)var278)->values[1]=var280;
if (likely(varonce283!=NULL)) {
var284 = varonce283;
} else {
var285 = "(";
var286 = core__flat___NativeString___to_s_full(var285, 1l, 1l);
var284 = var286;
varonce283 = var284;
}
((struct instance_core__NativeArray*)var278)->values[3]=var284;
if (likely(varonce287!=NULL)) {
var288 = varonce287;
} else {
var289 = "); /* autobox from ";
var290 = core__flat___NativeString___to_s_full(var289, 19l, 19l);
var288 = var290;
varonce287 = var288;
}
((struct instance_core__NativeArray*)var278)->values[5]=var288;
if (likely(varonce291!=NULL)) {
var292 = varonce291;
} else {
var293 = " to ";
var294 = core__flat___NativeString___to_s_full(var293, 4l, 4l);
var292 = var294;
varonce291 = var292;
}
((struct instance_core__NativeArray*)var278)->values[7]=var292;
...
((struct instance_core__NativeArray*)var278)->values[9]=var296;
} else {
var278 = varonce277;
varonce277 = NULL;
}
{
var299 = ((val*(*)(val* self))(var_res264->class->vft[COLOR_core__abstract_text__Object__to_s]))(var_res264); /* to_s on <var_res264:RuntimeVariable>*/
}
((struct instance_core__NativeArray*)var278)->values[0]=var299;
{
var300 = ((val*(*)(val* self))(var_valtype->class->vft[COLOR_nitc__model_base__MEntity__c_name]))(var_valtype); /* c_name on <var_valtype:MClassType>*/
}
((struct instance_core__NativeArray*)var278)->values[2]=var300;
{
var301 = ((val*(*)(val* self))(var_value->class->vft[COLOR_core__abstract_text__Object__to_s]))(var_value); /* to_s on <var_value:RuntimeVariable>*/
}
((struct instance_core__NativeArray*)var278)->values[4]=var301;
{
{ /* Inline abstract_compiler#RuntimeVariable#mtype (var_value) on <var_value:RuntimeVariable> */
var304 = var_value->attrs[COLOR_nitc__abstract_compiler__RuntimeVariable___mtype].val; /* _mtype on <var_value:RuntimeVariable> */
...
{
var305 = ((val*(*)(val* self))(var302->class->vft[COLOR_core__abstract_text__Object__to_s]))(var302); /* to_s on <var302:MType>*/
}
((struct instance_core__NativeArray*)var278)->values[6]=var305;
{
var306 = ((val*(*)(val* self))(var_mtype->class->vft[COLOR_core__abstract_text__Object__to_s]))(var_mtype); /* to_s on <var_mtype:MType>*/
}
((struct instance_core__NativeArray*)var278)->values[8]=var306;
{
var307 = ((val*(*)(val* self))(var278->class->vft[COLOR_core__abstract_text__NativeArray__native_to_s]))(var278); /* native_to_s on <var278:NativeArray[String]>*/
}
varonce277 = var278;
{
...
{
{ /* Inline abstract_compiler#RuntimeVariable#mtype (var_value) on <var_value:RuntimeVariable> */
var313 = var_value->attrs[COLOR_nitc__abstract_compiler__RuntimeVariable___mtype].val; /* _mtype on <var_value:RuntimeVariable> */
...
{
var314 = ((val*(*)(val* self))(var311->class->vft[COLOR_nitc__abstract_compiler__MType__ctype]))(var311); /* ctype on <var311:MType>*/
}
if (likely(varonce315!=NULL)) {
var316 = varonce315;
} else {
var317 = "void*";
var318 = core__flat___NativeString___to_s_full(var317, 5l, 5l);
var316 = var318;
varonce315 = var316;
}
{
var319 = ((short int(*)(val* self, val* p0))(var314->class->vft[COLOR_core__kernel__Object___61d_61d]))(var314, var316); /* == on <var314:String>*/
}
var_320 = var319;
if (var319){
{
var321 = ((val*(*)(val* self))(var_mtype->class->vft[COLOR_nitc__abstract_compiler__MType__ctype]))(var_mtype); /* ctype on <var_mtype:MType>*/
}
if (likely(varonce322!=NULL)) {
var323 = varonce322;
} else {
var324 = "void*";
var325 = core__flat___NativeString___to_s_full(var324, 5l, 5l);
var323 = var325;
varonce322 = var323;
}
{
var326 = ((short int(*)(val* self, val* p0))(var321->class->vft[COLOR_core__kernel__Object___61d_61d]))(var321, var323); /* == on <var321:String>*/
}
var310 = var326;
} else {
var310 = var_320;
...
{
{ /* Inline abstract_compiler#RuntimeVariable#mtype (var_value) on <var_value:RuntimeVariable> */
var331 = var_value->attrs[COLOR_nitc__abstract_compiler__RuntimeVariable___mtype].val; /* _mtype on <var_value:RuntimeVariable> */
...
{
var332 = ((val*(*)(val* self))(var329->class->vft[COLOR_nitc__abstract_compiler__MType__ctype]))(var329); /* ctype on <var329:MType>*/
}
if (likely(varonce333!=NULL)) {
var334 = varonce333;
} else {
var335 = "char*";
var336 = core__flat___NativeString___to_s_full(var335, 5l, 5l);
var334 = var336;
varonce333 = var334;
}
{
var337 = ((short int(*)(val* self, val* p0))(var332->class->vft[COLOR_core__kernel__Object___61d_61d]))(var332, var334); /* == on <var332:String>*/
}
var_338 = var337;
if (var337){
{
var339 = ((val*(*)(val* self))(var_mtype->class->vft[COLOR_nitc__abstract_compiler__MType__ctype]))(var_mtype); /* ctype on <var_mtype:MType>*/
}
if (likely(varonce340!=NULL)) {
var341 = varonce340;
} else {
var342 = "void*";
var343 = core__flat___NativeString___to_s_full(var342, 5l, 5l);
var341 = var343;
varonce340 = var341;
}
{
var344 = ((short int(*)(val* self, val* p0))(var339->class->vft[COLOR_core__kernel__Object___61d_61d]))(var339, var341); /* == on <var339:String>*/
}
var328 = var344;
} else {
var328 = var_338;
...
{
{ /* Inline abstract_compiler#RuntimeVariable#mtype (var_value) on <var_value:RuntimeVariable> */
var349 = var_value->attrs[COLOR_nitc__abstract_compiler__RuntimeVariable___mtype].val; /* _mtype on <var_value:RuntimeVariable> */
...
{
var350 = ((val*(*)(val* self))(var347->class->vft[COLOR_nitc__abstract_compiler__MType__ctype]))(var347); /* ctype on <var347:MType>*/
}
if (likely(varonce351!=NULL)) {
var352 = varonce351;
} else {
var353 = "void*";
var354 = core__flat___NativeString___to_s_full(var353, 5l, 5l);
var352 = var354;
varonce351 = var352;
}
{
var355 = ((short int(*)(val* self, val* p0))(var350->class->vft[COLOR_core__kernel__Object___61d_61d]))(var350, var352); /* == on <var350:String>*/
}
var_356 = var355;
if (var355){
{
var357 = ((val*(*)(val* self))(var_mtype->class->vft[COLOR_nitc__abstract_compiler__MType__ctype]))(var_mtype); /* ctype on <var_mtype:MType>*/
}
if (likely(varonce358!=NULL)) {
var359 = varonce358;
} else {
var360 = "char*";
var361 = core__flat___NativeString___to_s_full(var360, 5l, 5l);
var359 = var361;
varonce358 = var359;
}
{
var362 = ((short int(*)(val* self, val* p0))(var357->class->vft[COLOR_core__kernel__Object___61d_61d]))(var357, var359); /* == on <var357:String>*/
}
var346 = var362;
} else {
var346 = var_356;
...
{
var363 = nitc___nitc__AbstractCompilerVisitor___new_var(self, var_mtype);
}
var_res364 = var363;
if (unlikely(varonce365==NULL)) {
var366 = NEW_core__NativeArray(7l, &type_core__NativeArray__core__String);
if (likely(varonce367!=NULL)) {
var368 = varonce367;
} else {
var369 = "/* ";
var370 = core__flat___NativeString___to_s_full(var369, 3l, 3l);
var368 = var370;
varonce367 = var368;
}
((struct instance_core__NativeArray*)var366)->values[0]=var368;
if (likely(varonce371!=NULL)) {
var372 = varonce371;
} else {
var373 = " left unintialized (cannot convert ";
var374 = core__flat___NativeString___to_s_full(var373, 35l, 35l);
var372 = var374;
varonce371 = var372;
}
((struct instance_core__NativeArray*)var366)->values[2]=var372;
if (likely(varonce375!=NULL)) {
var376 = varonce375;
} else {
var377 = " to ";
var378 = core__flat___NativeString___to_s_full(var377, 4l, 4l);
var376 = var378;
varonce375 = var376;
}
((struct instance_core__NativeArray*)var366)->values[4]=var376;
if (likely(varonce379!=NULL)) {
var380 = varonce379;
} else {
var381 = ") */";
var382 = core__flat___NativeString___to_s_full(var381, 4l, 4l);
var380 = var382;
varonce379 = var380;
}
((struct instance_core__NativeArray*)var366)->values[6]=var380;
} else {
var366 = varonce365;
varonce365 = NULL;
}
{
var383 = ((val*(*)(val* self))(var_res364->class->vft[COLOR_core__abstract_text__Object__to_s]))(var_res364); /* to_s on <var_res364:RuntimeVariable>*/
}
((struct instance_core__NativeArray*)var366)->values[1]=var383;
{
{ /* Inline abstract_compiler#RuntimeVariable#mtype (var_value) on <var_value:RuntimeVariable> */
var386 = var_value->attrs[COLOR_nitc__abstract_compiler__RuntimeVariable___mtype].val; /* _mtype on <var_value:RuntimeVariable> */
...
{
var387 = ((val*(*)(val* self))(var384->class->vft[COLOR_core__abstract_text__Object__to_s]))(var384); /* to_s on <var384:MType>*/
}
((struct instance_core__NativeArray*)var366)->values[3]=var387;
{
var388 = ((val*(*)(val* self))(var_mtype->class->vft[COLOR_core__abstract_text__Object__to_s]))(var_mtype); /* to_s on <var_mtype:MType>*/
}
((struct instance_core__NativeArray*)var366)->values[5]=var388;
{
var389 = ((val*(*)(val* self))(var366->class->vft[COLOR_core__abstract_text__NativeArray__native_to_s]))(var366); /* native_to_s on <var366:NativeArray[String]>*/
}
varonce365 = var366;
{
nitc___nitc__AbstractCompilerVisitor___add(self, var389); /* Direct call abstract_compiler#AbstractCompilerVisitor#add on <self:SeparateCompilerVisitor>*/
}
if (unlikely(varonce390==NULL)) {
var391 = NEW_core__NativeArray(5l, &type_core__NativeArray__core__String);
if (likely(varonce392!=NULL)) {
var393 = varonce392;
} else {
var394 = "PRINT_ERROR(\"Cast error: Cannot cast %s to %s.\\n\", \"";
var395 = core__flat___NativeString___to_s_full(var394, 52l, 52l);
var393 = var395;
varonce392 = var393;
}
...
var398 = "\", \"";
var399 = core__flat___NativeString___to_s_full(var398, 4l, 4l);
var397 = var399;
varonce396 = var397;
}
((struct instance_core__NativeArray*)var391)->values[2]=var397;
if (likely(varonce400!=NULL)) {
var401 = varonce400;
} else {
var402 = "\"); fatal_exit(1);";
var403 = core__flat___NativeString___to_s_full(var402, 18l, 18l);
var401 = var403;
varonce400 = var401;
}
((struct instance_core__NativeArray*)var391)->values[4]=var401;
} else {
var391 = varonce390;
varonce390 = NULL;
}
{
{ /* Inline abstract_compiler#RuntimeVariable#mtype (var_value) on <var_value:RuntimeVariable> */
var406 = var_value->attrs[COLOR_nitc__abstract_compiler__RuntimeVariable___mtype].val; /* _mtype on <var_value:RuntimeVariable> */
...
{
var407 = ((val*(*)(val* self))(var404->class->vft[COLOR_core__abstract_text__Object__to_s]))(var404); /* to_s on <var404:MType>*/
}
((struct instance_core__NativeArray*)var391)->values[1]=var407;
{
var408 = ((val*(*)(val* self))(var_mtype->class->vft[COLOR_core__abstract_text__Object__to_s]))(var_mtype); /* to_s on <var_mtype:MType>*/
}
((struct instance_core__NativeArray*)var391)->values[3]=var408;
{
var409 = ((val*(*)(val* self))(var391->class->vft[COLOR_core__abstract_text__NativeArray__native_to_s]))(var391); /* native_to_s on <var391:NativeArray[String]>*/
}
varonce390 = var391;
{
nitc___nitc__AbstractCompilerVisitor___add(self, var409); /* Direct call abstract_compiler#AbstractCompilerVisitor#add on <self:SeparateCompilerVisitor>*/
}
var = var_res364;
goto RET_LABEL;
}
...
{
{ /* Inline model#MClassType#mclass (var_mtype) on <var_mtype:MType(MClassType)> */
var21 = var_mtype->attrs[COLOR_nitc__model__MClassType___mclass].val; /* _mclass on <var_mtype:MType(MClassType)> */
...
var26 = "NativeString";
var27 = core__flat___NativeString___to_s_full(var26, 12l, 12l);
var25 = var27;
varonce = var25;
}
{
{ /* Inline kernel#Object#!= (var22,var25) on <var22:String> */
var_other30 = var25;
{
var31 = ((short int(*)(val* self, val* p0))(var22->class->vft[COLOR_core__kernel__Object___61d_61d]))(var22, var_other30); /* == on <var22:String>*/
}
var32 = !var31;
var28 = var32;
goto RET_LABEL29;
...
{
{ /* Inline model#MClassType#mclass (var_mtype) on <var_mtype:MType(MClassType)> */
var36 = var_mtype->attrs[COLOR_nitc__model__MClassType___mclass].val; /* _mclass on <var_mtype:MType(MClassType)> */
...
var42 = "BufferedNativeString";
var43 = core__flat___NativeString___to_s_full(var42, 20l, 20l);
var41 = var43;
varonce40 = var41;
}
{
{ /* Inline kernel#Object#!= (var37,var41) on <var37:String> */
var_other30 = var41;
{
var46 = ((short int(*)(val* self, val* p0))(var37->class->vft[COLOR_core__kernel__Object___61d_61d]))(var37, var_other30); /* == on <var37:String>*/
}
var47 = !var46;
var44 = var47;
goto RET_LABEL45;
...
{
{ /* Inline abstract_compiler#AbstractCompilerVisitor#compiler (self) on <self:SeparateCompilerVisitor> */
var50 = self->attrs[COLOR_nitc__abstract_compiler__AbstractCompilerVisitor___compiler].val; /* _compiler on <self:SeparateCompilerVisitor> */
...
{
{ /* Inline abstract_compiler#AbstractCompiler#mainmodule (var48) on <var48:AbstractCompiler(SeparateCompiler)> */
var53 = var48->attrs[COLOR_nitc__abstract_compiler__AbstractCompiler___mainmodule].val; /* _mainmodule on <var48:AbstractCompiler(SeparateCompiler)> */
...
{
var54 = nitc__model___MModule___pointer_type(var51);
}
var_pointer_type = var54;
{
var55 = nitc___nitc__AbstractCompilerVisitor___new_var_extern(self, var_mtype);
}
var_res = var55;
if (unlikely(varonce56==NULL)) {
var57 = NEW_core__NativeArray(8l, &type_core__NativeArray__core__String);
if (likely(varonce58!=NULL)) {
var59 = varonce58;
} else {
var60 = " = ((struct instance_";
var61 = core__flat___NativeString___to_s_full(var60, 21l, 21l);
var59 = var61;
varonce58 = var59;
}
...
var69 = core__flat___NativeString___to_s_full(var68, 22l, 22l);
var67 = var69;
varonce66 = var67;
}
...
((struct instance_core__NativeArray*)var57)->values[7]=var71;
} else {
var57 = varonce56;
varonce56 = NULL;
}
...
{
var75 = ((val*(*)(val* self))(var_pointer_type->class->vft[COLOR_nitc__model_base__MEntity__c_name]))(var_pointer_type); /* c_name on <var_pointer_type:MClassType>*/
}
((struct instance_core__NativeArray*)var57)->values[2]=var75;
{
var76 = ((val*(*)(val* self))(var_value->class->vft[COLOR_core__abstract_text__Object__to_s]))(var_value); /* to_s on <var_value:RuntimeVariable>*/
}
((struct instance_core__NativeArray*)var57)->values[4]=var76;
{
{ /* Inline abstract_compiler#RuntimeVariable#mtype (var_value) on <var_value:RuntimeVariable> */
var79 = var_value->attrs[COLOR_nitc__abstract_compiler__RuntimeVariable___mtype].val; /* _mtype on <var_value:RuntimeVariable> */
...
{
var80 = ((val*(*)(val* self))(var77->class->vft[COLOR_core__abstract_text__Object__to_s]))(var77); /* to_s on <var77:MType>*/
}
((struct instance_core__NativeArray*)var57)->values[6]=var80;
{
var81 = ((val*(*)(val* self))(var57->class->vft[COLOR_core__abstract_text__NativeArray__native_to_s]))(var57); /* native_to_s on <var57:NativeArray[String]>*/
}
varonce56 = var57;
{
nitc___nitc__AbstractCompilerVisitor___add(self, var81); /* Direct call abstract_compiler#AbstractCompilerVisitor#add on <self:SeparateCompilerVisitor>*/
}
var = var_res;
goto RET_LABEL;
} else {
...
var_valtype = var54;
{
var55 = nitc___nitc__AbstractCompilerVisitor___new_var(self, var_mtype);
}
var_res = var55;
{
{ /* Inline abstract_compiler#AbstractCompilerVisitor#compiler (self) on <self:SeparateCompilerVisitor> */
...
{
{ /* Inline separate_compiler#SeparateCompiler#undead_types (var56) on <var56:AbstractCompiler(SeparateCompiler)> */
var61 = var56->attrs[COLOR_nitc__separate_compiler__SeparateCompiler___undead_types].val; /* _undead_types on <var56:AbstractCompiler(SeparateCompiler)> */
...
{
((void(*)(val* self, val* p0))((((long)var59&3)?class_info[((long)var59&3)]:var59->class)->vft[COLOR_core__abstract_collection__SimpleCollection__add]))(var59, var_mtype); /* add on <var59:Set[MType]>*/
}
...
var66 = "BOX_";
var67 = core__flat___NativeString___to_s_full(var66, 4l, 4l);
var65 = var67;
varonce64 = var65;
}
...
{
var68 = ((val*(*)(val* self))(var_valtype->class->vft[COLOR_nitc__model_base__MEntity__c_name]))(var_valtype); /* c_name on <var_valtype:MClassType>*/
}
((struct instance_core__NativeArray*)var63)->values[1]=var68;
{
var69 = ((val*(*)(val* self))(var63->class->vft[COLOR_core__abstract_text__NativeArray__native_to_s]))(var63); /* native_to_s on <var63:NativeArray[String]>*/
}
varonce62 = var63;
{
nitc___nitc__AbstractCompilerVisitor___require_declaration(self, var69); /* Direct call abstract_compiler#AbstractCompilerVisitor#require_declaration on <self:SeparateCompilerVisitor>*/
}
if (unlikely(varonce70==NULL)) {
var71 = NEW_core__NativeArray(8l, &type_core__NativeArray__core__String);
...
((struct instance_core__NativeArray*)var71)->values[3]=var77;
if (likely(varonce80!=NULL)) {
var81 = varonce80;
} else {
var82 = "); /* boxing ";
var83 = core__flat___NativeString___to_s_full(var82, 13l, 13l);
var81 = var83;
varonce80 = var81;
}
((struct instance_core__NativeArray*)var71)->values[5]=var81;
...
((struct instance_core__NativeArray*)var71)->values[7]=var85;
} else {
var71 = varonce70;
varonce70 = NULL;
}
{
var88 = ((val*(*)(val* self))(var_res->class->vft[COLOR_core__abstract_text__Object__to_s]))(var_res); /* to_s on <var_res:RuntimeVariable>*/
}
((struct instance_core__NativeArray*)var71)->values[0]=var88;
{
var89 = ((val*(*)(val* self))(var_valtype->class->vft[COLOR_nitc__model_base__MEntity__c_name]))(var_valtype); /* c_name on <var_valtype:MClassType>*/
}
((struct instance_core__NativeArray*)var71)->values[2]=var89;
{
var90 = ((val*(*)(val* self))(var_value->class->vft[COLOR_core__abstract_text__Object__to_s]))(var_value); /* to_s on <var_value:RuntimeVariable>*/
}
((struct instance_core__NativeArray*)var71)->values[4]=var90;
{
{ /* Inline abstract_compiler#RuntimeVariable#mtype (var_value) on <var_value:RuntimeVariable> */
...
((struct instance_core__NativeArray*)var71)->values[6]=var94;
{
var95 = ((val*(*)(val* self))(var71->class->vft[COLOR_core__abstract_text__NativeArray__native_to_s]))(var71); /* native_to_s on <var71:NativeArray[String]>*/
}
varonce70 = var71;
{
nitc___nitc__AbstractCompilerVisitor___add(self, var95); /* Direct call abstract_compiler#AbstractCompilerVisitor#add on <self:SeparateCompilerVisitor>*/
}
...
var100 = "type_";
var101 = core__flat___NativeString___to_s_full(var100, 5l, 5l);
var99 = var101;
varonce98 = var99;
}
...
{
var102 = ((val*(*)(val* self))(var_mtype->class->vft[COLOR_nitc__model_base__MEntity__c_name]))(var_mtype); /* c_name on <var_mtype:MType(MClassType)>*/
}
...
varonce96 = var97;
{
nitc___nitc__AbstractCompilerVisitor___require_declaration(self, var103); /* Direct call abstract_compiler#AbstractCompilerVisitor#require_declaration on <self:SeparateCompilerVisitor>*/
}
...
var108 = "->type = &type_";
var109 = core__flat___NativeString___to_s_full(var108, 15l, 15l);
var107 = var109;
varonce106 = var107;
}
...
{
var115 = ((val*(*)(val* self))(var_mtype->class->vft[COLOR_nitc__model_base__MEntity__c_name]))(var_mtype); /* c_name on <var_mtype:MType(MClassType)>*/
}
...
{
var123 = ((val*(*)(val* self))(var_mtype->class->vft[COLOR_nitc__model_base__MEntity__c_name]))(var_mtype); /* c_name on <var_mtype:MType(MClassType)>*/
}
...
varonce117 = var118;
{
nitc___nitc__AbstractCompilerVisitor___require_declaration(self, var124); /* Direct call abstract_compiler#AbstractCompilerVisitor#require_declaration on <self:SeparateCompilerVisitor>*/
}
...
var129 = "->class = &class_";
var130 = core__flat___NativeString___to_s_full(var129, 17l, 17l);
var128 = var130;
varonce127 = var128;
}
...
((struct instance_core__NativeArray*)var126)->values[3]=var132;
} else {
var126 = varonce125;
varonce125 = NULL;
}
...
((struct instance_core__NativeArray*)var126)->values[0]=var135;
{
var136 = ((val*(*)(val* self))(var_mtype->class->vft[COLOR_nitc__model_base__MEntity__c_name]))(var_mtype); /* c_name on <var_mtype:MType(MClassType)>*/
}
...
varonce125 = var126;
{
nitc___nitc__AbstractCompilerVisitor___add(self, var137); /* Direct call abstract_compiler#AbstractCompilerVisitor#add on <self:SeparateCompilerVisitor>*/
}
var = var_res;
goto RET_LABEL;
} else {
...
if (unlikely(!var5)) {
PRINT_ERROR("Runtime error: %s", "Assert failed");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__separate_compiler, 1301);
fatal_exit(1);
}
...
if (unlikely(!var17)) {
PRINT_ERROR("Runtime error: %s", "Assert failed");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__separate_compiler, 1366);
fatal_exit(1);
}
{
...
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__separate_compiler, 1456);
fatal_exit(1);
} else {
...
if (unlikely(!var406)) {
PRINT_ERROR("Runtime error: %s", "Assert failed");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__separate_compiler, 1514);
fatal_exit(1);
}
{
nitc___nitc__AbstractCompilerVisitor___assign(self, var_res0, var_res); /* Direct call abstract_compiler#AbstractCompilerVisitor#assign on <self:SeparateCompilerVisitor>*/
...
if (var4 == NULL) {
PRINT_ERROR("Runtime error: %s", "Receiver is null");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__separate_compiler, 1526);
fatal_exit(1);
} else {
...
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__separate_compiler, 1548);
fatal_exit(1);
}
...
if (unlikely(var6 == NULL)) {
PRINT_ERROR("Runtime error: %s", "Cast failed");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__separate_compiler, 1609);
fatal_exit(1);
}
var_mtype = var6;
{
