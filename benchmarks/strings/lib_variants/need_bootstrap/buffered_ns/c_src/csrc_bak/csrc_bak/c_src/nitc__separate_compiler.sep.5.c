...
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__separate_compiler, 2090);
fatal_exit(1);
}
{
...
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__separate_compiler, 2095);
fatal_exit(1);
} else {
...
if (var34 == NULL) {
PRINT_ERROR("Runtime error: %s", "Receiver is null");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__separate_compiler, 2096);
fatal_exit(1);
} else {
...
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__separate_compiler, 2114);
fatal_exit(1);
}
{
...
if (unlikely(var_ret_type == NULL)) {
PRINT_ERROR("Runtime error: %s", "Cast failed");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__separate_compiler, 2121);
fatal_exit(1);
}
{
...
if (var21 == NULL) {
PRINT_ERROR("Runtime error: %s", "Receiver is null");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__separate_compiler, 2151);
fatal_exit(1);
} else {
...
if (var34 == NULL) {
PRINT_ERROR("Runtime error: %s", "Receiver is null");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__separate_compiler, 2153);
fatal_exit(1);
} else {
...
if (var16 == NULL) {
PRINT_ERROR("Runtime error: %s", "Receiver is null");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__separate_compiler, 2164);
fatal_exit(1);
} else {
...
if (var38 == NULL) {
PRINT_ERROR("Runtime error: %s", "Receiver is null");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__separate_compiler, 2189);
fatal_exit(1);
} else {
...
if (var71 == NULL) {
PRINT_ERROR("Runtime error: %s", "Receiver is null");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__separate_compiler, 2216);
fatal_exit(1);
} else {
...
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__separate_compiler, 2240);
fatal_exit(1);
}
} else {
{
...
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__separate_compiler, 2250);
fatal_exit(1);
}
} else {
{
...
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__separate_compiler, 2269);
fatal_exit(1);
}
var_compiler = p0;
{
...
if (unlikely(!var177)) {
PRINT_ERROR("Runtime error: %s", "Assert failed");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__separate_compiler, 2316);
fatal_exit(1);
}
{
...
PRINT_ERROR("Runtime error: %s", "Cast failed");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__separate_compiler, 2317);
fatal_exit(1);
}
{
...
PRINT_ERROR("Runtime error: %s", "Cast failed");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__separate_compiler, 2325);
fatal_exit(1);
}
...
if (var264 == NULL) {
PRINT_ERROR("Runtime error: %s", "Receiver is null");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__separate_compiler, 2330);
fatal_exit(1);
} else {
...
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__separate_compiler, 2393);
fatal_exit(1);
}
} else {
{
...
if (var20 == NULL) {
PRINT_ERROR("Runtime error: %s", "Receiver is null");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__separate_compiler, 2421);
fatal_exit(1);
} else {
