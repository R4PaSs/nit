...
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 1628);
fatal_exit(1);
}
{
...
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 1643);
fatal_exit(1);
}
}
}
...
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 1685);
fatal_exit(1);
} else {
...
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 1026);
fatal_exit(1);
}
var58 = var60;
RET_LABEL59:(void)0;
...
if (var10 == NULL) {
PRINT_ERROR("Runtime error: %s", "Receiver is null");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 1727);
fatal_exit(1);
} else {
...
if (var75 == NULL) {
PRINT_ERROR("Runtime error: %s", "Receiver is null");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 1731);
fatal_exit(1);
} else {
...
if (var == NULL) {
PRINT_ERROR("Runtime error: %s", "Receiver is null");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 1752);
fatal_exit(1);
} else {
...
if (unlikely(var31 == NULL)) {
PRINT_ERROR("Runtime error: %s", "Cast failed");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 1772);
fatal_exit(1);
}
...
PRINT_ERROR("Runtime error: %s", "Cast failed");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 1811);
fatal_exit(1);
}
{
...
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 1844);
fatal_exit(1);
}
var = var1;
RET_LABEL:;
...
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__separate_compiler, 2232);
fatal_exit(1);
}
var9 = var11;
RET_LABEL10:(void)0;
...
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 1877);
fatal_exit(1);
}
var = var1;
RET_LABEL:;
...
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 1892);
fatal_exit(1);
}
{
...
if (unlikely(!var9)) {
PRINT_ERROR("Runtime error: %s", "Assert failed");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 1893);
fatal_exit(1);
}
RET_LABEL:;
}
...
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 1928);
fatal_exit(1);
}
var = var1;
RET_LABEL:;
...
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 1940);
fatal_exit(1);
}
var = var1;
RET_LABEL:;
...
var177 = "BufferedNativeString";
var178 = core__flat___NativeString___to_s_full(var177, 20l, 20l);
var176 = var178;
varonce175 = var176;
}
{
...
var182 = "nit_string*";
var183 = core__flat___NativeString___to_s_full(var182, 11l, 11l);
var181 = var183;
varonce180 = var181;
}
var3 = var181;
...
var192 = "NativeArray";
var193 = core__flat___NativeString___to_s_full(var192, 11l, 11l);
var191 = var193;
varonce190 = var191;
}
{
var194 = ((short int(*)(val* self, val* p0))(var187->class->vft[COLOR_core__kernel__Object___61d_61d]))(var187, var191); /* == on <var187:String>*/
}
if (var194){
...
var201 = "val*";
var202 = core__flat___NativeString___to_s_full(var201, 4l, 4l);
var200 = var202;
varonce199 = var200;
}
var3 = var200;
...
var158 = "BufferedNativeString";
var159 = core__flat___NativeString___to_s_full(var158, 20l, 20l);
var157 = var159;
varonce156 = var157;
}
{
...
{
{ /* Inline model#MClassType#mclass (self) on <self:MClassType> */
var182 = self->attrs[COLOR_nitc__model__MClassType___mclass].val; /* _mclass on <self:MClassType> */
...
{
{ /* Inline model#MClass#name (var180) on <var180:MClass> */
var185 = var180->attrs[COLOR_nitc__model__MClass___name].val; /* _name on <var180:MClass> */
...
var188 = "NativeArray";
var189 = core__flat___NativeString___to_s_full(var188, 11l, 11l);
var187 = var189;
varonce186 = var187;
}
{
var190 = ((short int(*)(val* self, val* p0))(var183->class->vft[COLOR_core__kernel__Object___61d_61d]))(var183, var187); /* == on <var183:String>*/
}
if (var190){
...
var197 = "val";
var198 = core__flat___NativeString___to_s_full(var197, 3l, 3l);
var196 = var198;
varonce195 = var196;
}
var = var196;
...
var_class_name = p0 == NULL ? "null" : p0->type->name;
PRINT_ERROR("Runtime error: Cast failed. Expected `%s`, got `%s`", "VISITOR", var_class_name);
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 2049);
fatal_exit(1);
}
var_v = p0;
{
...
PRINT_ERROR("Runtime error: %s", "Aborted");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 2062);
fatal_exit(1);
}
}
RET_LABEL:;
...
var_class_name = p0 == NULL ? "null" : p0->type->name;
PRINT_ERROR("Runtime error: Cast failed. Expected `%s`, got `%s`", "VISITOR", var_class_name);
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 2066);
fatal_exit(1);
}
var_v = p0;
var_arguments = p1;
...
PRINT_ERROR("Runtime error: %s", "Aborted");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 2096);
fatal_exit(1);
}
}
}
...
var_class_name = p0 == NULL ? "null" : p0->type->name;
PRINT_ERROR("Runtime error: Cast failed. Expected `%s`, got `%s`", "VISITOR", var_class_name);
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 2101);
fatal_exit(1);
}
var_v = p0;
var_arguments = p1;
...
if (unlikely(var17 == NULL)) {
PRINT_ERROR("Runtime error: %s", "Cast failed");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 2106);
fatal_exit(1);
}
...
if (var42 == NULL) {
PRINT_ERROR("Runtime error: %s", "Receiver is null");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 2114);
fatal_exit(1);
} else {
...
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 2158);
fatal_exit(1);
}
{
...
if (var91 == NULL) {
PRINT_ERROR("Runtime error: %s", "Receiver is null");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 2176);
fatal_exit(1);
} else {
...
if (var104 == NULL) {
PRINT_ERROR("Runtime error: %s", "Receiver is null");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 2177);
fatal_exit(1);
} else {
...
if (var21 == NULL) {
PRINT_ERROR("Runtime error: %s", "Receiver is null");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 2195);
fatal_exit(1);
} else {
