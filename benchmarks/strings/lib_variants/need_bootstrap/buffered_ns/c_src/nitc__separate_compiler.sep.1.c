...
val* var51 /* : String */;
val* var_52 /* var : Array[String] */;
val* var53 /* : IndexedIterator[nullable Object] */;
val* var_54 /* var : IndexedIterator[String] */;
short int var55 /* : Bool */;
...
val* var60 /* : Model */;
val* var62 /* : Model */;
val* var63 /* : nullable Array[MClass] */;
...
val* var83 /* : HashMap[MClass, Int] */;
val* var85 /* : HashMap[MClass, Int] */;
long var86 /* : Int */;
long var87 /* : Int */;
...
{
core___core__Array___with_capacity(var, 13l); /* Direct call array#Array#with_capacity on <var:Array[String]>*/
}
var_ = var;
if (likely(varonce!=NULL)) {
var1 = varonce;
...
var50 = "BufferedNativeString";
var51 = core__flat___NativeString___to_s_full(var50, 20l, 20l);
var49 = var51;
varonce48 = var49;
}
{
...
for(;;) {
{
var55 = ((short int(*)(val* self))((((long)var_54&3)?class_info[((long)var_54&3)]:var_54->class)->vft[COLOR_core__abstract_collection__Iterator__is_ok]))(var_54); /* is_ok on <var_54:IndexedIterator[String]>*/
}
if (var55){
} else {
goto BREAK_label;
...
{
var56 = ((val*(*)(val* self))((((long)var_54&3)?class_info[((long)var_54&3)]:var_54->class)->vft[COLOR_core__abstract_collection__Iterator__item]))(var_54); /* item on <var_54:IndexedIterator[String]>*/
}
var_classname = var56;
{
{ /* Inline abstract_compiler#AbstractCompiler#mainmodule (self) on <self:SeparateCompiler> */
...
{
{ /* Inline mmodule#MModule#model (var57) on <var57:MModule> */
var62 = var57->attrs[COLOR_nitc__mmodule__MModule___model].val; /* _model on <var57:MModule> */
if (unlikely(var62 == NULL)) {
...
{
var63 = nitc__model___Model___get_mclasses_by_name(var60, var_classname);
}
var_classes = var63;
if (var_classes == NULL) {
var64 = 1; /* is null */
...
if (0) {
var65 = core___core__Array___core__kernel__Object___61d_61d(var_classes, ((val*)NULL));
var64 = var65;
}
if (var64){
goto BREAK_label66;
...
var69 = var_classes->attrs[COLOR_core__array__AbstractArrayRead___length].l; /* _length on <var_classes:nullable Array[MClass](Array[MClass])> */
var67 = var69;
RET_LABEL68:(void)0;
}
}
{
{ /* Inline kernel#Int#== (var67,1l) on <var67:Int> */
var72 = var67 == 1l;
var70 = var72;
goto RET_LABEL71;
RET_LABEL71:(void)0;
...
{
var78 = core__abstract_text___Collection___join(var_classes, var75);
}
{
core__file___Sys___print(var73, var78); /* Direct call file#Sys#print on <var73:Sys>*/
}
...
{
var82 = core___core__SequenceRead___Collection__first(var_classes);
}
{
{ /* Inline separate_compiler#SeparateCompiler#box_kinds (self) on <self:SeparateCompiler> */
var85 = self->attrs[COLOR_nitc__separate_compiler__SeparateCompiler___box_kinds].val; /* _box_kinds on <self:SeparateCompiler> */
if (unlikely(var85 == NULL)) {
PRINT_ERROR("Runtime error: %s", "Uninitialized attribute _box_kinds");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__separate_compiler, 264);
fatal_exit(1);
...
{
var86 = core___core__HashMap___core__abstract_collection__MapRead__length(var83);
}
{
...
{
var91 = (val*)(var87<<2|1);
core___core__HashMap___core__abstract_collection__Map___91d_93d_61d(var79, var82, var91); /* Direct call hash_collection#HashMap#[]= on <var79:HashMap[MClass, Int]>*/
}
BREAK_label66: (void)0;
{
((void(*)(val* self))((((long)var_54&3)?class_info[((long)var_54&3)]:var_54->class)->vft[COLOR_core__abstract_collection__Iterator__next]))(var_54); /* next on <var_54:IndexedIterator[String]>*/
}
}
BREAK_label: (void)0;
{
((void(*)(val* self))((((long)var_54&3)?class_info[((long)var_54&3)]:var_54->class)->vft[COLOR_core__abstract_collection__Iterator__finish]))(var_54); /* finish on <var_54:IndexedIterator[String]>*/
}
RET_LABEL:;
}
...
long var56 /* : Int */;
val* var57 /* : HashMap[MClass, Int] */;
val* var59 /* : HashMap[MClass, Int] */;
...
var13 = var_mclass->attrs[COLOR_nitc__model__MClass___kind].val; /* _kind on <var_mclass:MClass> */
if (unlikely(var13 == NULL)) {
...
var14 = glob_sys;
{
var15 = nitc__model___core__Sys___extern_kind(var14);
}
{
{ /* Inline kernel#Object#== (var11,var15) on <var11:MClassKind> */
var_other = var15;
{
{ /* Inline kernel#Object#is_same_instance (var11,var_other) on <var11:MClassKind> */
var20 = var11 == var_other;
var18 = var20;
goto RET_LABEL19;
RET_LABEL19:(void)0;
}
...
var23 = var_mclass->attrs[COLOR_nitc__model__MClass___name].val; /* _name on <var_mclass:MClass> */
if (unlikely(var23 == NULL)) {
PRINT_ERROR("Runtime error: %s", "Uninitialized attribute _name");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__model, 388);
fatal_exit(1);
...
{
{ /* Inline kernel#Object#!= (var21,var25) on <var21:String> */
var_other30 = var25;
{
var31 = ((short int(*)(val* self, val* p0))(var21->class->vft[COLOR_core__kernel__Object___61d_61d]))(var21, var_other30); /* == on <var21:String>*/
}
var32 = !var31;
var28 = var32;
goto RET_LABEL29;
...
{
{ /* Inline model#MClass#name (var_mclass) on <var_mclass:MClass> */
var36 = var_mclass->attrs[COLOR_nitc__model__MClass___name].val; /* _name on <var_mclass:MClass> */
if (unlikely(var36 == NULL)) {
PRINT_ERROR("Runtime error: %s", "Uninitialized attribute _name");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__model, 388);
fatal_exit(1);
...
var_other30 = var38;
{
var43 = ((short int(*)(val* self, val* p0))(var34->class->vft[COLOR_core__kernel__Object___61d_61d]))(var34, var_other30); /* == on <var34:String>*/
}
var44 = !var43;
var41 = var44;
goto RET_LABEL42;
...
{
{ /* Inline abstract_compiler#AbstractCompiler#mainmodule (self) on <self:SeparateCompiler> */
var50 = self->attrs[COLOR_nitc__abstract_compiler__AbstractCompiler___mainmodule].val; /* _mainmodule on <self:SeparateCompiler> */
if (unlikely(var50 == NULL)) {
PRINT_ERROR("Runtime error: %s", "Uninitialized attribute _mainmodule");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__abstract_compiler, 531);
fatal_exit(1);
...
{
var51 = nitc__model___MModule___pointer_type(var48);
}
{
{ /* Inline model#MClassType#mclass (var51) on <var51:MClassType> */
var54 = var51->attrs[COLOR_nitc__model__MClassType___mclass].val; /* _mclass on <var51:MClassType> */
if (unlikely(var54 == NULL)) {
PRINT_ERROR("Runtime error: %s", "Uninitialized attribute _mclass");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__model, 1166);
fatal_exit(1);
...
{
var55 = core___core__HashMap___core__abstract_collection__MapRead___91d_93d(var45, var52);
}
var56 = (long)(var55)>>2;
var = var56;
goto RET_LABEL;
...
{
{ /* Inline separate_compiler#SeparateCompiler#box_kinds (self) on <self:SeparateCompiler> */
var59 = self->attrs[COLOR_nitc__separate_compiler__SeparateCompiler___box_kinds].val; /* _box_kinds on <self:SeparateCompiler> */
if (unlikely(var59 == NULL)) {
PRINT_ERROR("Runtime error: %s", "Uninitialized attribute _box_kinds");
PRINT_ERROR(" (%s:%d)\n", FILE_nitc__separate_compiler, 264);
fatal_exit(1);
...
{
var60 = core___core__HashMap___core__abstract_collection__MapRead___91d_93d(var57, var_mclass);
}
var61 = (long)(var60)>>2;
var = var61;
goto RET_LABEL;
