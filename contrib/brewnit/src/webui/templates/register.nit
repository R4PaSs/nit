...
"""
	...
	redef fun rendering do
		...
		"""
		bdy.add """<form class="form-horizontal" action="/register/confirm" method="POST" role="form">
			...
			<div class = "form-group">
				<label for="mail" class="col-sm-4 control-label">E-Mail address</label>
				<div class="col-sm-8">
				<input name="mail" id="mail" type="email" class="form-control" placeholder="example@example.org" value="{{{if user != null then user.mail else ""}}}">
				</div>
			</div>
			<div class="form-group">
